...
export default function LabTabs({ socket }) {
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/battletrade/payoutchart`, {
    ...
    >
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4, paddingRight: 4 }}
                  >
                    Check all trader's battle position here!
                  </MDTypography>
                </MDBox>
              </Grid>
      ...
      >
        <Grid item xs={12} md={12} lg={12}>
          <MDBox p={1}>
            {completedBattle && (
              <BattleChart completedBattle={completedBattle} />
            )}
          </MDBox>
        </Grid>
      </Grid>
