...
const College = () => {
  ...
  useEffect(() => {
    let call1 = axios.get(`${baseUrl}api/v1/college/south`, {
  ...
  function backHandler() {
    ...
    axios
      .get(
        `${baseUrl}api/v1/college/south?skip=${
          skip - limitSetting
        }&limit=${limitSetting}`,
        {
          withCredentials: true,
  ...
  function Delete(id) {
    console.log(id);
    axios
      .get(`${baseUrl}api/v1/college/delete/${id}`, {
        withCredentials: true,
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
        ...
        {!isLoading ? (
          collegeData?.map((elem, index) => {
            return (
              <Grid
                container
                backgroundColor={index % 2 === 0 ? "grey" : "lightgrey"}
                mt={1}
                p={1}
                style={{ border: "1px solid white", borderRadius: 5 }}
              >
                ...
                >
                  <MDTypography
                    ...
                    fontWeight="bold"
                  >
                    {elem?.collegeName.slice(0, 60) +
                      (elem?.collegeName.length > 60 ? "..." : "")}
                  </MDTypography>
                </Grid>
                ...
                >
                  <MDTypography
                    ...
                    fontWeight="bold"
                  >
                    {elem?.createdBy?.first_name} {elem?.createdBy?.last_name}
                  </MDTypography>
                </Grid>
              </Grid>
            );
        ...
        {!isLoading && count !== 0 && (
          ...
          >
            ...
            <MDTypography color="light" fontSize={15} fontWeight="bold">
              Total Colleges: {!count ? 0 : count} | Page{" "}
