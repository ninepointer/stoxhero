  ...
  function onCreate() {
    ...
    obj.delete = (
      <MDButton
        ...
        fontWeight="medium"
        onClick={(e) => {
          deleteItem(obj.id.props.children);
        }}
      >
        🗑️
      </MDButton>
    ...
    obj.cunitfullname = (
      <TextField
        ...
        onChange={(e) => {
          unitConversionData.unitConversionFullName = e.target.value;
        }}
      />
    );
    ...
    obj.cunitid = (
      <TextField
        ...
        sx={{ margin: 1, padding: 1, width: "200px" }}
        onChange={(e) => {
          unitConversionData.unitConversionId = e.target.value;
        }}
      />
    );
    ...
    obj.value = (
      <TextField
        ...
        onChange={(e) => {
          unitConversionData.value = e.target.value;
        }}
      />
    );
      ...
      <MDBox pt={3} pb={3}>
        ...
        >
          <TextField
            ...
            sx={{ margin: 1, padding: 1, width: "200px" }}
            onChange={(e) => {
              formData.unitFullName = e.target.value;
            }}
          />
          ...
          <TextField
            ...
            onChange={(e) => {
              formData.unitId = e.target.value;
            }}
          />
