  ...
  async function deletesubCategory(type_id, create_id) {
    ...
    if (type_id) {
      const res = await fetch(
        `${baseUrl}api/v1/category/subCategoryDelete/${type_id}`,
        {
          method: "PATCH",
        }
      );
      ...
      let obj = {
        ...
        delete: (
          <MDButton
            ...
            fontWeight="medium"
            onClick={() => {
              deletesubCategory(elem._id, elem.id, "database");
            }}
          >
            🗑️
          </MDButton>
    ...
    let obj = {
      ...
      delete: (
        <MDButton
          ...
          fontWeight="medium"
          onClick={() => {
            deletesubCategory(obj.id, "created");
          }}
        >
          🗑️
        </MDButton>
      ...
      subcategoryname: (
        <TextField
          ...
          onChange={(e) => {
            subCategoryDataFirst.subCategoryName = e.target.value;
          }}
        />
      ),
      subcategoryid: (
        <TextField
          ...
          onChange={(e) => {
            subCategoryDataFirst.subCategoryId = e.target.value;
          }}
        />
      ),
      status: (
        <TextField
          ...
          onChange={(e) => {
            subCategoryDataFirst.status = e.target.value;
          }}
        />
      ),
    };
