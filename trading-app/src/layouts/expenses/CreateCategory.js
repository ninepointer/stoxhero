  ...
  function onCreate() {
    ...
    obj.subcategoryname = (
      <TextField
        ...
        onChange={(e) => {
          subCategoryData.subCategoryName = e.target.value;
        }}
      />
    );
    ...
    obj.subcategoryid = (
      <TextField
        ...
        sx={{ margin: 1, padding: 1, width: "200px" }}
        onChange={(e) => {
          subCategoryData.subCategoryId = e.target.value;
        }}
      />
    );
    ...
    obj.status = (
      <TextField
        ...
        onChange={(e) => {
          subCategoryData.status = e.target.value;
        }}
      />
    );
      ...
      <MDBox pt={3} pb={3}>
        ...
        >
          <TextField
            ...
            sx={{ margin: 1, padding: 1, width: "200px" }}
            onChange={(e) => {
              formData.categoryName = e.target.value;
            }}
          />
