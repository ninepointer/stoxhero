...
function OnGoingContests() {
  ...
  useEffect(() => {
    setIsLoading(true);
    let call1 = axios.get(
      `${baseUrl}api/v1/dailycontest/contests/onlyupcoming`,
      {
          ...
          >
            <Grid item xs={12} md={6} lg={12} m={1}>
              ...
              >
                <Grid container alignItems="center">
                  <Grid item xs={12} md={6} lg={12}>
                    <MDTypography ml={1} fontSize={15} fontWeight="bold">
                      {ongoing.length !== 0
                        ? "Ongoing TestZones"
                        : upcoming.length !== 0
                        ? "Upcoming TestZones"
              ...
              {contest.length !== 0 ? (
                contest.map((elem) => {
                  let isContestFull =
                    elem.maxParticipants - elem.participants.length === 0;
                  return (
                    <MDBox
                      key={elem._id}
                      bgColor="light"
                            ...
                            <Grid container xs={12} md={12} lg={12}>
                              ...
                              >
                                <MDTypography
                                  ...
                                  fontWeight="bold"
                                >
                                  Payout: {elem?.payoutPercentage}% of Net P&L
                                </MDTypography>
                              </Grid>
                              <Grid
                                item
                      ...
                      >
                        <Grid container xs={12} md={12} lg={12}>
                          ...
                          >
                            ...
                            >
                              There are currently no active TestZones on the
                              platform. Please stay tuned for updates.
                            </MDTypography>
                          </Grid>
                        </Grid>
                      </MDBox>
