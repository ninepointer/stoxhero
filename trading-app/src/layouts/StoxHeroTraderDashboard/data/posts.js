          ...
          >
            ...
            >
              <MDAvatar
                ...
                src={
                  elem?.postedBy?.profilePhoto?.url
                    ? elem?.postedBy?.profilePhoto?.url
                    : ""
                }
            ...
            >
              ...
              >
                <MDTypography fontSize={15} fontWeight="bold">
                  {elem?.postedBy?.first_name} {elem?.postedBy?.last_name}
                </MDTypography>
                <MDTypography fontSize={15} fontWeight="bold" ml={1} mt={0.4}>
                  <VerifiedIcon color="warning" />
                </MDTypography>
                <MDTypography fontSize={10} ml={1} mt={0.5}>
                  {getTimeElapsed(elem?.postedOn)}
                </MDTypography>
              </MDBox>
            </Grid>
            <Grid
