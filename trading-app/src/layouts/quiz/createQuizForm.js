...
function Index() {
  ...
  const [formState, setFormState] = useState({
    ...
    registrationCloseDateTime: dayjs(quiz?.registrationCloseDateTime) ?? dayjs(new Date()).set('hour', 0).set('minute', 0).set('second', 0),
        ...
        (
          <MDBox pl={2} pr={2} mt={4}>
            ...
            <Grid container spacing={1} mt={1} xs={12} md={12} xl={12} display="flex" flexDirection="row" justifyContent="center">
                          ...
                          <DemoContainer components={['MobileDateTimePicker']}>
                            <DemoItem>
                              <MobileDateTimePicker
                                ...
                                disabled={((isSubmitted || quiz) && (!editing || saving))}
                                value={formState?.registrationCloseDateTime || dayjs(quizData?.registrationCloseDateTime)}
                                onChange={(newValue) => {
                                  if (newValue && newValue.isValid()) {
                                    setFormState(prevState => ({ ...prevState, registrationCloseDateTime: newValue }))
                                  }
                                }}
                                minDateTime={null}
                                sx={{ width: '100%' }}
                ...
                <Grid mt={0} item xs={12} md={12} xl={3} display="flex" justifyContent="center">
                          ...
                          <Grid item xs={12} md={12} xl={12} style={{ maxWidth: '100%', height: 'auto' }}>
                            <Card sx={{ minWidth: '100%', cursor: 'pointer' }}>
                              <CardActionArea>
                                ...
                                <Grid item xs={12} md={12} lg={12} display='flex' justifyContent='center' alignContent='center' alignItems='center' style={{ maxWidth: '100%', height: 'auto' }}>
                                  <img src={previewUrl} style={{ width: "100%", height: "auto", borderBottomLeftRadius: 10, borderBottomRightRadius: 10 }} />
                                </Grid>
                              </CardActionArea>
                            </Card>
                          </Grid>
                          ...
                          <Grid item xs={12} md={12} xl={12} style={{ maxWidth: '100%', height: 'auto' }}>
                            <Card sx={{ minWidth: '100%', cursor: 'pointer' }}>
                              <CardActionArea>
                                ...
                                <Grid item xs={12} md={12} lg={12} display='flex' justifyContent='center' alignContent='center' alignItems='center' style={{ maxWidth: '100%', height: 'auto' }}>
                                  <img src={quiz?.image} style={{ width: "100%", height: "auto", borderBottomLeftRadius: 10, borderBottomRightRadius: 10 }} />
                                </Grid>
                              </CardActionArea>
                            </Card>
                          </Grid>
                ...
                <Grid mt={2} item xs={12} md={12} xl={12} display="flex" justifyContent="center" style={{minWidth:'100%'}}>
                  <JoditEditor
                    ref={editor}
                    config={config}
