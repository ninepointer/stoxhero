...
export default function UserTodayTradeData() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${baseUrl}api/v1/todayXTS?skip=${skip}&limit=${limitSetting}`, {
          ...
          data?.map((elem) => {
            ...
            return (
              ...
              >
                ...
                >
                  <MDTypography color={"light"} fontSize={10} fontWeight="bold">
                    {elem?.average_price ? elem?.average_price : 0}
                  </MDTypography>
                </Grid>
                <Grid
                  item
                ...
                >
                  <MDTypography color="light" fontSize={10} fontWeight="bold">
                    ...
                    }).format(Math.abs(elem?.average_price * elem?.quantity))}
                  </MDTypography>
                </Grid>
                <Grid
                  item
                ...
                >
                  <MDTypography color="light" fontSize={10} fontWeight="bold">
                    {elem?.exchange_order_id ? elem?.exchange_order_id : "N/A"}
                  </MDTypography>
                </Grid>
                <Grid
                  item
