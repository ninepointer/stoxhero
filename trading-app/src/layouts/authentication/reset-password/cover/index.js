            ...
            {passwordResetDone ? (
              ...
              >
                <Typography
                  ...
                  mb={5}
                >
                  <img height="40" width="40" src={completeIcon} />
                  <MDBox>Password Reset Process Completed.</MDBox>
                </Typography>
                <MDBox mb={4}>
                  <MDButton
                    style={{
                    ...
                    {!editable && (
                      <>
                        ...
                        >
                          ...
                          />
                          {((onReset && formstate.confirm_password) ||
                            formstate.password !=
                              formstate.confirm_password) && (
                            <Typography style={{ color: "red", fontSize: 15 }}>
                        ...
                        >
                          <MDInput
                            ...
                            fullWidth
                            onChange={(e) => {
                              formstate.confirm_password = e.target.value;
                            }}
                          />
                          {((onReset && formstate.password) ||
                            formstate.password !=
                              formstate.confirm_password) && (
                            <Typography style={{ color: "red", fontSize: 15 }}>
                              Password match failed
