...
function Cover() {
  ...
  const resetPassword = async () => {
    setOnReset(true);
    if (
      !formstate.confirm_pin ||
      !formstate.pin ||
      formstate.confirm_pin != formstate.pin
    ) {
      return;
    }
    setTimerActive(true);
            ...
            {passwordResetDone ? (
              ...
              >
                ...
                >
                  ...
                  <MDBox>PIN Reset Process Completed.</MDBox>
                </Typography>
                <MDBox mb={4}>
                  <MDButton
                    style={{
                      ...
                      <>
                        ...
                        >
                          <MDInput
                            ...
                            fullWidth
                            onChange={(e) => {
                              formstate.pin = e.target.value;
                            }}
                          />
                          {((onReset && formstate.confirm_pin) ||
                            formstate.pin != formstate.confirm_pin) && (
                            <Typography style={{ color: "red", fontSize: 15 }}>
                        ...
                        >
                          <MDInput
                            ...
                            fullWidth
                            onChange={(e) => {
                              formstate.confirm_pin = e.target.value;
                            }}
                          />
                          {((onReset && formstate.pin) ||
                            formstate.pin != formstate.confirm_pin) && (
                            <Typography style={{ color: "red", fontSize: 15 }}>
                              Password match failed
                            </Typography>
