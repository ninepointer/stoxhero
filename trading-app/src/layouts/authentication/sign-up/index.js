...
function Cover(props) {
  ...
  useEffect(() => {
    setformstate((prevState) => ({
      ...prevState,
      referrerCode: referrerCodeString,
    }));
    getMetrics();
    getEarnings();
  ...
  return (
    <>
      <Helmet>
        <title>
          StoxHero - The best platform for learning stock market trading
        </title>
        <meta
          name="description"
          content="Experience live stock trading on real time platform using virtual money. Test strategies on F&O and enhance your trading skills without the fear of losing money. Join us"
        />
        <meta
          name="keywords"
          content="Best virtual trading platform,best app for paper trading,best low cost stock trading platform,trading simulation,stock market trading strategies,virtual trading platform india,best platform for trading options"
        />
      </Helmet>
      <MDBox
        mt={-1}
                    ...
                    >
                      ...
                      >
                        <MDTypography
                          ...
                          fontWeight="bold"
                        >
                          Get ready, your stock market trading journey starts
                          here!
                        </MDTypography>
                      </Grid>
                          ...
                          >
                            {signup ? (
                              <MDTypography
                                ...
                                fontWeight="bold"
                              >
                                Unlock your welcome bonus! Use code{" "}
                                {defaultInvite?.campaignCode} & grab ₹
                                {defaultInvite?.campaignSignupBonus?.amount} in
                            ...
                            {showEmailOTP && showConfirmation && (
                              <>
                                ...
                                >
                                  ...
                                  >
                                    {timerActive
                                      ? `Resend Mobile OTP in ${resendTimer} seconds`
                                      : "Resend Mobile OTP"}
                                  </MDButton>
                                </Grid>
                            ...
                            {otpGen && (
                              <>
                                ...
                                >
                                  ...
                                  >
                                    {timerActiveSi
                                      ? `Resend Mobile OTP in ${resendTimerSi} seconds`
                                      : "Resend Mobile OTP"}
                                  </MDButton>
                                </Grid>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <TotalContest
                    initialCount={data?.totalContestConducted || 0}
                  />
                </Grid>
                <Grid
                  item
                ...
                >
                  <CollegeContest
                    initialCount={data?.collegeContestConducted || 0}
                  />
                </Grid>
                <Grid
                  item
                ...
                >
                  <Subscription
                    initialCount={data?.tenxSubscriptionsBought || 0}
                  />
                </Grid>
                <Grid
                  item
                ...
                >
                  <Withdrawals
                    initialCount={data?.withdrawalProcessedAmount || 0}
                  />
                </Grid>
              </Grid>
            </Grid>
            ...
            >
              ...
              >
                <Grid
                  ...
                  alignItems="center"
                >
                  <MDTypography fontSize={15} color="text" fontWeight="bold">
