...
export default function FreeCollegeContestData() {
  ...
  useEffect(()=>{
    axios.get(`${baseUrl}api/v1/dailycontest/dailyfreecollegecontestdata?skip=${skip}&limit=${limitSetting}`,{
  ...
  function backHandler(){
    ...
    setFreeContestData([]);
    setIsLoading(true)
    axios.get(`${baseUrl}api/v1/dailycontest/dailyfreecollegecontestdata?skip=${skip-limitSetting}&limit=${limitSetting}`,{
        withCredentials: true,
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
