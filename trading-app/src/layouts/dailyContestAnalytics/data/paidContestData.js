...
export default function FreeContestData() {
  ...
  useEffect(()=>{
  let call1 = axios.get(`${baseUrl}api/v1/dailycontest/dailypaidcontestdata?skip=${skip}&limit=${limitSetting}`,{
    ...
    let call2 = axios.get(`${baseUrl}api/v1/dailycontest/paidcontestuserdata?skip=${userskip}&limit=${userlimitSetting}`,{
      withCredentials: true,
      headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  function backHandler(){
    ...
    axios.get(`${baseUrl}api/v1/dailycontest/dailypaidcontestdata?skip=${skip-limitSetting}&limit=${limitSetting}`,{
        withCredentials: true,
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
  ...
  function backHandlerUser(){
    ...
    axios.get(`${baseUrl}api/v1/dailycontest/paidcontestuserdata?skip=${userskip-userlimitSetting}&limit=${userlimitSetting}`,{
        withCredentials: true,
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
