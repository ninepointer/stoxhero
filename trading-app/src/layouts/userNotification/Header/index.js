        ...
        <Grid container xs={12} md={6} lg={12}>
          <Grid item xs={12} md={12} lg={12} mb={1}>
            {data?.length > 0 && (
              ...
              >
                <MDBox mb={2}>
                  <MDTypography color="light" fontSize={18} display="flex">
                ...
                {data?.length > 0 && (
                  ...
                  >
                    ...
                    <MDTypography color="light" fontSize={15} fontWeight="bold">
                      Total Data: {notifications.length} | Page {currentPage} of{" "}
                      {Math.ceil(notifications.length / perPage)}
                    </MDTypography>
                    <MDButton
                      variant="outlined"
                      color="warning"
