...
export default function data() {
  ...
  return {
    columns: [
      { Header: "Trader Name", accessor: "traderName", width: "12.5%", align: "center" },
      ...
      { Header: "ROI(%)", accessor: "roi", width: "12.5%", align: "center" },
      { Header: "Investment", accessor: "investment", width: "12.5%", align: "center" },
