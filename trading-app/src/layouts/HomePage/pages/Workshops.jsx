...
const Internship = ({ campaignCode }) => {
  ...
  useEffect(() => {
    ...
    axios.get(`${baseUrl}api/v1/career/live?type=Workshop`).then((res) => {
        ...
        career.map(async (elem) => {
          try {
            const res = await axios.get(
              `${apiUrl}career/careerapplicationcount/${elem?._id}`
            );
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      👩🏻‍💻{" "}
                                      {careerApplicationCounts[
                                        index
                                      ]?.toLocaleString()}{" "}
                                      applicants{" "}
                                      {elem?.activelyRecruiting === true
                                        ? " | 👨‍💼👩‍💼 Actively recruiting"
                                        : ""}
                                    </MDTypography>
                                  </Grid>
                ...
                <Grid item border="1px solid transparent" xs={12} md={6}>
                  ...
                  >
                    ...
                    <Typography
                      ...
                      sx={{ pb: 2 }}
                    >
                      No currently we don't have any open positions. Kindly
                      visit after sometime or contact us for more information...
                    </Typography>
                  </Stack>
                </Grid>
