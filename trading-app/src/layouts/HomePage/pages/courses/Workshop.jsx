...
const Workshop = () => {
  ...
  const getCourseDetails = async (slug) => {
    try {
      const res = await axios.get(`${apiUrl}courses/user/${slug}/slug`);
    ...
    >
      <ThemeProvider theme={theme}>
        ...
        >
            ...
            >
              ...
              >
                ...
                <MDTypography
                  ...
                  style={{ fontWeight: 500, color: "white" }}
                >
                  ⁠Insights into crafting personalised trading strategies and
                  setups.
                </MDTypography>
              </Grid>
            </Grid>
          ...
          >
            <MDBox display="flex" justifyContent="center" alignItems="stretch">
              <Grid
                container
                // spacing={5}
                xs={12}
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <MDBox
                        ...
                        sx={{ cursor: "pointer" }}
                        onClick={() => {
                          openSocialMediaHandle(
                            instructor?.influencerDetails?.channelDetails
                              ?.youtube?.channelLink
                          );
                        }}
                      >
                        <span style={{ color: "#ffffff", marginTop: "3px" }}>
                          <YouTubeIcon color="red" />
                        </span>{" "}
                        <span style={{ color: "#ffffff" }}>{`${formatNumber(
                          instructor?.influencerDetails?.channelDetails?.youtube
                            ?.followers
                        )} Subscribers`}</span>
                      </MDBox>
                      <MDBox
                  ...
                  >
                    ...
                    >
                      {instructor?.influencerDetails?.about ||
                        "Lorum ipsum dolor sit amet, consectetur adipiscing elit. Sed aliquam ultricies eros, a consectetur turpis maximus sed. Quisque convallis, lorem vitae ultrices consequat, nibh justo fermentum dui, et sodales justo magna non elit. Nulla facilisi. Integer auctor consequat diam, id fermentum magna efficitur eu."}
                    </MDTypography>
                  </MDBox>
                </MDBox>
              </Grid>
