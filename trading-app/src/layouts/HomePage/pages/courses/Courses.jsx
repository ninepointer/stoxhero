...
export default function Courses() {
  ...
  async function fetchData() {
    let call1 = axios.get(`${apiUrl}courses/user/byslug?slug=${slug}&skip=${skip}&limit=${limitSetting}`, {
      headers: {
                  ...
                  <Grid container xs={12} md={12} lg={12} display='flex' justifyContent='center' alignContent='center' alignItems='center' style={{ maxWidth: '100%', height: 'auto' }}>
                    <Grid item xs={12} md={12} lg={12} display='flex' justifyContent='center' alignContent='center' alignItems='center' style={{ maxWidth: '100%', height: 'auto' }}>
                      <MDBox display='flex' justifyContent='center' alignContent='center' alignItems='center' style={{ maxWidth: '100%', height: 'auto' }}>
                        <MDTypography fontSize={18} fontWeight="bold">Let's continue this journey with expert courses</MDTypography>
                      </MDBox>
                    </Grid>
                                      ...
                                      <Card sx={{ minWidth: '100%', cursor: 'pointer' }} >
                                        ...
                                        <CardActionArea>
                                          ...
                                          <Grid container spacing={0} alignItems="center">
                                              ...
                                              <CardContent>
                                                ...
                                                <MDBox display='flex' justifyContent='center' alignItems='center'>
                                                  <MDTypography variant='caption' display='flex' justifyContent='center' alignItems='center' gap={3}>
                                                    <MDTypography variant='caption' fontSize={15} fontWeight="bold" display='flex' alignItems='center' gap={0.5}>
                                                      <span>₹{elem?.discountedPrice}</span>
                                                      <PaymentIcon />
                                                    </MDTypography>
                                                    <span>|</span>
                                                    <MDTypography variant='caption' fontSize={15} fontWeight="bold" display='flex' alignItems='center' gap={0.5}>
                                                      <span>{elem?.userEnrolled}</span>
                                                      <Groups2Icon />
                                                    </MDTypography>
                                                  </MDTypography>
                                                </MDBox>
                                            ...
                                            <Grid item xs={12} md={4} lg={12} p={1}>
                                              <MDBox display='flex' justifyContent='flex-end' style={{ width: '100%', height: '100%' }}
                                              component={Link}
                                              to={{
