...
const Form = ({ data, slug, checkPaid, testzone, referrerCode, isCoupon, workshop }) => {
  ...
  const [isCheckPaid, setIsCheckPaid] = useState(null);
      ...
      >
        <DialogTitle id="alert-dialog-title">
          <MDTypography
            ...
            textAlign="center"
          >
            {!isCheckPaid && (detail.isLogin === false
        ...
        <DialogContent
          sx={{
            width: detail.isLogin ? "1px" : "500px",
            height: detail.isLogin ? "1px" : "auto",
            display: "flex",
  ...
  >
    Close
          ...
          {detail.isLogin ? (
            ...
            ((detail.isLogin === false) && !isCheckPaid) && (
              <>
                <Grid
                  item
                  xs={12}
          ...
          {buttonLoading.getOtp && (
            ...
            >
              {timerActive
                ? `Resend Mobile OTP in ${resendTimer} seconds`?.toUpperCase()
                : "Resend Mobile OTP"?.toUpperCase()}
            </MDTypography>
          )}
        </DialogContent>
        <DialogActions>
          ...
          {detail.isLogin !== false && (
            <MDButton
              onClick={() => {
                !detail.otpGenerate ? generateOTP() : confirmOTP();
              }}
              variant="gradient"
              size="small"
              color="warning"
