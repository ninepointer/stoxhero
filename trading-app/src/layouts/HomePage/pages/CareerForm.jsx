            ...
            >
              <MDBox display="flex" justifyContent="center">
                <MDTypography color="black">
                  Please fill your details to apply for {career?.jobTitle}!
                </MDTypography>
              </MDBox>
              <Grid
                container
            ...
            >
              <Grid container>
                ...
                >
                  ...
                  <MDTypography mt={1}>
                    We have also created your StoxHero trading account and the
                    login details have been sent on your email!
                  </MDTypography>
                  <MDTypography mt={1} fontSize={20} fontWeight="bold">
                    Explore the world of options trading by visiting
                    www.stoxhero.com
                  </MDTypography>
                </Grid>
              </Grid>
