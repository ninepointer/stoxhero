  ...
  const renderSuccessSB = (
    ...
    return (
        ...
        >
            ...
            <Box style={{  width: "100%", display: "flex", flexDirection: "column", justifyContent: "center", textAlign: "center", background: "#353535" }}>
            <Navbar/>


            <MDBox style={isMobile ? { marginTop: '100px'} : {}}>
                    ...
                    <form onSubmit={HandleSubmit} >
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm={12} lg={12}>
                                ...
                                <TextField value={data.first_name} name='first_name' placeholder="First Name" variant='outlined' fullWidth required onChange={HandleChange} />

                            </Grid>

                            <Grid item xs={12} sm={12} lg={12}>

                                <TextField value={data.last_name} name='last_name' placeholder="Last Name" variant='outlined' fullWidth required onChange={HandleChange} />

                            </Grid>

                            <Grid item xs={12} sm={12}  lg={12}>

                                <TextField value={data.email} name='email' type='email' placeholder="Email"  variant='outlined' fullWidth required onChange={HandleChange} />

                            </Grid>

                            <Grid item xs={12} sm={12}  lg={12}  >

                                <TextField value={data.phone} name='phone' type='number' placeholder="Phone" variant='outlined' fullWidth required onChange={HandleChange} />
                            ...
                            <Grid item xs={12} sm={12}  lg={12}  >
                                ...
                                <Button type='submit' variant='contained' style={{backgroundColor:'#353535', color:'#ffffff'}} fullWidth onClick={onSubmit}>Submit</Button>
