                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    Introducing MarginX: Your Gateway to
                                    Realistic Trading
                                  </DialogTitle>
                                  <DialogContent>
                                    <DialogContentText>
                                      ...
                                      <p style={{ textAlign: "center" }}>
                                        In MarginX, you won't just learn about
                                        trading; you'll experience it. MarginX
                                        is designed to bridge the gap between
                                        learning and real-world trading,
                                        allowing you to get as close to the
                                        market as possible & also continue to
                                        make real profit using virtual currency.
                                        Your success in MarginX depends on your
                      ...
                      >
                        ...
                        >
                          <MDTypography
                            ...
                            fontWeight="bold"
                          >
                            {changeDateFormat(elem.startTime)}
                          </MDTypography>
                        </Grid>
                        <Grid
                          item
                      ...
                      >
                        ...
                        >
                          <MDButton
                            ...
                            onClick={() => {
                              navigate(
                                `/marginxs/${elem?.marginXName}/${
                                  elem?.startTime.split("T")[0]
                                }`,
                                {
                                  state: {
                                    elem: elem,
                        ...
                        >
                          {isParticipated ? (
                            ...
                            <MDButton
                              ...
                              style={{ minWidth: "95%", fontSize: 9 }}
                              disabled={
                                particularMarginXTime[0]?.value < 0
                                  ? false
                                  : true
                              }
                              onClick={() => {
                                window.webengage.track(
                                  "marginx_start_trading_clicked",
                                  {
                                    user: getDetails?.userDetails?._id,
                                    marginxId: elem?._id,
                                  }
                            ...
                            <Payment
                              ...
                              timeDifference={particularMarginXTime[0]?.value}
                            />
                          )}
                        </Grid>
                      </Grid>
