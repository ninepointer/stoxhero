...
export default function TenXSubsDetails() {
  ...
  React.useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/portfolio/tenx`, { withCredentials: true })
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/tenX/${id}`, { withCredentials: true })
      .then((res) => {
        setTenXSubs(res?.data?.data);
        setLiveTenXSubs(
          res?.data?.data?.users?.filter((user) => user.status === "Live")
        );
        setExpiredTenXSubs(
          res?.data?.data?.users?.filter((user) => user.status === "Expired")
        );
        setTimeout(() => {
          setIsLoading(false);
        }, 500);
  ...
  async function onEdit(e, formState) {
    ...
    if (Number(formState.validity) > Number(formState.expiryDays)) {
      return openErrorSB(
        "Error",
        "Expiry days should be greater then validity."
      );
    }
    const {
      rewardType,
  ...
  async function onAddFeature(e, childFormState, setChildFormState) {
    ...
    if (data.status === 422 || data.error || !data) {
      ...
      openSuccessSB(
        "Feature added",
        "New Feature line item has been added in the TenX"
      );
      setTimeout(() => {
        setSaving(false);
        setEditing(false);
        ...
        <MDBox pl={2} pr={2} mt={4} mb={5}>
            ...
            <Grid container spacing={2} mt={0.5} mb={0} xs={12} md={9} xl={12}>
              <Grid item xs={12} md={6} xl={3}>
                <TextField
                  ...
                  defaultValue={
                    editing ? formState?.plan_name : tenXSubs?.plan_name
                  }
                  onChange={(e) => {
                    setFormState((prevState) => ({
                      ...prevState,
              ...
              <Grid item xs={12} md={6} xl={3}>
                <TextField
                  ...
                  defaultValue={
                    editing ? formState?.actual_price : tenXSubs?.actual_price
                  }
                  onChange={(e) => {
                    setFormState((prevState) => ({
                      ...prevState,
              ...
              <Grid item xs={12} md={6} xl={3}>
                <TextField
                  ...
                  fullWidth
                  value={
                    formState?.discounted_price || tenXSubs?.discounted_price
                  }
                  defaultValue={
                    editing
                      ? formState?.discounted_price
                      : tenXSubs?.discounted_price
                  }
                  onChange={(e) => {
                    setFormState((prevState) => ({
                      ...prevState,
              ...
              <Grid item xs={12} md={6} xl={3}>
                <TextField
                  ...
                  defaultValue={
                    editing ? formState?.profitCap : tenXSubs?.profitCap
                  }
                  onChange={(e) => {
                    setFormState((prevState) => ({
                      ...prevState,
              ...
              <Grid item xs={12} md={6} xl={3}>
                <TextField
                  ...
                  fullWidth
                  value={
                    formState?.payoutPercentage || tenXSubs?.payoutPercentage
                  }
                  defaultValue={
                    editing
                      ? formState?.payoutPercentage
                      : tenXSubs?.payoutPercentage
                  }
                  onChange={(e) => {
                    setFormState((prevState) => ({
                      ...prevState,
              ...
              <Grid item xs={12} md={6} xl={3}>
                <TextField
                  ...
                  defaultValue={
                    editing ? formState?.expiryDays : tenXSubs?.expiryDays
                  }
                  onChange={(e) => {
                    setFormState((prevState) => ({
                      ...prevState,
                ...
                <FormControl sx={{ minHeight: 10, minWidth: 263 }}>
                  ...
                  <Select
                    ...
                    value={
                      ...
                      tenXSubs?.portfolio?.portfolioName
                    }
              ...
              <Grid item xs={12} md={6} xl={3}>
                <TextField
                  ...
                  defaultValue={
                    editing ? formState?.validity : tenXSubs?.validity
                  }
                  onChange={(e) => {
                    setFormState((prevState) => ({
                      ...prevState,
              ...
              <Grid item xs={12} md={6} xl={3}>
                <FormControl sx={{ width: "100%" }}>
                  ...
                  <Select
                    ...
                    name="validityPeriod"
                    value={
                      formState?.validityPeriod || tenXSubs?.validityPeriod
                    }
                    disabled={(isSubmitted || id) && (!editing || saving)}
                    onChange={(e) => {
                      setFormState((prevState) => ({
          ...
          <Grid container mt={2} xs={12} md={12} xl={12}>
                ...
                <Grid container spacing={1}>
                  ...
                  <Grid item xs={12} md={0.6} xl={1.2} mt={-0.7}>
                    <IoMdAddCircle
                      cursor="pointer"
                      onClick={(e) => {
                        onAddFeature(e, formState, setFormState);
                      }}
                    />
                  </Grid>
                </Grid>
            ...
            {(id || newObjectId) && (
              <Grid item xs={12} md={12} xl={12} mt={2}>
                <MDBox>
                  <ActiveTenXSubscribers
                    tenXSubscription={LiveTenXSubs}
                    subscriptionCount={LiveTenXSubs?.length}
                  />
                </MDBox>
              </Grid>
            )}
            ...
            {(id || newObjectId) && (
              <Grid item xs={12} md={12} xl={12} mt={2}>
                <MDBox>
                  <TenXSubscriptionPurchaseIntent
                    tenXSubscription={newObjectId ? newObjectId : id}
                    purchaseIntentCount={purchaseIntentCount}
                    setPurchaseIntentCount={setPurchaseIntentCount}
                  />
                </MDBox>
              </Grid>
            )}
            ...
            {(id || newObjectId) && (
              <Grid item xs={12} md={12} xl={12} mt={2}>
                <MDBox>
                  <TenXSubscriptionTutorialView
                    tenXSubscription={newObjectId ? newObjectId : id}
                    tutorialVideoViewCount={tutorialVideoViewCount}
                    setTutorialVideoViewCount={setTutorialVideoViewCount}
                  />
                </MDBox>
              </Grid>
            )}
