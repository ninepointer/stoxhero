...
export default function ActiveTenXSubscriptions() {
  ...
  async function getTenXActiveSubs() {
    const res = await fetch(`${baseUrl}api/v1/tenX/draft`, {
      method: "GET",
      credentials: "include",
      headers: {
                  ...
                  <Grid container>
                    ...
                    >
                      <MDTypography
                        ...
                        fontWeight="bold"
                      >
                        Program Name: {elem?.plan_name?.toUpperCase()}
                      </MDTypography>
                    </Grid>
                    <Grid
                      item
                        ...
                        <Grid item xs={12} md={12} lg={8}>
                          ...
                          >
                            <MDTypography
                              ...
                              fontWeight="bold"
                            >
                              Actual Price : ₹{elem?.actual_price}/-
                            </MDTypography>
                          </Grid>
                          <Grid
                            item
                          ...
                          >
                            <MDTypography
                              ...
                              fontWeight="bold"
                            >
                              Validity : {elem?.validity} TRADING{" "}
                              {elem?.validityPeriod?.toUpperCase()}
                            </MDTypography>
                          </Grid>
                          <Grid
                            item
