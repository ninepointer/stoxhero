...
function ReferralHeader({ children }) {
  ...
  return (
    <MDBox position="relative" mb={5}>
      ...
      >
        <MDTypography variant="text" fontSize="18px">
          Welcome to Tredos referral program!
        </MDTypography>
        <MDTypography variant="text" fontSize="18px">
          Here's what's happening with your referral program.
        </MDTypography>
      </MDBox>
      <MDBox>
        <Grid container>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    Click to Share on &nbsp;
                    <IoLogoWhatsapp color="green" lineHeight={1} />
                  </MDTypography>
                </a>
              </MDBox>
            </MDBox>
            ...
            >
              ...
              >
                <MDTypography fontSize="30px" lineHeight={1}>
                  {thisMonthsReferral ? thisMonthsReferral : 0}
                </MDTypography>
                <MDTypography fontSize="10px" lineHeight={1}>
            ...
            <AppBar position="static">
              ...
              >
                <Tab
                  ...
                  icon={<PersonIcon fontSize="small" sx={{ mt: -0.25 }} />}
                  onClick={() => {
                    Loading();
                  }}
                ></Tab>
              ...
              {isLoading ? (
                ...
                <>
                  <ReferralDataThisMonth
                    thisMonthsReferral={thisMonthsReferral}
                    setThisMonthsReferral={setThisMonthsReferral}
                  />
                </>
              )}
            </TabPanel>
