...
export default function BasicModal({
  ...
  async function onInvite() {
    const { name, email, mobile, referralProgram } = formData;
    ...
    if (!name.trim().length || !mobile.length) {
      return openErrorSB(
        "Error",
        "Enter your friend's credentials to continue."
      );
    }
            ...
            >
              ...
              >
                <Typography fontSize={13} fontWeight={700}>
                  Hurry up to refer only 5 days 3 hrs 20 mins left
                </Typography>
              </Grid>
              <Grid
                item
            ...
            <Box>
              ...
              >
                <Typography fontSize={14} p={1}>
                  Copy and paste this in your chat to invite {formData.name} to
                  StoxHero.
                </Typography>
                ...
                <Typography fontSize={14} p={1}>
                  ...
                  >
                    ...
                    <Typography fontSize={11}>
                      Join me at StoxHero - India's First Options Trading and
                      Investment Platform 🤝
                    </Typography>
