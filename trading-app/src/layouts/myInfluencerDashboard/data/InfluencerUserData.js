...
export default function InfluencerUserData({ userData, setUserData }) {
  ...
  async function userDataFunc() {
    const data = await axios.get(`${apiUrl}influencer/userdata`, {
  ...
  async function userLast60DaysData() {
    const data = await axios.get(`${apiUrl}influencer/last60daysuserdata`, {
      withCredentials: true,
    });
    setChartData(
      data?.data?.data?.map((elem) => {
        return {
          date: moment(new Date(elem?._id)).format("DD MMM"),
          data: elem?.count,
        };
      })
    );
        ...
        >
            ...
            >
              ...
              >
                {new Intl.NumberFormat(undefined, {
                  minimumFractionDigits: 0,
                  maximumFractionDigits: 0,
                }).format(userData?.thisWeekCount || 0)}
              </MDTypography>
            </Grid>
            <Grid
              item
            ...
            >
              ...
              >
                {new Intl.NumberFormat(undefined, {
                  minimumFractionDigits: 0,
                  maximumFractionDigits: 0,
                }).format(userData?.thisMonthCount || 0)}
              </MDTypography>
            </Grid>
            <Grid
              item
            ...
            >
              ...
              >
                {new Intl.NumberFormat(undefined, {
                  minimumFractionDigits: 0,
                  maximumFractionDigits: 0,
                }).format(userData?.lifetimeCount || 0)}
              </MDTypography>
            </Grid>
          </Grid>
          ...
          >
            <Grid
              ...
              lg={12}
              display="flex"
              flexDirection={chartData?.length ? "column" : "column"}
              justifyContent="center"
              alignContent="center"
              alignItems="center"
            >
