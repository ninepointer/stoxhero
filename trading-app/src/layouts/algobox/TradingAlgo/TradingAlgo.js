...
const TradingAlgo = () => {
  ...
  algoData.map((subelem) => {
    ...
    obj.transactionChange = (
      <MDBox mt={0.5}>
        <Switch
          checked={subelem.transactionChange === "TRUE"}
          onChange={() => {
            transactionChange(subelem._id, subelem.transactionChange);
          }}
        />
      </MDBox>
    );
    obj.marginDeduction = (
      <MDBox mt={0.5}>
        <Switch
          checked={subelem.marginDeduction}
          onChange={() => {
            marginDeduction(subelem._id, subelem.marginDeduction);
          }}
        />
      </MDBox>
    );
    obj.isDefault = (
      <MDBox mt={0.5}>
        <Switch
          checked={subelem.isDefault}
          onChange={() => {
            defaultAlgo(subelem._id, subelem.isDefault, subelem.algoName);
          }}
        />
      </MDBox>
    );
    obj.instrumentChange = (
      <MDBox mt={0.5}>
        <Switch
          checked={subelem.instrumentChange === "TRUE"}
          onChange={() => {
            instrumentChange(subelem._id, subelem.instrumentChange);
          }}
        />
      </MDBox>
    );
    ...
    obj.exchangeChange = (
      <MDBox mt={0.5}>
        <Switch
          checked={subelem.exchangeChange === "TRUE"}
          onChange={() => {
            exchangeChange(subelem._id, subelem.exchangeChange);
          }}
        />
      </MDBox>
    );
    obj.productChange = (
      <MDBox mt={0.5}>
        <Switch
          checked={subelem.productChange === "TRUE"}
          onChange={() => {
            productChange(subelem._id, subelem.productChange);
          }}
        />
      </MDBox>
    );
