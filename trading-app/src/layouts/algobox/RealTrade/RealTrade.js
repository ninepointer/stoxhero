...
export default function RealTrade({ Render, id, buttonTextBool, tradingAlgo }) {
    ...
    //                 productChange, tradingAccount, marginDeduction, isDefault, _id
    //             }, instrumentToken
    ...
    async function switchTrade(isRealTrade) {
        ...
        let call1 = axios.get(`${baseUrl}api/v1/switchRealToMock`, {
    ...
    return (
        <>
            <MDBox mt={0.5}>
                <Switch checked={tradingAlgo.isRealTrade} onChange={() => { switchTrade(tradingAlgo.isRealTrade) }} />
            </MDBox>
