      ...
      >
        ...
        <DialogContent>
          <DialogContentText sx={{ display: "flex", flexDirection: "column" }}>
            <TextField
              id="outlined-basic"
              label="Incoming Instrument"
              variant="standard"
              value={incomingInstrument}
              sx={{ margin: 1, padding: 1, width: "300px" }}
              onChange={(e) => {
                setIncomingInstrument(e.target.value);
              }}
            />

            <TextField
              id="outlined-basic"
              label="Outgoing Instrument"
              variant="standard"
              value={outgoingInstrument}
              sx={{ margin: 1, padding: 1, width: "300px" }}
              onChange={(e) => {
                setOutgoingInstrument(e.target.value);
              }}
            />
