...
const CompletedContest = () => {
  ...
  useEffect(() => {
    let call1 = axios.get(
      `${baseUrl}api/v1/notificationgroup/inactive?skip=${skip}&limit=${limitSetting}`,
      {
  ...
  function backHandler() {
    ...
    axios
      .get(
        `${baseUrl}api/v1/notificationgroup/inactive?skip=${
          skip - limitSetting
        }&limit=${limitSetting}`,
        {
          withCredentials: true,
    ...
    <>
      {active?.length > 0 ? (
          ...
          {!isLoading && count !== 0 && (
            ...
            >
              ...
              <MDTypography color="light" fontSize={15} fontWeight="bold">
                Total Groups: {!count ? 0 : count} | Page{" "}
        ...
        <Grid container spacing={1} xs={12} md={6} lg={12}>
          ...
          >
            <MDTypography color="light">No Inactive Group(s)</MDTypography>
          </Grid>
        </Grid>
      )}
    </>
