...
const CompletedContest = () => {
  ...
  useEffect(() => {
    let call1 = axios.get(
      `${baseUrl}api/v1/notificationgroup/active?skip=${skip}&limit=${limitSetting}`,
      {
  ...
  function backHandler() {
    ...
    axios
      .get(
        `${baseUrl}api/v1/notificationgroup/active?skip=${
          skip - limitSetting
        }&limit=${limitSetting}`,
        {
          withCredentials: true,
          ...
          {!isLoading && count !== 0 && (
            ...
            >
              ...
              <MDTypography color="light" fontSize={15} fontWeight="bold">
                Total Notification Groups: {!count ? 0 : count} | Page{" "}
