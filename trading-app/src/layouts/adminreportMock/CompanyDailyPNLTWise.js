...
// Data
import MockCompanyPNLTWiseData from "./data/MockCompanyPNLTWiseData";
...
const TableTwo = () => {
  ...
  const { columns, rows } = MockCompanyPNLTWiseData();
  let date = new Date();
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${baseUrl}api/v1/infinityTrade/traderwisecompanypnlreport/${firstDate}/${secondDate}`,
        ...
        <Grid item xs={12} md={1} lg={12}>
          ...
          >
            <MDBox>
              ...
              >
                Trader Wise Company P&L Report (Mock)
              </Typography>
            </MDBox>
            <MDBox>
              <Typography
