                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} md={6} lg={6}>
                      <MDTypography
                        ...
                        justifyContent="center"
                      >
                        {ConvertDate(referralProgram?.referralProgramStartDate)}
                      </MDTypography>
                    </Grid>
                    ...
                    <Grid item xs={12} md={6} lg={6}>
                      <MDTypography
                        ...
                        justifyContent="center"
                      >
                        {ConvertDate(referralProgram?.referralProgramEndDate)}
                      </MDTypography>
                    </Grid>
                    ...
                    <Grid item xs={12} md={6} lg={6}>
                      <MDTypography
                        ...
                        justifyContent="center"
                      >
                        {referralProgram?.rewardPerReferral}
                      </MDTypography>
                    </Grid>
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} md={6} lg={6} mb={2}>
                      <MDTypography
                        ...
                        justifyContent="center"
                      >
                        {totalUsers * referralProgram?.rewardPerReferral}
                      </MDTypography>
                    </Grid>
                  </Grid>
                </MDBox>
