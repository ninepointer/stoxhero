...
const SellModel = ({
  ...
  async function placeOrder() {
    ...
    let createdOn = `${String(date.getDate()).padStart(2, "0")}-${String(
      ...
      date.getSeconds()
    ).padStart(2, "0")}:${String(date.getMilliseconds()).padStart(2, "0")}`;
  ...
  const renderSuccessSB = (
    <MDSnackbar
      ...
      sx={{
        ...
        borderRadius: "15px",
        width: `${messageObj.title == "Error" ? "500px" : "auto"}`,
      }}
    />
  );
          ...
          >
            ...
            <Box sx={{ display: "flex", flexDirection: "row" }}>
              ...
              <TextField
                ...
                onChange={(e) => {
                  {
                    sellFormDetails.TriggerPrice = e.target.value;
                  }
                }}
            ...
            >
              ...
              <FormControl>
                ...
                <RadioGroup
                  ...
                  onChange={(e) => {
                    {
                      sellFormDetails.stopLoss = e.target.value;
                    }
                  }}
                  sx={{ display: "flex", flexDirection: "row" }}
                >
