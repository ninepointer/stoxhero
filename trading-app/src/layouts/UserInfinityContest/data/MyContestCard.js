...
const ContestCard = () => {
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/contest/mycontests`, {
                        ...
                        >
                          <Tooltip title="Click me!">
                            <MDBox
                              ...
                              component={Link}
                              to={{
                                pathname: `/testzone/${e?.contestName}`,
                              }}
                              state={{
                                entry: e?.participants?.length,
                                minEntry: e?.minParticipants,
                                contestId: e?._id,
                              ...
                              <Grid container>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        Start Time:{" "}
                                        {dateConvert(e?.contestStartDate)}
                                      </MDTypography>
                                    </MDBox>
                                  </Grid>
                                </Grid>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <MDBox
                                      color="light"
                                      style={{ marginLeft: 2, fontWeight: 700 }}
                                    >
                                      Seats Left:{" "}
                                      {e?.maxParticipants -
                                        e?.participants?.length}
                ...
                <Grid item xs={12} md={6} lg={12}>
                  ...
                  >
                    ...
                    <MDTypography color="light" fontSize={15}>
                      You have not registered in any of the battles!
                    </MDTypography>
                  </MDBox>
                </Grid>
              </Grid>
