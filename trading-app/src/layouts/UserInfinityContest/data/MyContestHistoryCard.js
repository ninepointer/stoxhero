...
const MyContestHistoryCard = () => {
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/contest/history`, {
            ...
            <Grid container spacing={2}>
              {contestData?.map((e) => {
                ...
                const myReward = e?.rewards?.filter((elem) => {
                  return (
                    elem?.rankStart <= participatedUser[0]?.myRank?.rank &&
                    elem?.rankEnd >= participatedUser[0]?.myRank?.rank
                  );
                });
                    ...
                    <Grid key={e._id} item xs={12} md={6} lg={3}>
                      ...
                      >
                        <MDButton
                          ...
                          state={{
                            contestId: e?._id,
                            portfolioId: participatedUser[0].portfolioId,
                            isFromHistory: true,
                          }}
                        ...
                        >
                          <Grid container>
                            ...
                            >
                              ...
                              >
                                Reward Pool: {e?.entryFee?.currency}{" "}
                                {e?.rewards
                                  ?.reduce(
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  My Rank:{" "}
                                  {participatedUser[0]?.myRank?.rank
                                    ? participatedUser[0]?.myRank?.rank
                                    : "NA"}
                                </span>
                              </MDTypography>
