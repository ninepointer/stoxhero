...
const ContestPortfolioCard = ({
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/portfolio/user`, {
    ...
    axios
      .get(`${baseUrl}api/v1/portfolio/pnl`, {
        withCredentials: true,
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function joinContest() {
    ...
    if (data.status === "error" || data.error || !data) {
      ...
      openSuccessSB(
        "Great",
        `You have successfully registered for the battle ${contestName}`,
        "SUCCESS"
      );
        ...
        <>
          {contestPortfolioData.length > 0 ? (
                          ...
                          >
                            ...
                            >
                              ...
                              <span>
                                ₹
                                {netPnl
                                  ? (e?.portfolioValue + netPnl).toFixed(0)
                                  : e?.portfolioValue.toFixed(0)}
                              </span>{" "}
                            </MDTypography>
                          </Grid>
              ...
              <Grid container>
                ...
                >
                  <MDTypography color="light">
                    Select Your Portfolio and click on join!
                  </MDTypography>
                </Grid>
                <Grid
                  item
            ...
            <Grid container spacing={1} xs={12} md={6} lg={12}>
              ...
              >
                <MDTypography color="light">
                  You do not have any portfolio to join the battle
                </MDTypography>
              </Grid>
            </Grid>
          )}
