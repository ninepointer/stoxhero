...
function LastTrade({ contestId, Render }) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${baseUrl}api/v1/contest/${contestId}/trades/tradesByPagination?skip=${skip}&limit=${limitSetting}`,
        {
    ...
    axios
      .get(`${baseUrl}api/v1/contest/${contestId}/trades/countTrades`, {
        withCredentials: true,
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  function backHandler() {
    ...
    axios
      .get(
        `${baseUrl}api/v1/contest/${contestId}/trades/tradesByPagination?skip=${
          skip - limitSetting
        }&limit=${limitSetting}`,
        {
          withCredentials: true,
    ...
    <>
      <Grid container>
        <Grid item xs={12} md={12} lg={12}>
          <MDTypography fontSize={13} style={{ fontWeight: 500 }} color="light">
            Battle Order
          </MDTypography>
        </Grid>
      </Grid>
            ...
            return (
              ...
              >
                ...
                >
                  <MDTypography
                    fontSize={11.5}
                    color={elem.buyOrSell == "BUY" ? "success" : "error"}
                    style={{ fontWeight: 500, fontSize: "10px" }}
                  >
                    {elem.buyOrSell}
                  </MDTypography>
                ...
                >
                  <MDTypography
                    fontSize={11.5}
                    color={elem.status == "COMPLETE" ? "success" : "error"}
                    style={{ fontWeight: 500, fontSize: "10px" }}
                  >
                    {elem.status}
                  </MDTypography>
