...
function ContestResultPage() {
  ...
  React.useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/contest/${contestId}`)
      .then((res) => {
              ...
              <MDBox color="light">
                <MDBox display="flex" alignItems="center" gap={"130px"} mb={1}>
                  ...
                  <MDTypography
                    mt={1.5}
                    color="light"
                    style={{ fontWeight: 700, filter: isDummy && "blur(2px)" }}
                  >
                    {contest?.contestName}
                  </MDTypography>
                </MDBox>
                  ...
                  <div style={{ position: "relative" }}>
                    ...
                    >
                      ...
                      >
                        {myReward?.length &&
                          myReward[0]?.reward &&
                          `Congratulations ${getDetails?.userDetails?.employeeid}`}
                      </MDTypography>
                      <MDTypography
                        mt={2}
                      ...
                      >
                        {rank
                          ? myReward?.length &&
                            myReward[0]?.reward &&
                            `Your rank is ${rank} and you have won`
