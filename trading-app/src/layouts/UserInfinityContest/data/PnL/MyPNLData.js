      ...
      {isLoading ? (
        ...
        <>
          ...
          {tradeData?.map((subelem, index) => {
            ...
            let updatedValue =
              liveDetail.length && liveDetail[0]?.last_price
            ...
            console.log(
              ...
              subelem.amount + subelem.lots * liveDetail[0]?.last_price,
              subelem.lots,
              subelem.lots * liveDetail[0]?.last_price
            );
          ...
          >
            ...
            >
              <MDTypography fontSize={10} color="light">
                Open Quantity : {totalRunningLots}
              </MDTypography>
            </Grid>
            <Grid
              item
