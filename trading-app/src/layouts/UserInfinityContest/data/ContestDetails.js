...
function ContestDetails() {
  ...
  function convertDate(date) {
    console.log(date);
    return `${dateChange(date?.split("T")[0])} | ${timeChange(
      date?.split("T")[1]
    )}`;
  }
  ...
  const handleInvite = () => {
    openSuccessSB(
      "Copied",
      "Invite code copied. Paste it and invite your friends.",
      "SUCCESS"
    );
  };
            ...
            <Grid item xs={12} md={6} lg={4.5} mb={2}>
              <MDBox color="light">
                ...
                >
                  ...
                  >
                    <Timer
                      targetDate={contest?.entryOpeningDate}
                      text="Open for Registration now. Register!"
                    />
                  </MDBox>
                </MDTypography>
                ...
                <Grid container spacing={2}>
                  ...
                  >
                    ...
                    >
                      <CopyToClipboard text={copyText} onCopy={handleInvite}>
                        <MDButton variant="Text">Invite Friends</MDButton>
                      </CopyToClipboard>
                  ...
                  <Grid
                    ...
                    justifyContent="left"
                  >
                    <MDTypography color="light" fontSize={10}>{`${convertDate(
                  ...
                  >
                    <MDTypography color="light" fontSize={10}>
                      {convertDate(contest?.entryClosingDate)}
                    </MDTypography>
                  </Grid>
                  ...
                  >
                    ...
                    >
                      <HiUserGroup />
                      <span
                        style={{ marginLeft: 2, marginTop: 2, fontWeight: 700 }}
                      >
                        Min Participants: {contest?.minParticipants}
                      </span>
                    </MDTypography>
                    <MDTypography
                      color="white"
                    ...
                    >
                      ...
                      <span
                        style={{ marginLeft: 2, marginTop: 2, fontWeight: 700 }}
                      >
                        Entries so Far: {contest?.participants?.length}
                      </span>
                    </MDTypography>
                    <MDTypography
                      color="white"
                    ...
                    >
                      ...
                      <span
                        style={{ marginLeft: 2, marginTop: 2, fontWeight: 700 }}
                      >
                        Max Participants: {contest?.maxParticipants}
                      </span>
                    </MDTypography>
                  </Grid>
