...
export default function TutorialCategory() {
  ...
  React.useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/tutorialcategory/${id?._id}`, {
  ...
  async function AddVideo(e, childFormState, setChildFormState) {
    ...
    const res = await fetch(
      `${baseUrl}api/v1/tutorialcategory/${id ? id?._id : newObjectId}`,
      {
        method: "PATCH",
        credentials: "include",
        headers: {
            ...
            <Grid container spacing={2} mt={0.5} mb={0} xs={12} md={9} xl={12}>
              <Grid item xs={12} md={6} xl={3}>
                <TextField
                  ...
                  value={
                    formState?.categoryName || tutorialCategory?.categoryName
                  }
                  onChange={(e) => {
              ...
              <Grid item xs={12} md={6} xl={12}>
                <TextField
                  ...
                  // defaultValue={portfolioData?.portfolioName}
                  value={
                    formState?.description || tutorialCategory?.description
                  }
                  onChange={(e) => {
                    setFormState((prevState) => ({
                      ...prevState,
                ...
                <Grid container spacing={1}>
                  ...
                  >
                    ...
                    <MDButton
                      ...
                      size="small"
                      onClick={(e) => {
                        AddVideo(e, formState, setFormState);
                      }}
                    >
                      Add Video
                    </MDButton>
