...
function BillingInformation({ render }) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${baseUrl}api/v1/payment/${api}?skip=${skip}&limit=${limitSetting}`,
  ...
  function backHandler() {
    ...
    axios
      .get(
        `${baseUrl}api/v1/payment/${api}?skip=${
          skip - limitSetting
        }&limit=${limitSetting}`,
        {
          withCredentials: true,
      ...
      >
        <Grid container spacing={1} xs={12} md={12} lg={12} minWidth="100%">
          ...
          >
            <MDButton
              bgColor="dark"
              color={clicked == "successful" ? "warning" : "secondary"}
              size="small"
              style={{ minWidth: "100%" }}
              onClick={() => {
          ...
          >
            <MDButton
              bgColor="dark"
              color={clicked == "initiated" ? "warning" : "secondary"}
              size="small"
              style={{ minWidth: "100%" }}
              onClick={() => {
                handleClick("initiated");
              }}
            >
              <MDBox display="flex" justifyContent="center" alignItems="center">
                <MDBox
          ...
          >
            <MDButton
              bgColor="dark"
              color={clicked == "failed" ? "warning" : "secondary"}
              size="small"
              style={{ minWidth: "100%" }}
              onClick={() => {
                handleClick("failed");
                        ...
                        {!isLoading && count !== 0 && (
                          ...
                          >
                            ...
                            <MDTypography
                              ...
                              fontWeight="bold"
                            >
                              Total Transaction: {!count ? 0 : count} | Page{" "}
