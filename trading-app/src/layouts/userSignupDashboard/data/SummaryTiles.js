...
import FinowledgeUser from "./finowledgeUsers";
...
export default function LabTabs() {
  ...
  const [referralsCountYesterday, setReferralsCountYesterday] =
    React.useState(0);
  const [referralsCountThisMonth, setReferralsCountThisMonth] =
    React.useState(0);
    ...
    Promise.all([
      ...
      .then(
        ([
          ...
          const slicedData = api1Response.data.data.slice(
            startIndex,
            startIndex + perPage
          );
          setData(slicedData);
              ...
              >
                ...
                >
                  ...
                  <Grid item xs={12} md={6} lg={9}>
                    ...
                    <MDBox display="flex">
                      <MDTypography fontWeight="bold" fontSize={15}>
                        {todayCount}
                      </MDTypography>
                    </MDBox>
                  </Grid>
              ...
              >
                ...
                >
                  ...
                  <Grid item xs={12} md={6} lg={9}>
                    ...
                    <MDBox display="flex">
                      <MDTypography fontWeight="bold" fontSize={15}>
                        {beginnerCount + intermediateCount + proCount}
                      </MDTypography>
                    </MDBox>
                  </Grid>
                </Grid>
            ...
            return (
              ...
              >
                ...
                >
                  <MDTypography color="light" fontSize={13}>
                    {elem?.referredBy
                      ? elem?.referredBy?.first_name +
                        " " +
                        elem?.referredBy?.last_name
                      : elem?.campaign?.campaignName}
                  </MDTypography>
                </Grid>
                <Grid
                  item
          ...
          {!isLoading && data?.length > 0 && (
            ...
            >
              ...
              <MDTypography color="light" fontSize={15} fontWeight="bold">
                Total Data: {today?.length} | Page {currentPage} of{" "}
                {Math.ceil(today?.length / perPage)}
              </MDTypography>
              <MDButton
                variant="outlined"
                color="warning"
                disabled={
                  Math.ceil(today?.length / perPage) === currentPage
                    ? true
                    : false
                }
                size="small"
