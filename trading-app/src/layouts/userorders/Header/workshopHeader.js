...
function Header() {
  ...
  function internshipBackHandler() {
    ...
    axios
      .get(
        `${baseUrl}api/v1/internship/${url}?skip=${
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${baseUrl}api/v1/internship/${url}?skip=${internshipSkip}&limit=${limitSetting}`,
        {
          withCredentials: true,
          headers: {
            Accept: "application/json",
                  ...
                  <Grid item xs={12} md={6} lg={12}>
                    ...
                    >
                      ...
                      <MDTypography color="light" fontSize={15}>
                        You do not have any WorkShop trading orders!
                      </MDTypography>
                    </MDBox>
                  </Grid>
                </>
