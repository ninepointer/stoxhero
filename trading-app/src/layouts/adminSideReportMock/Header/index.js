...
export default function LabTabs() {
  ...
  if (alignment === companyDailyPnl) {
    endpoint = `infinityTrade/companypnlreport`;
  } else if (alignment === companyPnlTraderwise) {
    if (!value) {
      endpoint = `infinityTrade/traderwisecompanypnlreport`;
    } else {
      endpoint = `infinityTrade/companypnlreportsingleuser/${value?._id}`;
    }
  } else if (alignment === traderPnlTraderwise) {
    if (!value) {
      endpoint = `infinityTrade/traderwisetraderpnlreport`;
    } else {
      endpoint = `infinityTrade/traderpnlreportsingleuser/${value?._id}`;
    }
  } else if (alignment === traderMetrics) {
    endpoint = `infinityTrade/tradermatrixpnlreport`;
  }
  ...
  const handleShowDetails = async () => {
    ...
    if (from && to) {
      const res = await axios.get(`${apiUrl}${endpoint}/${from}/${to}`, {
        withCredentials: true,
      });
  ...
  if (dateWiseData.length > 0) {
    ...
    if (
      alignment === companyPnlTraderwise ||
      alignment === traderPnlTraderwise
    ) {
  ...
  let cumulativeTotalgpnl = 0,
    cumulativeTotalnpnl = 0,
    cumulativeTotalBrokerage = 0,
    cumulativeTotalOrders = 0,
    cumulativeTotalTradingDays = 0,
    cumulativeTotalGreenDays = 0,
    cumulativeTotalRedDays = 0;
  if (cumulativeData?.length > 0) {
    ...
    if (alignment === companyDailyPnl) {
      cumulativeTotalgpnl =
        cumulativeData[cumulativeData.length - 1]?.totalGpnl;
      cumulativeTotalnpnl =
        cumulativeData[cumulativeData.length - 1]?.totalNpnl;
      cumulativeTotalBrokerage =
        cumulativeData[cumulativeData.length - 1]?.totalBrokerage;
      cumulativeTotalOrders =
        cumulativeData[cumulativeData.length - 1]?.totalTrade;
      cumulativeTotalGreenDays =
        cumulativeData[cumulativeData.length - 1]?.greenDays;
      cumulativeTotalRedDays =
        cumulativeData[cumulativeData.length - 1]?.redDays;
      cumulativeTotalTradingDays =
        cumulativeData[cumulativeData.length - 1]?.tradingDays;
    }
  }
        ...
        <MDBox sx={{ display: "flex", alignItems: "center" }}>
          ...
          >
            ...
            <ToggleButton
              ...
              value={companyPnlTraderwise}
            >
              {companyPnlTraderwise}
            </ToggleButton>
            <ToggleButton
              style={{
                paddingLeft: 14,
              ...
              >
                ...
                >
                  <MDBox
                    ...
                    p={1}
                  >
                    <MDTypography fontSize={11} fontWeight="bold">
                      Gross:&nbsp;
                    </MDTypography>
                    <MDTypography
                      fontSize={11}
                      fontWeight="bold"
                      color={totalgpnl > 0 ? "success" : "error"}
                    >
                      {totalgpnl
                        ? totalgpnl >= 0
                          ? "+₹" +
                ...
                >
                  ...
                  >
                    ...
                    <MDTypography
                      fontSize={11}
                      fontWeight="bold"
                      color={totalnpnl > 0 ? "success" : "error"}
                    >
                      {totalnpnl
                        ? totalnpnl >= 0
                          ? "+₹" +
                ...
                >
                  ...
                  >
                    ...
                    <MDTypography fontSize={11} fontWeight="bold" color="info">
                      {totalBrokerage
                        ? "+₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          }).format(totalBrokerage)
                        : "+₹0"}
                    </MDTypography>
                  </MDBox>
                </Grid>
                ...
                >
                  ...
                  >
                    ...
                    <MDTypography fontSize={11} fontWeight="bold" color="error">
                      {totalRedDays}
                    </MDTypography>
                  </MDBox>
                </Grid>
                ...
                >
                  ...
                  >
                    ...
                    <MDTypography
                      fontSize={11}
                      fontWeight="bold"
                      color={cumulativeTotalgpnl > 0 ? "success" : "error"}
                    >
                      {cumulativeTotalgpnl
                        ? cumulativeTotalgpnl >= 0
                          ? "+₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(cumulativeTotalgpnl)
                          : "-₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                ...
                >
                  ...
                  >
                    ...
                    <MDTypography
                      fontSize={11}
                      fontWeight="bold"
                      color={cumulativeTotalnpnl > 0 ? "success" : "error"}
                    >
                      {cumulativeTotalnpnl
                        ? cumulativeTotalnpnl >= 0
                          ? "+₹" +
                      ...
                      {cumulativeTotalBrokerage
                        ? "+₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          }).format(cumulativeTotalBrokerage)
                        : "+₹0"}
                    </MDTypography>
                  </MDBox>
                </Grid>
