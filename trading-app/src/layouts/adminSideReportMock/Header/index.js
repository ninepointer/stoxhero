...
//   option: {
//     minHeight: '100px', // Adjust the height as per your requirement
//   },
// });
          ...
          <MDBox bgColor="light" borderRadius={5}>
            ...
            <MDBox>
              <Grid container spacing={0} p={1} display="flex" justifyContent="space-around" alignContent="center" alignItems="center">
                ...
                <Grid item xs={12} md={6} lg={2} mt={1} mb={1} display="flex" justifyContent="center" alignContent="center" alignItems="center">
                  ...
                  <Autocomplete
                    ...
                    // sx={{ width: 170, height: 100, maxHeight: 170, margin: "10px",  }}
                    freeSolo
                    renderInput={(params) => (
                      <TextField {...params} label="Select" sx={{ width: 170, height: 100, maxHeight: 170, margin: "10px", }} />
                    )}
                  // classes={{
                ...
                <Grid item xs={12} md={6} lg={2} mb={1}>
      ...
      <Grid mt={3} container>
        <Grid item xs={12} md={6} lg={12} overflow='auto'>
          <MDBox p={1} bgColor="light" borderRadius={4}>
            <MonthLineChart traderType={alignment} cumulativeData={cumulativeData} monthWiseData={dateWiseData} />
          </MDBox>
        </Grid>
