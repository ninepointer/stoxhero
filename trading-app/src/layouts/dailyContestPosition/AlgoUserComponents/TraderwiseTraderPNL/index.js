...
function TraderwiseTraderPNL({ socket }) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${baseUrl}api/v1/dailycontest/trade/${selectedContest?._id}/traderWisePnl`,
        { withCredentials: true }
      )
      .then((res) => {
        ...
        <Card>
          ...
          <MDBox>
            ...
            <MDBox
              style={{
                backgroundColor: `${
                  selectedContest?.entryFee > 0 ? "lightgreen" : "yellow"
                }`,
              }}
              borderRadius={3}
              m={1}
              ...
              <Grid container xs={12} md={12} lg={12}>
                ...
                <Grid item xs={12} md={12} lg={2}>
                  ...
                  >
                    ...
                    <MDTypography fontSize={13} fontWeight="bold">
                      {selectedContest?.isNifty === true ? "Yes" : "No"}
                    </MDTypography>
                  </MDBox>
                </Grid>
                <Grid item xs={12} md={12} lg={2}>
                  ...
                  >
                    ...
                    <MDTypography fontSize={13} fontWeight="bold">
                      {selectedContest?.isBankNifty === true ? "Yes" : "No"}
                    </MDTypography>
                  </MDBox>
                </Grid>
                <Grid item xs={12} md={12} lg={2}>
                  ...
                  >
                    ...
                    <MDTypography fontSize={13} fontWeight="bold">
                      {selectedContest?.isFinNifty === true ? "Yes" : "No"}
                    </MDTypography>
                  </MDBox>
                </Grid>
              </Grid>
