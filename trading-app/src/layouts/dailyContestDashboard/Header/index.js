...
export default function LabTabs({ socket }) {
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/dailycontest/trade/payoutchart`, {
  ...
  useEffect(() => {
    let call1 = axios.get(
      `${baseUrl}api/v1/dailycontest/contest/dailyallcontestusers`,
      {
        withCredentials: true,
        headers: {
            ...
            <Grid container xs={12} md={12} lg={12}>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  ...
                  >
                    Check all trader's TestZone position here!
                  </MDTypography>
                </MDBox>
              </Grid>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4, paddingRight: 4 }}
                  >
                    Check all trader's contest position here!
                  </MDTypography>
                </MDBox>
              </Grid>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4, paddingRight: 4 }}
                  >
                    Check all daily contest reports here!
                  </MDTypography>
                </MDBox>
              </Grid>
        ...
        <Grid item xs={12} md={12} lg={12}>
          <MDBox p={0.5}>
            {dailyAllContestUsers && (
              <DailyPaidContestUsers
                dailyAllContestUsers={dailyAllContestUsers}
              />
            )}
          </MDBox>
        </Grid>
