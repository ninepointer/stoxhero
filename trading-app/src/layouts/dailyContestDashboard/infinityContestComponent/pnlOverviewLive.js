...
export default function PnlOverviewLive({ socket }) {
  ...
  useEffect(() => {
    ...
    setIsLoading(true);
    axios
      .get(`${baseUrl}api/v1/dailycontest/live/overalltraderpnltoday`, {
        withCredentials: true,
      })
      .then((res) => {
    ...
    console.log("Loading: ", isLoading);
    axios
      .get(`${baseUrl}api/v1/dailycontest/live/liveandtotaltradercounttoday`, {
        withCredentials: true,
      })
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/dailycontest/live/overalltraderpnlyesterday`, {
        withCredentials: true,
      })
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/dailycontest/live/overalltraderpnlthismonth`, {
        withCredentials: true,
      })
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/dailycontest/live/overalltraderpnllifetime`, {
        withCredentials: true,
      })
      .then((res) => {
    ...
    axios
      .get(
        `${baseUrl}api/v1/dailycontest/live/liveandtotaltradercountyesterday`,
        { withCredentials: true }
      )
      .then((res) => {
              ...
              <Grid container xs={12} md={12} lg={12}>
                <Grid item p={2} xs={12} md={12} lg={5.9}>
                  <MDTypography fontSize={16} fontWeight="bold" color="dark">
                    Today's TestZone Position (Company Side) - Live
                  </MDTypography>
                ...
                <Grid item p={2} xs={12} md={12} lg={5.9}>
                  <MDTypography fontSize={16} fontWeight="bold" color="dark">
                    Last Trading Day TestZone Position (Company Side) - Live
                  </MDTypography>
                  <Grid container spacing={0.5} xs={12} md={12} lg={12} mt={1}>
                    <Grid item xs={4} md={4} lg={4}>
                      <MDTypography
          ...
          {isLoading ? (
            ...
            <>
              <Grid container xs={12} md={12} lg={12}>
                <Grid item p={2} xs={12} md={12} lg={5.9}>
                  <MDTypography fontSize={16} fontWeight="bold" color="dark">
                    MTD till Yesterday TestZone Position (Company Side) - Live
                  </MDTypography>
                  <Grid container spacing={0.5} xs={12} md={12} lg={12} mt={1}>
                    <Grid item xs={4} md={4} lg={4}>
                      <MDTypography
