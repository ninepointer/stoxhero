...
export default function PnlOverviewMock({ socket }) {
  ...
  useEffect(() => {
    ...
    setIsLoading(true);
    axios
      .get(`${baseUrl}api/v1/dailycontest/trade/overalltraderpnltoday`, {
    ...
    console.log("Loading: ", isLoading);
    axios
      .get(`${baseUrl}api/v1/dailycontest/trade/liveandtotaltradercounttoday`, {
        withCredentials: true,
      })
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/dailycontest/trade/overalltraderpnlyesterday`, {
        withCredentials: true,
      })
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/dailycontest/trade/overalltraderpnlthismonth`, {
        withCredentials: true,
      })
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/dailycontest/trade/overalltraderpnllifetime`, {
        withCredentials: true,
      })
      .then((res) => {
    ...
    axios
      .get(
        `${baseUrl}api/v1/dailycontest/trade/liveandtotaltradercountyesterday`,
        { withCredentials: true }
      )
      .then((res) => {
