...
const AccountsModel = ({ Render }) => {
  ...
  async function formbtn() {
    ...
    const { AccountID, Broker, AccountName, APIKey, APISecret, Status } =
      formstate;
        ...
        <DialogContent>
          <DialogContentText sx={{ display: "flex", flexDirection: "column" }}>
            <TextField
              ...
              onChange={(e) => {
                formstate.Broker = e.target.value;
              }}
            />
            ...
            <TextField
              ...
              sx={{ margin: 1, padding: 1, width: "300px" }}
              onChange={(e) => {
                formstate.AccountID = e.target.value;
              }}
            />
            ...
            <TextField
              ...
              sx={{ margin: 1, padding: 1, width: "300px" }}
              onChange={(e) => {
                formstate.AccountName = e.target.value;
              }}
            />
            ...
            <TextField
              ...
              sx={{ margin: 1, padding: 1, width: "300px" }}
              onChange={(e) => {
                formstate.APIKey = e.target.value;
              }}
            />
            ...
            <TextField
              ...
              sx={{ margin: 1, padding: 1, width: "300px" }}
              onChange={(e) => {
                formstate.APISecret = e.target.value;
              }}
            />
