...
export default function LabTabs({ socket }) {
  ...
  useEffect(() => {
    ...
    setIsLoading(true);
    axios
      .get(`${baseUrl}api/v1/papertrade/virtualoveralltraderpnltoday`)
      .then((res) => {
    ...
    console.log("Loading: ", isLoading);
    axios
      .get(`${baseUrl}api/v1/papertrade/liveandtotaltradercounttoday`)
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/papertrade/dailyvirtualusers`)
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/papertrade/virtualoveralltraderpnlyesterday`)
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/papertrade/liveandtotaltradercountyesterday`)
      .then((res) => {
    ...
    >
              ...
              <Grid container>
                <Grid item p={2} xs={12} lg={5.9}>
                  <MDTypography fontSize={16} fontWeight="bold" color="dark">
                    Today's Virtual Trading Position (Trader Side)
                  </MDTypography>
                  <Grid container mt={1}>
                    <Grid item lg={4}>
                      <MDTypography
                ...
                <Grid item p={2} xs={12} lg={5.9}>
                  <MDTypography fontSize={16} fontWeight="bold" color="dark">
                    Last Virtual Trading Day (Trader Side) -{" "}
                    {new Date(lastVirtualTradingDate).toLocaleDateString(
                      "en-US",
                      {
                        day: "numeric",
                        month: "short",
      ...
      >
        <Grid item xs={12} md={12} lg={12}>
          <MDBox p={0.5}>
            {dailyVirtualUsers && (
              <DailyVirtualUsers dailyVirtualUsers={dailyVirtualUsers} />
            )}
          </MDBox>
        </Grid>
      </Grid>
            ...
            <Grid container>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  ...
                  >
                    Check today's virtual trading position here!
                  </MDTypography>
                </MDBox>
              </Grid>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4, paddingRight: 4 }}
                  >
                    Check all trader's virtual position here!
                  </MDTypography>
                </MDBox>
              </Grid>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4, paddingRight: 4 }}
                  >
                    Check all virtual trading reports here!
                  </MDTypography>
                </MDBox>
              </Grid>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4, paddingRight: 4 }}
                  >
                    Check all virtual trader's queries here!
                  </MDTypography>
                </MDBox>
              </Grid>
