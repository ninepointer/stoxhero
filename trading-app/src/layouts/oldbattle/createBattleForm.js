...
function Index() {
  ...
  const [formState, setFormState] = useState({
    ...
    battleLiveTime:
      dayjs(battle?.battleLiveTime) ??
      dayjs(new Date()).set("hour", 0).set("minute", 0).set("second", 0),
    battleStartTime:
      dayjs(battle?.battleStartTime) ??
      dayjs(new Date()).set("hour", 0).set("minute", 0).set("second", 0),
    battleEndTime:
      dayjs(battle?.battleEndTime) ??
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/portfolio/battleportfolio`, {
    ...
    axios
      .get(`${baseUrl}api/v1/college/${battle?.college?._id}`, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  async function onSubmit(e, formState) {
    ...
    try {
      ...
      if (
        !formState.battleName ||
        !formState.battleLiveTime ||
        !formState.battleStartTime ||
        !formState.battleEndTime ||
        !formState.battleStatus ||
  ...
  async function onEdit(e, formState) {
    ...
    console.log(
      "Edited FormState: ",
      new Date(formState.battleStartTime).toISOString(),
      new Date(formState.battleEndTime).toISOString()
    );
    setSaving(true);
      ...
      {isLoading ? (
        ...
        <MDBox pl={2} pr={2} mt={4}>
            ...
            <Grid container spacing={2} mt={0.5} mb={0} xs={12} md={9} xl={12}>
              <Grid item xs={12} md={6} xl={3}>
                <TextField
                  ...
                  fullWidth
                  defaultValue={
                    editing ? formState?.battleName : battle?.battleName
                  }
                  onChange={(e) => {
                    setFormState((prevState) => ({
                      ...prevState,
                  ...
                  <DemoContainer components={["MobileDateTimePicker"]}>
                    <DemoItem>
                      <MobileDateTimePicker
                        ...
                        disabled={
                          (isSubmitted || battle) && (!editing || saving)
                        }
                        value={
                          formState?.battleLiveTime || battle?.battleLiveTime
                        }
                        onChange={(newValue) => {
                          if (newValue && newValue.isValid()) {
                            setFormState((prevState) => ({
                              ...prevState,
                              battleLiveTime: newValue,
                            }));
                          }
                        }}
                        minDateTime={null}
                  ...
                  <DemoContainer components={["MobileDateTimePicker"]}>
                    <DemoItem>
                      <MobileDateTimePicker
                        ...
                        value={
                          formState?.battleStartTime || battle?.battleStartTime
                        }
                        onChange={(newValue) => {
                          if (newValue && newValue.isValid()) {
                            setFormState((prevState) => ({
                              ...prevState,
                              battleStartTime: newValue,
                            }));
                          }
                        }}
                        minDateTime={null}
                  ...
                  <DemoContainer components={["MobileDateTimePicker"]}>
                    <DemoItem>
                      <MobileDateTimePicker
                        ...
                        value={
                          formState?.battleEndTime || battle?.battleEndTime
                        }
                        onChange={(newValue) => {
                          if (newValue && newValue.isValid()) {
                            setFormState((prevState) => ({
                              ...prevState,
                              battleEndTime: newValue,
                            }));
                          }
                        }}
                        minDateTime={null}
              ...
              {(formState?.battleFor === "College" ||
                battle?.battleFor === "College") && (
                <>
                  ...
                  <Grid item xs={12} md={6} xl={3}>
                    <TextField
                      ...
                      fullWidth
                      defaultValue={
                        editing ? formState?.collegeCode : battle?.collegeCode
                      }
              ...
              <Grid item xs={12} md={6} xl={3} mb={2}>
                <TextField
                  ...
                  type="number"
                  defaultValue={
                    editing ? formState?.entryFee : battle?.entryFee
                  }
                  // onChange={handleChange}
                  onChange={(e) => {
                    setFormState((prevState) => ({
              ...
              <Grid item xs={12} md={6} xl={12} mt={-2}>
                <TextField
                  ...
                  fullWidth
                  defaultValue={
                    editing ? formState?.description : battle?.description
                  }
                  onChange={handleChange}
                />
              </Grid>
              ...
              <Grid item xs={12} md={3} xl={3}>
                <FormControl sx={{ minHeight: 10, minWidth: 263 }}>
                  ...
                  <Select
                    ...
                    disabled={(isSubmitted || battle) && (!editing || saving)}
                    value={
                      formState?.portfolio?.name?.portfolio?.portfolioName ||
                      battle?.portfolio?.portfolioName
                    }
          ...
          {(isSubmitted || battle) && (
            <CreateRules
              battle={
                battle != undefined ? battle?._id : createdBattle?.data?._id
              }
            />
          )}
          {(isSubmitted || battle) && (
