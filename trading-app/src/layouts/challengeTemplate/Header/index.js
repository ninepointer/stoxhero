...
import ActiveChallengeTemplate from '../data/activeChallengeTemplate';
import InactiveChallengeTemplate from '../data/inactiveChallengeTemplate';
...
export default function LabTabs() {
  ...
  return (
    ...
    size="small"
    component={Link}
    to='/challengedashboard/challengetemplateform'
    >
