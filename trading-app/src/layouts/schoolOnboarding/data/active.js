              ...
              <MDBox style={{ borderRadius: 4, minWidth: '100%' }} display='flex' justifyContent='center' alignItems='center'>
                ...
                >
                  <Grid container xs={12} md={12} lg={12} display="flex" justifyContent="center" alignItems='center'>
                    ...
                    <Grid item xs={12} md={3} lg={5} display="flex" justifyContent="center" alignItems='center'>
                      <MDTypography variant="body3">School</MDTypography>
                    </Grid>
                    <Grid item xs={12} md={3} lg={2} display="flex" justifyContent="center" alignItems='center'>
                      <MDTypography variant="body3">Board</MDTypography>
                    </Grid>
                    <Grid item xs={12} md={3} lg={2} display="flex" justifyContent="center" alignItems='center'>
                      <MDTypography variant="body3">Affiliate No.</MDTypography>
                    </Grid>
                    <Grid item xs={12} md={3} lg={2} display="flex" justifyContent="center" alignItems='center'>
                  ...
                  <MDBox style={{ borderRadius: 4, minWidth: '100%' }}>
                    ...
                    >
                      <Grid container xs={12} md={12} lg={12} display="flex" justifyContent="center" alignItems='center'>
                        ...
                        <Grid item xs={12} md={3} lg={5} display="flex" justifyContent="center" alignItems='center'>
                          <MDTypography variant="body3">{e?.school_name}</MDTypography>
                        </Grid>
                        <Grid item xs={12} md={3} lg={2} display="flex" justifyContent="center" alignItems='center'>
                          <MDTypography variant="body3">{e?.board}</MDTypography>
                        </Grid>
                        <Grid item xs={12} md={3} lg={2} display="flex" justifyContent="center" alignItems='center' >
                          <MDTypography variant="body3">{e?.aff_no}</MDTypography>
                        </Grid>
                        <Grid item xs={12} md={3} lg={2} display="flex" justifyContent="center" alignItems='center' >
