...
export default function BatchAndCollegeWise({ id, college }) {
  ...
  useEffect(() => {
    ...
    if (id && college && open) {
      axios
        .get(
          `${baseUrl}api/v1/internbatch/batchandcollegewise/${id}/${college}`,
          {
          ...
          {activeUser.length > 0 && (
            <Grid container spacing={1} mt={2}>
              <Grid
                ...
                lg={12}
                mb={1}
                style={{ backgroundColor: "#344767", borderRadius: 5 }}
                display="flex"
              ...
              >
                ...
                >
                  ...
                  <MDTypography
                    ...
                    fontSize={13}
                    fontWeight="bold"
                  >{`College Wise Active User Info (${activeUser.length})`}</MDTypography>
                  <MDTypography
                    style={{ cursor: "pointer" }}
                    onClick={() => {
                      handleDownload(collegeActiveUser, "collegeActiveUser");
                    }}
                  >
                    <DownloadIcon />{" "}
                  </MDTypography>
              ...
              <Grid
                container
                p={1}
                style={{ border: "1px solid #344767", borderRadius: 5 }}
              >
                <Grid
                  item
                  xs={12}
                  ...
                  alignItems="center"
                >
                  <MDTypography color="dark" fontSize={9} fontWeight="bold">
                    NAME
                  </MDTypography>
                </Grid>
                <Grid
              ...
              >
                ...
                >
                  ...
                  <MDTypography
                    ...
                    fontSize={13}
                    fontWeight="bold"
                  >{`College Wise Inactive User Info (${inactiveUser.length})`}</MDTypography>
                  <MDTypography
                    style={{ cursor: "pointer" }}
                    onClick={() => {
                      handleDownload(
