...
function Index() {
  ...
  const [formState, setFormState] = useState({
    ...
    cummulativeTotalPurchaseTurnover:
      "" || id?.cummulativeTotalPurchaseTurnover,
  ...
  const getPnlDetails = async (e, fromDate) => {
    ...
    try {
      const res = await axios.get(
        `${baseUrl}api/v1/infinityTrade/live/brokerreportmatch/${e
          .toDate()
          .toISOString()
          .substr(0, 10)}/${fromDate.toDate().toISOString().substr(0, 10)}`,
  ...
  const getBrokerPnlDetails = async (e) => {
    ...
    try {
      const res = await axios.get(
        `${baseUrl}api/v1/brokerreport/singular/${formState.brokerName}/${e
          .toDate()
          .toISOString()
          .substr(0, 10)}`,
        { withCredentials: true }
        ...
        <MDBox pl={2} pr={2} mt={4}>
            ...
            <Grid container spacing={1} mt={0.5} mb={0} xs={12} md={9} xl={12}>
              ...
              <Grid item xs={12} md={6} xl={3} mt={1}>
                <TextField
                  ...
                  fullWidth
                  defaultValue={
                    formState?.brokerName || brokerReport?.brokerName
                  }
                  onChange={(e) => {
                    setFormState((prevState) => ({
                      ...prevState,
              ...
              {(isSubmitted || id) && !editing && (
                <>
                  ...
                  <MDButton
                    ...
                    size="small"
                    onClick={() => {
                      id ? navigate("/brokerreports") : setIsSubmitted(false);
                    }}
                  >
                    Back
                  </MDButton>
          ...
          {Object.keys(pnlDetails).length > 0 && (
            <MDBox bgColor="dark" mt={1} borderRadius={5}>
              <Grid container p={2}>
                ...
                >
                  <Grid
                    ...
                    alignItems="center"
                  >
                    <MDTypography fontSize={15} color="dark" fontWeight="bold">
                      Infinity P&L for {pnlDetails?.date} [As per StoxHero App]
                    </MDTypography>
                  </Grid>
                </MDBox>
                <MDBox
                ...
                >
                  ...
                  >
                    <MDTypography fontSize={15} color="light">
                      Transaction:{" "}
                      {pnlDetails?.brokerage >= 0
                        ? "₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          }).format(pnlDetails?.brokerage)
                        : "-₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                ...
                >
                  ...
                  >
                    <MDTypography fontSize={15} color="light">
                      Total Turn:{" "}
                      {pnlDetails?.totalTurnover >= 0
                        ? "₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          }).format(pnlDetails?.totalTurnover)
                        : "-₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                  ...
                  >
                    <MDTypography fontSize={15} color="light">
                      Pur Turn:{" "}
                      {pnlDetails?.purchaseTurnover >= 0
                        ? "₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          }).format(pnlDetails?.purchaseTurnover)
                        : "-₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                  ...
                  >
                    <MDTypography fontSize={15} color="light">
                      Sale Turn:{" "}
                      {pnlDetails?.saleTurnover >= 0
                        ? "₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          }).format(pnlDetails?.saleTurnover)
                        : "-₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                ...
                >
                  ...
                  >
                    <MDTypography fontSize={15} color="light">
                      Cumm. Gross P&L:{" "}
                      {cummulativePnlDetails?.totalGpnl >= 0
                        ? "+₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          }).format(cummulativePnlDetails?.totalGpnl)
                        : "-₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                  ...
                  >
                    <MDTypography fontSize={15} color="light">
                      Cumm. Net P&L:{" "}
                      {cummulativePnlDetails?.totalNpnl >= 0
                        ? "+₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          }).format(cummulativePnlDetails?.totalNpnl)
                        : "-₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                  ...
                  >
                    <MDTypography fontSize={15} color="light">
                      Cumm. Transaction:{" "}
                      {cummulativePnlDetails?.totalBrokerage >= 0
                        ? "₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          }).format(cummulativePnlDetails?.totalBrokerage)
                        : "-₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                ...
                >
                  ...
                  >
                    <MDTypography fontSize={15} color="light">
                      Cumm. Total Turn:{" "}
                      {cummulativePnlDetails?.cummulativeTotalTurnover >= 0
                        ? "₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          }).format(
                            cummulativePnlDetails?.cummulativeTotalTurnover
                          )
                        : "-₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                  ...
                  >
                    <MDTypography fontSize={15} color="light">
                      Cumm. Pur Turn:{" "}
                      {cummulativePnlDetails?.cummulativePurchaseTurnover >= 0
                        ? "₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          }).format(
                            cummulativePnlDetails?.cummulativePurchaseTurnover
                          )
                        : "-₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                  ...
                  >
                    <MDTypography fontSize={15} color="light">
                      Cumm. Sale Turn:{" "}
                      {cummulativePnlDetails?.cummulativeSaleTurnover >= 0
                        ? "₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          }).format(
                            cummulativePnlDetails?.cummulativeSaleTurnover
                          )
                        : "-₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
              ...
              {Object.keys(brokerPnlDetails).length > 0 && (
                <Grid container p={2}>
                  <MDBox
                    bgColor="light"
                    display="flex"
                  ...
                  >
                    ...
                    >
                      <MDTypography
                        ...
                        fontWeight="bold"
                      >
                        Infinity P&L for {pnlDetails?.date} [As per Broker]
                      </MDTypography>
                    </Grid>
                  </MDBox>
                  <MDBox
                  ...
                  >
                    ...
                    >
                      <MDTypography fontSize={15} color="light">
                        Gross P&L:{" "}
                        {brokerPnlDetails?.cummulativeGrossPNL >= 0
                          ? "+₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(brokerPnlDetails?.cummulativeGrossPNL)
                          : "-₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                    ...
                    >
                      <MDTypography fontSize={15} color="light">
                        Net P&L:{" "}
                        {brokerPnlDetails?.cummulativeNetPNL >= 0
                          ? "+₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(brokerPnlDetails?.cummulativeNetPNL)
                          : "-₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                    ...
                    >
                      <MDTypography fontSize={15} color="light">
                        Transaction:{" "}
                        {brokerPnlDetails?.cummulativeTransactionCharge >= 0
                          ? "+₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(
                              brokerPnlDetails?.cummulativeTransactionCharge
                            )
                          : "-₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                ...
                <MDTypography fontSize={15} color='light'>
                  ...
                  >
                    ...
                    >
                      <MDTypography fontSize={15} color="light">
                        Total Turn:{" "}
                        {brokerPnlDetails?.cummulativeOptionsTurnover >= 0
                          ? "+₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(
                              brokerPnlDetails?.cummulativeOptionsTurnover
                            )
                          : "-₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                    ...
                    >
                      <MDTypography fontSize={15} color="light">
                        Pur Turn:{" "}
                        {brokerPnlDetails?.cummulativeTotalPurchaseTurnover >= 0
                          ? "+₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(
                              brokerPnlDetails?.cummulativeTotalPurchaseTurnover
                            )
                          : "-₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                    ...
                    >
                      <MDTypography fontSize={15} color="light">
                        Sale Turn:{" "}
                        {brokerPnlDetails?.cummulativeTotalSaleTurnover >= 0
                          ? "+₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(
                              brokerPnlDetails?.cummulativeTotalSaleTurnover
                            )
                          : "-₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
