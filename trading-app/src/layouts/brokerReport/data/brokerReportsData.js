...
const BrokerReports = () => {
  ...
  function backHandler() {
    ...
    axios
      .get(
        `${baseUrl}api/v1/brokerreport/?skip=${
          skip - limitSetting
        }&limit=${limitSetting}`,
        {
          withCredentials: true,
  ...
  function Delete(id) {
    console.log(id);
    axios
      .get(`${baseUrl}api/v1/brokerreport/delete/${id}`, {
        withCredentials: true,
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
                ...
                >
                  ...
                  >
                    <MDTypography
                      ...
                      fontWeight="bold"
                    >
                      {elem?.cummulativeGrossPNL >= 0
                        ? "+₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          }).format(elem?.cummulativeGrossPNL)
                        : "-₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                  ...
                  >
                    <MDTypography
                      ...
                      fontWeight="bold"
                    >
                      {elem?.cummulativeNetPNL >= 0
                        ? "+₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          }).format(elem?.cummulativeNetPNL)
                        : "-₹" +
                          new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
        ...
        {!isLoading && count !== 0 && (
          ...
          >
            ...
            <MDTypography color="light" fontSize={15} fontWeight="bold">
              Total Reports: {!count ? 0 : count} | Page{" "}
