...
function FAQs() {
  ...
  return (
    ...
    <MDBox>
        <MDBox>
            <MDTypography mt={2} fontSize={25} fontWeight="bold" align="center">Have questions about StoxHero?</MDTypography>
            <MDTypography fontSize={20} fontWeight="normal" align="center">Find your answers in the Frequently Asked Questions (FAQs)</MDTypography>
        </MDBox>
        <Grid container spacing={2} xs={12} md={12} lg={12} mt={1}  mb={5} display="flex" justifyContent="center">
            <Grid item xs={12} md={12} lg={10}>
                <MDBox bgColor="dark" style={{border:'1px solid black', borderRadius:5}}>
                    <MDBox display="flex" justifyContent="space-between" alignItems="center">
                    <MDTypography style={{fontSize:18, fontWeight:700}} color="light" ml={2}>About StoxHero</MDTypography>
                    ...
                    {expanded[1] && 
                    <>
                    <MDTypography ml={2} mr={2} fontSize={15} fontWeight="bold" color="light">What is StoxHero?</MDTypography>
                    <MDTypography ml={2} mr={2} fontSize={13} color="light">
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">Can I Join A Battle On StoxHero Without A Trading Account?</MDTypography>
                    <MDTypography ml={2} mr={2} fontSize={13} color="light">
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">Do I Trade Contracts With Real Money?</MDTypography>
                    <MDTypography ml={2} mr={2} fontSize={13} mb={2} color="light">
            ...
            <Grid item xs={12} md={12} lg={10}>
                <MDBox bgColor="dark" style={{border:'1px solid black', borderRadius:5}}>
                    <MDBox display="flex" justifyContent="space-between" alignItems="center">
                    <MDTypography style={{fontSize:18, fontWeight:700}} color="light" ml={2}>Login & Registration</MDTypography>
                    ...
                    {expanded[2] && 
                    <>
                    <MDTypography ml={2} mr={2} fontSize={15} fontWeight="bold" color="light">How Do I Register On StoxHero?</MDTypography>
                    <MDTypography ml={2} mr={2} fontSize={13} color="light" display="flex" justifyContent="left" flexDirection="flex-start" alignContent="center" alignItems="center">
                       <span>&#x2022; &nbsp;</span> 
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">Where Can I Find Invitation Code?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
            ...
            <Grid item xs={12} md={12} lg={10}>
                <MDBox bgColor="dark" style={{border:'1px solid black', borderRadius:5}}>
                    <MDBox display="flex" justifyContent="space-between" alignItems="center">
                    <MDTypography style={{fontSize:18, fontWeight:700}} color="light" ml={2}>Portfolios</MDTypography>
                    ...
                    {expanded[3] && 
                    <>
                    <MDTypography ml={2} mr={2} fontSize={15} fontWeight="bold" color="light">What Is A Portfolio?</MDTypography>
                    <MDTypography ml={2} mr={2} fontSize={13} color="light" display="flex" justifyContent="left" flexDirection="flex-start" alignContent="center" alignItems="center">
                       <span>&#x2022; &nbsp;</span> 
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">What Are Mania And Fever Portfolios?</MDTypography>
                    <MDTypography ml={2} mr={2} fontSize={13} color="light">
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">What Is A Trading Portfolio?</MDTypography>
                    <MDTypography ml={2} mr={2} fontSize={13} mb={2} color="light">
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">What Is The Difference Between Mania And Fever Portfolios?</MDTypography>
                    <MDTypography ml={2} mr={2} fontSize={13} mb={2} color="light">
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">Can I Join Multiple Leagues With The Same Portfolio?</MDTypography>
                    <MDTypography ml={2} mr={2} fontSize={13} mb={2} color="light">
                        No, you can only join 1 league with 1 portfolio.
                    </MDTypography> 

                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">Can I Join A League With Multiple Portfolios?</MDTypography>
                    <MDTypography ml={2} mr={2} fontSize={13} mb={2} color="light">
                        No, you can only join a league with a single portfolio.
                    </MDTypography>

                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">Is There A Limit On The Number Of Portfolios I Can Use?</MDTypography>
                    <MDTypography ml={2} mr={2} fontSize={13} mb={2} color="light">
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">What Is Portfolio Value? How Is It Different From Opening Balance?</MDTypography>
                    <MDTypography ml={2} mr={2} fontSize={13} color="light" display="flex" justifyContent="left" flexDirection="flex-start" alignContent="center" alignItems="center">
                       <span>&#x2022; &nbsp;</span> 
                    ...
                    <MDTypography ml={2} mr={2} fontSize={13} mb={2} color="light" display="flex" justifyContent="left" flexDirection="flex-start" alignContent="center" alignItems="center">
                       <span>&#x2022; &nbsp;</span> 
            ...
            <Grid item xs={12} md={12} lg={10}>
                <MDBox bgColor="dark" style={{border:'1px solid black', borderRadius:5}}>
                    <MDBox display="flex" justifyContent="space-between" alignItems="center">
                    <MDTypography style={{fontSize:18, fontWeight:700}} color="light" ml={2}>StoxHero Battles</MDTypography>
                    ...
                    {expanded[5] && 
                    <>
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">What Is A Battle?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">Can I Create My Own League?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">What is 'Upcoming Battles' tab?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">What is 'My Battle' tab?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
                        My Battles tab has all those battle which you've enrolled in and is yet to end.
                    </MDTypography>

                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">What is 'History' tab?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
                        History tab has all those battles in which you've participated.
                    </MDTypography>

                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">Can I Join Battle Everyday And At Any Time?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">How Can I Join Leagues?</MDTypography>
                    <MDTypography ml={2} mr={2} fontSize={13} color="light" display="flex" justifyContent="left" flexDirection="flex-start" alignContent="center" alignItems="center">
                       <span>&#x2022; &nbsp;</span> 
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">What Are The Rules Of A Battle?</MDTypography>
                    <MDTypography ml={2} mr={2} fontSize={13} color="light" display="flex" justifyContent="left" flexDirection="flex-start" alignContent="center" alignItems="center">
                       <span>&#x2022; &nbsp;</span> 
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">Can I Exit The Battle Before It Starts?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
                        Yes, a battle can be exited before it starts.
                    </MDTypography>

                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">Where Can I See The Battle I Joined In The Past?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
                        You can visit 'History' tab under Battle Ground tab to see the battles which you joined in the past.
                    </MDTypography>

                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">What Is 'Transaction Fee'?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">When Does Trading Start On The StoxHero App?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
            ...
            <Grid item xs={12} md={12} lg={10}>
                <MDBox bgColor="dark" style={{border:'1px solid black', borderRadius:5}}>
                    <MDBox display="flex" justifyContent="space-between" alignItems="center">
                    <MDTypography style={{fontSize:18, fontWeight:700}} color="light" ml={2}>Points & Ranking System</MDTypography>
                    ...
                    {expanded[4] && 
                    <>
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">When Are The Winners Announced?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">How Are The Winners Decided?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
                        Participants are ranked on the basis of the profit made in that contest.
                    </MDTypography>

                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">How Are Rewards Distributed To The Players?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">What Is The Hero's Chart?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
            ...
            <Grid item xs={12} md={12} lg={10}>
                <MDBox bgColor="dark" style={{border:'1px solid black', borderRadius:5}}>
                    <MDBox display="flex" justifyContent="space-between" alignItems="center">
                    <MDTypography style={{fontSize:18, fontWeight:700}} color="light" ml={2}>StoxHero Account</MDTypography>
                    ...
                    {expanded[5] && 
                    <>
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">What Is A StoxHero Account?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
                        StoxHero Account reflects all your rewards. It shows your StoxHero cash and Bonus cash balance.
                    </MDTypography>

                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">How Can I Withdraw Money From My StoxHero Account?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">What Are The Limits For Withdrawing Money?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={1} fontSize={13} color="light">
                    ...
                    <MDTypography ml={2} mr={2} mt={1} fontSize={15} fontWeight="bold" color="light">What Is Hero Cash? Can I Withdraw It?</MDTypography>
                    <MDTypography ml={2} mr={2} mb={2} fontSize={13} color="light">
        ...
        <MDBox>
            <MDTypography mt={2} fontSize={20} mb={8} fontWeight="bold" align="center">For any additional queries, drop us an email @ team@stoxhero.com</MDTypography>
        </MDBox>
    </MDBox>
    </>
  );
