  ...
  useEffect(() => {
    ...
    Promise.all([call1])
      .then(([api1Response]) => {
        ...
        setSelectedSubtopic(
          api1Response?.data?.data?.courseContent?.[0]?.subtopics?.[0]
        );
      ...
      {courses ? (
        ...
        >
          {!hasPurchased && (
            <>
              <BlurPage
                course={courses}
                message={message}
                workshop={courses?.type === "Workshop" ? true : false}
              />
              <MDBox
                style={{
          ...
          >
            <Grid item xs={12} sm={12} md={12} lg={8.4} xl={8.4}>
              <MDBox>
                ...
                <Typography
                  fontSize={16}
                  fontWeight={700}
                  sx={{ color: "#000000", padding: "5px 0px 5px 15px" }}
                >
                  <span>
                    Topic&nbsp;{selectedTopic?.order}.{selectedSubtopic?.order}
                    &nbsp;:&nbsp;
                  </span>
            ...
            {!isMobile && (
              <Grid item xs={12} sm={12} md={12} lg={3.6} xl={3.6}>
                <MDBox
                  style={{
                    position: "fixed",
                    top: 82,
