...
import AllWorkshop from './allWorkshops.js';
...
const Courses = () => {
  ...
  useEffect(() => {
    let call1 = axios.get(`${apiUrl}courses/user/courses?skip=${skip}&limit=${limitSetting}`, {
  ...
  return (
    <>
     ...
     <>
      ...
      <AllWorkshop data={workshop} showPay={showPay} setShowPay={setShowPay} />
      <MDTypography
        variant="body2"
        fontWeight="bold"
        fontSize='20px'
