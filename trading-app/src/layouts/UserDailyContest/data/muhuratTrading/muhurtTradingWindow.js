...
import Leaderboard from '../dailyContestLeaderboard'
import DailyContestMyRank from '../newMyRank';
...
// import DiwaliBG from '../../../assets/images/diwaliBG.gif';
import BasicLayout from "../../../authentication/components/BasicLayout";
import Card from "@mui/material/Card";
import MuhuratReward from "./muhuratReward";
...
function Header({ socket, data }) {
    ...
    return (
        <>
            {/* <BasicLayout image={DiwaliBG} >
                <Card> */}
                    <MDBox color="dark" mt={2} mb={1} borderRadius={10} minHeight='80vH' 
                    // position='relative'
                    >
                        {/* <img src={DiwaliBG} minHeight='80vH' width='100%' style={{borderRadius: "10px", zIndex: -100}} /> */}
                        {/* <img src={DiwaliBG} minHeight='80vH' width='100%' style={{borderRadius: "10px", zIndex: -100, position: 'absolute', top: 0, left: 0}} /> */}
