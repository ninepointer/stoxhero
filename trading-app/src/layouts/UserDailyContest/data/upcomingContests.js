    ...
    return (
        ...
        <MDBox bgColor="dark" color="light" display='flex' justifyContent='center' flexDirection='column'  mb={0.5} borderRadius={10} minHeight='auto' width='100%'>
            ...
            {contest.length != 0 ?
                <Grid container xs={12} md={12} lg={12} display='flex'>
                    ...
                    <Grid item xs={12} md={6} lg={12}>
                        ...
                        <>
                            <MDBox>
                                <MDTypography color="light" fontSize={15} fontWeight="bold" ml={1} mb={0.5} alignItems='center'>Free TestArena(s)</MDTypography>
                            </MDBox>
                    ...
                    <Grid item xs={12} md={6} lg={12} mt={.5}>
                        ...
                        <>
                            <MDBox>
                                <MDTypography color="light" fontSize={15} ml={1} mb={0.5} fontWeight="bold">Paid TextArena(s)</MDTypography>
                            </MDBox>
                            <MDBox style={{ minWidth: '100%' }}>
            ...
            <MDBox style={{minHeight:"20vh"}} border='1px solid white' borderRadius={5} display="flex" justifyContent="center" flexDirection="column" alignContent="center" alignItems="center">
                ...
                <MDTypography color="light" fontSize={15} mb={1}>No Upcoming TestArena(s)</MDTypography>
                <MDButton color="info" size='small' fontSize={10}  onClick={()=>{setClicked("live")}} >Check Live TestArena(s)</MDButton>
            </MDBox>
            }
            </>
            }
