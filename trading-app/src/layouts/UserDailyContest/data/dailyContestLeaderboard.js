                                ...
                                <Grid item lg={12}>
                                            ...
                                            <Grid item xs={12} md={6} lg={12} display='flex' justifyContent='center' alignItems='center'>
                                                        ...
                                                        <Grid item lg={6} display='flex' justifyContent='left' alignItems='center'>
                                                            <MDTypography fontSize={15} color='light' fontWeight='bold'>StoxHero Wednesday Mania Contest Leaderboard</MDTypography>
                                                        </Grid>
                            ...
                            <Grid item lg={12} mb={1}>
                                <Grid container spacing={0.5} lg={12} display='flex' justifyContent='center' alignItems='center'>
                                    ...
                                    <Grid item xs={12} md={6} lg={2} display='flex' justifyContent='center'>
                                        <MDBox><MDTypography fontSize={25} color='light' fontWeight='bold'>#1</MDTypography></MDBox>
                                    </Grid>
                                    ...
                                    <Grid item xs={12} md={6} lg={4} display='flex' justifyContent='center'>
                                        <MDBox><MDTypography fontSize={15} color='light' fontWeight='bold'>Prateek Pawan</MDTypography></MDBox>
                                    </Grid>

                                    <Grid item xs={12} md={6} lg={4} display='flex' justifyContent='center'>
                                        <MDBox><MDTypography fontSize={15} color='light' fontWeight='bold'>+₹2,22,000</MDTypography></MDBox>     
                                    </Grid>
