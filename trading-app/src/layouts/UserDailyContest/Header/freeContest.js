                                                    ...
                                                    <Grid item xs={12} md={12} lg={12} mt={1} mb={1}>
                                                        {particularContestTime[0]?.value > 0 ?
                                                            ...
                                                            <MDBox color="light" fontSize={10} display="flex" >
                                                                <HiUserGroup color='black' /><MDBox color={"dark"} style={{ marginLeft: 3, marginTop: 3, fontWeight: 700 }}>{isInterestedState[elem?._id]?.count} PEOPLE HAVE SHOWN INTEREST IN THIS TestZone</MDBox>
                                                            </MDBox>
                                                            :
                                                            particularContestTime[0]?.value <= 0 &&
                                                        ...
                                                        <MDBox display='flex' justifyContent='space-between' flexDirection='row' width='100%'>
                                                            ...
                                                            <MDBox display='flex' justifyContent='flex-start' width='50%'>
                                                                {(particularContestTime[0]?.value > 0 && !checkIsInterested) &&
                                                                    <PopupMessage isInterested={checkIsInterested} setIsInterested={setIsInterested} isInterestedState={isInterestedState} setIsInterestedState={setIsInterestedState} elem={elem} data={`Thanks for showing interest in ${elem.contestName} contest. You will be notified 10 mins before the TestZone starts on your WhatsApp Number.`} />
                                                                }
                                                                {checkIsInterested &&
