...
import LiveContests from "../data/liveContests";
import UpcomingContests from "../data/upcomingContests";
import CompletedContest from "../data/completedContest";
...
export default function LabTabs() {
  ...
  useEffect(() => {
    setIsLoading(true);
    axios
      .get(`${baseUrl}api/v1/dailycontest/contests/upcoming`, {
      ...
      >
        <Grid container spacing={1} xs={12} md={12} lg={12} minWidth="100%">
          ...
          >
            <MDButton
              bgColor="dark"
              color={clicked == "live" ? "warning" : "secondary"}
              size="small"
              style={{ minWidth: "100%" }}
              onClick={() => {
                handleClick("live");
          ...
          >
            <MDButton
              bgColor="dark"
              color={clicked == "upcoming" ? "warning" : "secondary"}
              size="small"
              style={{ minWidth: "100%" }}
              onClick={() => {
          ...
          >
            <MDButton
              bgColor="dark"
              color={clicked == "completed" ? "warning" : "secondary"}
              size="small"
              style={{ minWidth: "100%" }}
              onClick={() => {
          ...
          >
            <MDButton
              bgColor="dark"
              color={clicked == "leaderboard" ? "warning" : "secondary"}
              size="small"
              style={{ minWidth: "100%" }}
              onClick={() => {
                handleClick("leaderboard");
              }}
            >
              <MDBox display="flex" justifyContent="center" alignItems="center">
                <MDBox
