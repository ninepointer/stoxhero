                    ...
                    <Grid container spacing={2} xs={12} md={12} lg={12}>
                        {
                            contest.map((elem) => {
                                ...
                                let checkIsInterested = elem?.registeredUsers.some(elem => elem?.userId?.toString() == getDetails?.userDetails?._id?.toString())
                                        ...
                                        <MDButton variant="contained" color="light" size="small">
                                            <Grid container display='flex' justifyContent='space-between' alignItems='center'>
                                                ...
                                                <Grid item xs={12} md={12} lg={12} display="flex" mt={1} mb={1} justifyContent="space-between" alignItems="center" alignContent="center">
                                                    {timeDifference > 0 ?
                                                        <MDBox color="light" fontSize={10} display="flex" justifyContent="center" alignItems='center'>
                                                            <HiUserGroup color='black' /><MDBox color="dark" style={{ marginLeft: 3, marginTop: 3, fontWeight: 700 }}>{elem?.registeredUsers?.length} PEOPLE HAVE SOON INTEREST IN THIS CONTEST</MDBox>
                                                        </MDBox>
                                                        :
                                                        <MDBox color="light" fontSize={10} display="flex" justifyContent="center" alignItems='center'>
