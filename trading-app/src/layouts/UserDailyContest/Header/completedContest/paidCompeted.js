    ...
    axios
      ...
      .then((res) => {
        if (res.data.count > 0) {
          ...
          openSuccessSB("error", "No leaderboard for this TestZones.");
        }
      })
      .catch((err) => {
        return new Error(err);
                                ...
                                >
                                  ...
                                  <MDBox display="flex" justifyContent="center">
                                    <MDTypography
                                      ...
                                      sx={{ color: "#DBB670" }}
                                    >
                                      {/* {elem?.payoutType !== "Reward" ? `${elem.payoutPercentage}% of the net P&L` : <RewardTable reward={elem?.rewards} paid={true}/> }    */}{" "}
