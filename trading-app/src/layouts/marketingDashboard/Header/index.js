...
export default function Dashboard() {
  ...
  const [downloadingLifetimeSignUpUsers, setDownloadingLifetimeSignUpUsers] =
    useState(false);
  const [downloadingLifetimeActiveUsers, setDownloadingLifetimeActiveUsers] =
    useState(false);
  const [downloadingLifetimePaidUsers, setDownloadingLifetimePaidUsers] =
    useState(false);
  // const [downloadingPaidUsers, setDownloadingPaidUsers] = useState(false)
  ...
  useEffect(() => {
    setIsLoading(true);
    let call1 = axios.get(
      `${baseUrl}api/v1/stoxherouserdashboard/marketingfunnel/${monthNameToNumber(
        monthName
      )}/${parseInt(yearNumber)}`,
      {
  ...
  useEffect(() => {
    ...
    let call2 = axios.get(
      `${baseUrl}api/v1/stoxherouserdashboard/marketingfunnellifetime`,
      {
        withCredentials: true,
        headers: {
          Accept: "application/json",
  ...
  const downloadThisMonthActiveUsersData = () => {
    ...
    return new Promise((resolve, reject) => {
      axios
        .get(
          `${baseUrl}api/v1/stoxherouserdashboard/thismonthactive/${monthNameToNumber(
            monthName
          )}/${yearNumber}`,
          {
            withCredentials: true,
  ...
  const downloadThisMonthPaidUsersData = () => {
    ...
    return new Promise((resolve, reject) => {
      axios
        .get(
          `${baseUrl}api/v1/stoxherouserdashboard/thismonthpaid/${monthNameToNumber(
            monthName
          )}/${yearNumber}`,
          {
            withCredentials: true,
  ...
  const downloadThisMonthSignUpUsersData = () => {
    ...
    return new Promise((resolve, reject) => {
      axios
        .get(
          `${baseUrl}api/v1/stoxherouserdashboard/thismonthsignup/${monthNameToNumber(
            monthName
          )}/${yearNumber}`,
          {
            withCredentials: true,
        ...
        >
          <MDBox>
            <MDButton
              ...
              size="small"
              onClick={() => {
                handleDownload(`Month SignUp Users`);
              }}
            >
        ...
        >
          <MDBox>
            <MDButton
              ...
              size="small"
              onClick={() => {
                handleDownload(`Month Active User`);
              }}
            >
        ...
        >
          <MDBox>
            <MDButton
              ...
              size="small"
              onClick={() => {
                handleDownload(`Month Paid User`);
              }}
            >
        ...
        >
          <MDBox>
            <MDButton
              ...
              size="small"
              onClick={() => {
                handleDownload(`Lifetime SignUp User`);
              }}
            >
        ...
        >
          <MDBox>
            <MDButton
              ...
              size="small"
              onClick={() => {
                handleDownload(`Lifetime Active User`);
              }}
            >
        ...
        >
          <MDBox>
            <MDButton
              ...
              size="small"
              onClick={() => {
                handleDownload(`Lifetime Paid User`);
              }}
            >
            ...
            >
              ...
              <MDBox display="flex" justifyContent="center" alignItems="center">
                <MDTypography fontSize={15}>
                  Loading This Month's User Funnel...
                </MDTypography>
              </MDBox>
            </MDBox>
          ) : (
      ...
      >
        <Grid item xs={12} md={12} lg={12}>
          {isLoadingLifetime ? (
            ...
            <MDBox>
              <LifetimeFunnel
                marketingFunnelLifetime={marketingFunnelLifetime}
              />
