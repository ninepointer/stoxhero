...
const InstrumentModel = ({ Render }) => {
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/contest/active`)
      .then((res) => {
        // setContestData(res.data.data);
        console.log("optionData res", res.data.data);
        for (let i = 0; i < res.data.data.length; i++) {
          optionData.push(
            <option value={res.data.data[i]}>
              {res.data.data[i].contestName}
            </option>
          );
        }
        ...
        <DialogContent>
          <DialogContentText sx={{ display: "flex", flexDirection: "column" }}>
            <TextField
              ...
              type="date"
              onChange={(e) => {
                formData.contractDate = e.target.value;
              }}
            />
            ...
            <TextField
              ...
              sx={{ margin: 1, padding: 1, width: "300px" }}
              onChange={(e) => {
                formData.lotSize = e.target.value;
              }}
            />
            ...
            <TextField
              ...
              sx={{ margin: 1, padding: 1, width: "300px" }}
              onChange={(e) => {
                formData.maxLot = e.target.value;
              }}
            />
            ...
            <FormControl variant="standard" sx={{ m: 1, minWidth: 120 }}>
              ...
              <Select
                ...
                label="Contest"
                onChange={(e) => {
                  formData.contest = e.target.value;
                }}
