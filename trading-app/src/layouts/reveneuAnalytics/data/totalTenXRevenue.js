              ...
              >
                ...
                >
                  <MDTypography variant="h6">
                    ...
                    }).format(totalTenXRevenue?.totalGMV)}
                  </MDTypography>
                </Grid>
              </CardContent>
            </Grid>
                ...
                >
                  <MDTypography variant="h6">
                    ...
                    {new Intl.NumberFormat(undefined, {
                      minimumFractionDigits: 0,
                      maximumFractionDigits: 0,
                    }).format(totalTenXRevenue?.totalRevenue)}
                  </MDTypography>
                </Grid>
              </CardContent>
            </Grid>
                ...
                >
                  <MDTypography variant="h6">
                    {new Intl.NumberFormat(undefined, {
                      minimumFractionDigits: 0,
                      maximumFractionDigits: 0,
                    }).format(totalTenXRevenue?.totalOrder)}
                  </MDTypography>
                </Grid>
              </CardContent>
            </Grid>
                ...
                >
                  <MDTypography variant="h6">
                    ...
                    {new Intl.NumberFormat(undefined, {
                      minimumFractionDigits: 0,
                      maximumFractionDigits: 0,
                    }).format(totalTenXRevenue?.totalDiscountAmount)}
                  </MDTypography>
                </Grid>
              </CardContent>
            </Grid>
