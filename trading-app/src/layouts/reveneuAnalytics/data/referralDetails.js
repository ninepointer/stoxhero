    ...
    return (
        <>
            ...
            <Grid item xs={12} md={12} lg={12} display='flex' justifyContent='center' alignContent='center' alignItems='center'>
                <MDTypography variant='caption' fontWeight='bold'>Referral Revenue Data</MDTypography>
            </Grid>
            <Divider style={{ width: '100%' }} />
                                                ...
                                                return (
                                                    <>
                                                        <Grid item xs={12} md={12} lg={1.71} display='flex' justifyContent='center' alignContent='center' alignItems='center'>
                                                            <MDTypography variant='caption'>{(elem?.referrerFirstName+" "+elem?.referrerLastName) || "-"}</MDTypography>
                                                        </Grid>
                                                        <Grid item xs={12} md={12} lg={1.71} display='flex' justifyContent='center' alignContent='center' alignItems='center'>
                                                            <MDTypography variant='caption'>{elem?.referrerCode || "-"}</MDTypography>
                                                        </Grid>
                                                        <Grid item xs={12} md={12} lg={1.71} display='flex' justifyContent='center' alignContent='center' alignItems='center'>
