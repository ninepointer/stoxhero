...
function InstrumentsData({
  ...
  useEffect(() => {
    ...
    axios
      .get(`${baseUrl}api/v1/contestInstrument/${contestId}`, {
      ...
      {isLoading ? (
        ...
        <>
          ...
          {instrumentData.map((elem, index) => {
            ...
            elem.buyState = false;
            let perticularInstrumentMarketData =
              marketDetails.contestMarketData.filter((subelem) => {
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >{`${day}${getDaySuffix(day)} ${month}`}</MDTypography>
                </Grid>
                  ...
                  >
                    ...
                    >
                      {perticularInstrumentMarketData[0]?.change >= 0
                        ? "+" +
                          perticularInstrumentMarketData[0]?.change?.toFixed(
                            2
                          ) +
                          "%"
                        : perticularInstrumentMarketData[0]?.change?.toFixed(
                    ...
                    >
                      ...
                      0
                        ? "+" +
                          (
                            ((perticularInstrumentMarketData[0]?.last_price -
                              perticularInstrumentMarketData[0]
                                ?.average_price) /
                              perticularInstrumentMarketData[0]
                                ?.average_price) *
                            100
                ...
                >
                  {!elem.buyState ? (
                    <BuyModel
                      ...
                      maxLot={elem.maxLot}
                      ltp={perticularInstrumentMarketData[0]?.last_price?.toFixed(
                        2
                      )}
                      contestId={contestId}
