...
const DraftCareers = ({ type }) => {
  ...
  useEffect(() => {
    let call1 = axios.get(`${baseUrl}api/v1/career/draft?type=Job`, {
    ...
    <>
      {activeCareer.length > 0 ? (
                      ...
                      <Grid container>
                        ...
                        >
                          <MDTypography fontSize={9} style={{ color: "black" }}>
                            Status:{" "}
                            <span style={{ fontSize: 11, fontWeight: 700 }}>
                              {e?.status ? e?.status : "Status not available"}
                            </span>
                          </MDTypography>
                        </Grid>
                      </Grid>
        ...
        <Grid container spacing={1} xs={12} md={6} lg={12}>
          ...
          >
            <MDTypography color="light">No draft Job(s)</MDTypography>
          </Grid>
        </Grid>
      )}
    </>
