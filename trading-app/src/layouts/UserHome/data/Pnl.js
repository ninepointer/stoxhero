  ...
  return (
    <Card>
      <MDBox
        ...
        alignItems="center"
        p={3}
        sx={{ backgroundColor: "#CCCCCC", borderRadius: "10px", py: 1.5 }}
      >
        <MDBox>
      ...
      {rows.length === 0 ? (
        ...
        <MDBox>
          <TableContainer component={Paper} style={{ my: 1 }}>
            ...
            >
              <thead
                style={{ backgroundColor: "#CCCCCC", borderRadius: "0px" }}
              >
                ...
                >
                  ...
                  <td style={{ padding: "8px 10px" }}>
                    <div
                      style={{
                        ...styleBottomRow,
                        color: `${totalGrossPnl > 0 ? "green" : "red"}`,
                      }}
                    >
                      Gross P&L:{" "}
                      {totalGrossPnl >= 0.0
