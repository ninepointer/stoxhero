  ...
  useEffect(() => {
    ...
    Promise.all([call1, call2])
      .then(([api1Response, api2Response]) => {
        ...
        setActiveTenXSubs(
          api1Response.data.data.filter(
            (obj1) =>
              !api2Response.data.data.some(
  ...
  return (
    <MDBox bgColor="dark" color="light" mt={2} mb={2} p={2} borderRadius={10}>
      ...
      >
        ...
        >
          <MDTypography fontSize={12} fontWeight="bold" color="dark">
            <span style={{ fontWeight: "bold", fontSize: 15 }}>TenX</span> gives
            every trader an opportunity to make a profit with{" "}
            <span style={{ fontWeight: "bold", fontSize: 15 }}>
              0 (Zero) capital.
            </span>{" "}
            You just have to start trading using the virtual currency (i.e.
            Virtual Margin Money) provided by StoxHero. After 20 days of active
            trading,{" "}
            <span style={{ fontWeight: "bold", fontSize: 15 }}>
              we'll transfer 10%
            </span>{" "}
            of the net profit (the real money) to your wallet. And the cycle
            repeats. Yes, you heard it right. Don't miss out on the opportunity
            to learn and potentially earn real money through virtual currency
            trading, with the ultimate goal of becoming a successful trader, a
            StoxHero. Your trader's journey starts now.
          </MDTypography>
        </MDBox>
        <MDBox
          bgColor="white"
        ...
        >
          <MDTypography fontSize={12} fontWeight="bold" color="dark">
            <span style={{ fontWeight: "bold", fontSize: 15 }}>TenX</span> हर
            ट्रेडर को वास्तविक पैसे कमाने का मौका देता है जहां उपभोक्ता को{" "}
            <span style={{ fontWeight: "bold", fontSize: 15 }}>
              0 (शून्य) पूंजी
            </span>{" "}
            के साथ लाभ कमाने का मौका मिलता है। आपको सिर्फ StoxHero द्वारा प्रदान
            की जाने वाली वर्चुअल मुद्रा (अर्थात मार्जिन पैसे) का उपयोग करके
            ट्रेडिंग शुरू करनी होगी। सक्रिय ट्रेडिंग के 20 दिनों के बाद, हम आपके{" "}
            <span style={{ fontWeight: "bold", fontSize: 15 }}>
              {" "}
              वॉलेट में 10%{" "}
            </span>
            नेट लाभ (वास्तविक पैसे) स्थानांतरित करेंगे। और यह प्रक्रिया दोहराती
            रहेगी। हाँ, आपने सही सुना है। वास्तविक मुद्रा ट्रेडिंग के माध्यम से
            सीखने और संभावित रूप से वास्तविक पैसे कमाने का यह मौका न छोड़ें,
            जहां अंतिम लक्ष्य है सफल ट्रेडर बनना, एक स्टॉक्सहीरो। आपकी ट्रेडर की
            यात्रा अब शुरू होती है।
          </MDTypography>
        </MDBox>
      </MDBox>
      {currentTenXSubs?.length > 0 && (
        <MDTypography fontWeight="bold" color="white">
      ...
      {activeTenXSubs?.length > 0 && (
        <MDTypography mt={2} mb={2} color="white" fontWeight="bold">
