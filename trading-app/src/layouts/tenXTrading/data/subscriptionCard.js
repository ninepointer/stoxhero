...
function Header({
  ...
  async function captureTutorialViews() {
    ...
    const res = await fetch(`${baseUrl}api/v1/tenX/tenxtutorialview`, {
      ...
      body: JSON.stringify({
        tutorialViewedBy: getDetails?.userDetails?._id,
        tenXSubscription: id,
      }),
    });
  }
      ...
      >
        ...
        >
          <MDBox
            style={{
              background:
                "linear-gradient(to bottom, #FFFAF0 0%, #F0EBE1 100%)",
            }}
            height="auto"
            minWidth="100%"
            borderRadius={5}
          >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <MDBox mt={0.5} display="flex" justifyContent="center">
                    ...
                    >
                      Validity: {subscription?.validity} trading{" "}
              ...
              <Grid
                ...
                style={{ width: "100%" }}
              >
                <MDTypography fontSize={8} fontWeight="bold">
                  {55 + userCount} Traders have already purchased this
                  subscription
                </MDTypography>
              </Grid>
            </Grid>
