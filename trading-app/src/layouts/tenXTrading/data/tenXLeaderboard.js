        ...
        >
          ...
          >
            <Grid
              ...
              style={{ width: "100%" }}
            >
              <MDTypography fontSize={25} color="light" fontWeight="bold">
                StoxHero : TenX Earnings Leaderboard
              </MDTypography>
            </Grid>
            ...
            >
              <MDBox style={{ width: "100%" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {TruncatedName(
                            tenXLeaderboard[0]?.first_name +
                              " " +
                              tenXLeaderboard[0]?.last_name
                          )}
                        </MDTypography>
                      </Grid>
                      <Grid
                      ...
                      >
                        <MDTypography
                          ...
                          fontSize={15}
                        >
                          Badge: {Badge(tenXLeaderboard[0]?.strikeRate)}
                        </MDTypography>
                      </Grid>
                      <Grid
                        item
                      ...
                      >
                        ...
                        >
                          Subscriptions(Total):{" "}
                          {tenXLeaderboard[0]?.subscriptions}
                        </MDTypography>
                      </Grid>
                      <Grid
                        item
                      ...
                      >
                        ...
                        >
                          Subscriptions(Wins):{" "}
                          {tenXLeaderboard[0]?.subscriptionsWithPayout}
                        </MDTypography>
                      </Grid>
                      <Grid
                        item
                      ...
                      >
                        ...
                        >
                          Strike Rate:{" "}
                          {(tenXLeaderboard[0]?.strikeRate * 100).toFixed(0)}%
                        </MDTypography>
                      </Grid>
                      <MDTypography
                        color="light"
                      ...
                      >
                        ...
                        }).format(tenXLeaderboard[0]?.earnings)}
                      </MDTypography>
                    </Grid>
                  </Grid>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {TruncatedName(
                            tenXLeaderboard[1]?.first_name +
                              " " +
                              tenXLeaderboard[1]?.last_name
                          )}
                        </MDTypography>
                      </Grid>
                      <Grid
                      ...
                      >
                        <MDTypography
                          ...
                          fontSize={15}
                        >
                          Badge: {Badge(tenXLeaderboard[1]?.strikeRate)}
                        </MDTypography>
                      </Grid>
                      <Grid
                        item
                      ...
                      >
                        ...
                        >
                          Subscriptions(Total):{" "}
                          {tenXLeaderboard[1]?.subscriptions}
                        </MDTypography>
                      </Grid>
                      <Grid
                        item
                      ...
                      >
                        ...
                        >
                          Subscriptions(Wins):{" "}
                          {tenXLeaderboard[1]?.subscriptionsWithPayout}
                        </MDTypography>
                      </Grid>
                      <Grid
                        item
                      ...
                      >
                        ...
                        >
                          Strike Rate:{" "}
                          {(tenXLeaderboard[1]?.strikeRate * 100).toFixed(0)}%
                        </MDTypography>
                      </Grid>
                      <MDTypography
                        color="light"
                      ...
                      >
                        ...
                        {new Intl.NumberFormat(undefined, {
                          minimumFractionDigits: 0,
                          maximumFractionDigits: 0,
                        }).format(tenXLeaderboard[1]?.earnings)}
                      </MDTypography>
                    </Grid>
                  </Grid>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {TruncatedName(
                            tenXLeaderboard[2]?.first_name +
                              " " +
                              tenXLeaderboard[2]?.last_name
                          )}
                        </MDTypography>
                      </Grid>
                      <Grid
                      ...
                      >
                        <MDTypography
                          ...
                          fontSize={15}
                        >
                          Badge: {Badge(tenXLeaderboard[2]?.strikeRate)}
                        </MDTypography>
                      </Grid>
                      <Grid
                        item
                      ...
                      >
                        ...
                        >
                          Subscriptions(Total):{" "}
                          {tenXLeaderboard[2]?.subscriptions}
                        </MDTypography>
                      </Grid>
                      <Grid
                        item
                      ...
                      >
                        ...
                        >
                          Subscriptions(Wins):{" "}
                          {tenXLeaderboard[2]?.subscriptionsWithPayout}
                        </MDTypography>
                      </Grid>
                      <Grid
                        item
                      ...
                      >
                        ...
                        >
                          Strike Rate:{" "}
                          {(tenXLeaderboard[2]?.strikeRate * 100).toFixed(0)}%
                        </MDTypography>
                      </Grid>
                      <Grid
                        item
                      ...
                      >
                        ...
                        >
                          ...
                          {new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          }).format(tenXLeaderboard[2]?.earnings)}
                        </MDTypography>
                      </Grid>
                    </Grid>
                  </Grid>
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <MDTypography color="light" fontSize={15}>
                                {e?.subscriptions}/{e?.subscriptionsWithPayout}
                              </MDTypography>
                            </Grid>
                            <Grid
                              item
                ...
                <Grid
                  ...
                  justifyContent="center"
                  alignItems="center"
                  style={{ width: "100%", border: "0.25px solid lightgrey" }}
                >
                  <Grid
                    item
                    xs={12}
                  ...
                  >
                    <MDTypography color="light" fontSize={12}>
                      TenX Titan : Strike Rate is greater than 80%
                    </MDTypography>
                  </Grid>
                  <Grid
                    item
                  ...
                  >
                    <MDTypography color="light" fontSize={12}>
                      TenX Wizard : Strike Rate is in between 60% to 80%
                    </MDTypography>
                  </Grid>
                  <Grid
                    item
                  ...
                  >
                    <MDTypography color="light" fontSize={12}>
                      TenX Maestro : Strike Rate is in between 40% to 60%
                    </MDTypography>
                  </Grid>
                  <Grid
                    item
                  ...
                  >
                    <MDTypography color="light" fontSize={12}>
                      TenX Rising : Strike Rate is in between 20% to 40%
                    </MDTypography>
                  </Grid>
                </Grid>
              </MDBox>
