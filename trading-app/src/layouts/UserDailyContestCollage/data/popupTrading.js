...
const PopupTrading = ({ elem, timeDifference }) => {
  ...
  async function participateUserToContest(elem) {
    const res = await fetch(
      `${baseUrl}api/v1/dailycontest/contest/${elem._id}/varifycodeandparticipate`,
      {
        method: "PUT",
        credentials: "include",
        headers: {
    ...
    <div>
      {timeDifference && (
        <MDButton
          ...
          onClick={() => {
            openPopupAndCheckParticipant(elem);
          }}
        >
          ...
          <DialogContent>
            ...
            >
              ...
              >
                ...
                {errorMsg && (
                  <MDTypography color="error" fontSize={10}>
                    {errorMsg}
                  </MDTypography>
                )}
              </MDBox>
