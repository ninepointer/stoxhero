...
function Header() {
  ...
  useEffect(() => {
    ...
    let call2 = axios.get(
      `${baseUrl}api/v1/dailycontest/contestleaderboard/${id}`,
      {
        withCredentials: true,
      }
    );
          ...
          >
            ...
            >
              <MDButton
                ...
                to={{
                  pathname: `${
                    id?.contestFor === "StoxHero"
                      ? "/testzone"
                      : "/collegetestzone"
                  }`,
                }}
              >
                <MDTypography color="warning" fontWeight="bold" fontSize={10}>
                  Back
                </MDTypography>
              </MDButton>
            </Grid>
            ...
            >
              <MDTypography fontSize={25} color="light" fontWeight="bold">
                StoxHero : {contest?.contestName} TestZone Leaderboard
              </MDTypography>
            </Grid>
            ...
            >
              <MDBox style={{ width: "100%" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {TruncatedName(
                            contestLeaderboard[0]?.first_name +
                              " " +
                              contestLeaderboard[0]?.last_name
                          )}
                        </MDTypography>
                      </Grid>
                      <Grid
                      ...
                      >
                        <MDTypography
                          ...
                          fontSize={15}
                        >
                          Badge: {Badge(contestLeaderboard[0]?.rank)}
                        </MDTypography>
                      </Grid>
                      <MDTypography
                        color="light"
                      ...
                      >
                        ...
                        }).format(contestLeaderboard[0]?.payout)}
                      </MDTypography>
                    </Grid>
                  </Grid>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {TruncatedName(
                            contestLeaderboard[1]?.first_name +
                              " " +
                              contestLeaderboard[1]?.last_name
                          )}
                        </MDTypography>
                      </Grid>
                      <Grid
                      ...
                      >
                        <MDTypography
                          ...
                          fontSize={15}
                        >
                          Badge: {Badge(contestLeaderboard[1]?.rank)}
                        </MDTypography>
                      </Grid>
                      <MDTypography
                        color="light"
                      ...
                      >
                        ...
                        {new Intl.NumberFormat(undefined, {
                          minimumFractionDigits: 0,
                          maximumFractionDigits: 0,
                        }).format(contestLeaderboard[1]?.payout)}
                      </MDTypography>
                    </Grid>
                  </Grid>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {TruncatedName(
                            contestLeaderboard[2]?.first_name +
                              " " +
                              contestLeaderboard[2]?.last_name
                          )}
                        </MDTypography>
                      </Grid>
                      <Grid
                      ...
                      >
                        <MDTypography
                          ...
                          fontSize={15}
                        >
                          Badge: {Badge(contestLeaderboard[2]?.rank)}
                        </MDTypography>
                      </Grid>
                      <Grid
                        item
                      ...
                      >
                        ...
                        >
                          ...
                          {new Intl.NumberFormat(undefined, {
                            minimumFractionDigits: 0,
                            maximumFractionDigits: 0,
                          }).format(contestLeaderboard[2]?.payout)}
                        </MDTypography>
                      </Grid>
                    </Grid>
                  </Grid>
                ...
                >
                  ...
                  >
                    <MDTypography color="light" fontSize={12}>
                      TestZone Runners : Rank 4 to Rank 6
                    </MDTypography>
                  </Grid>
                  <Grid
                    item
                  ...
                  >
                    <MDTypography color="light" fontSize={12}>
                      TestZone Rising Stars : Rank 7 to Rank 10
                    </MDTypography>
                  </Grid>
                </Grid>
              </MDBox>
