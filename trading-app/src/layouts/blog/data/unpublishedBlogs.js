      ...
      {publishedBlogs.length > 0 ? (
                          ...
                          >
                            ...
                            >
                              <MDTypography variant="caption" fontSize={11}>
                                {`${moment
                                  .utc(elem?.publishedOn)
                                  .utcOffset("+05:30")
                                  .format("DD MMM YY")} • ${
                                  elem?.readingTime || 1
                                } min read • ${elem?.viewCount || 0} views • ${
                                  elem?.reader.length || 0
                                } reader`}
                              </MDTypography>
                            </MDBox>
                          </CardContent>
        ...
        <Grid container spacing={1} xs={12} md={6} lg={12}>
          <Grid
            ...
            justifyContent="center"
          >
            <MDTypography color="light">No Unpublished Blogs(s)</MDTypography>
          </Grid>
        </Grid>
      )}
    </>
