...
const ChooseAfiliate = lazy(() => import('../data/chooseAffiliate'));
const AfiliateBasicSummary = lazy(() => import('../data/affiliateBasicSummary'));
const ReferredProduct = lazy(() => import('../data/transactions'));
const RaferralGrid = lazy(() => import('../data/affiliateRaferrals'));
const RecentReferralGrid = lazy(() => import('../data/recentAffiliateRaferrals'));
