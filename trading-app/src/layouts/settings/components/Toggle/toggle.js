  ...
  return (
    <>
      <MDBox display="flex" alignItems="center" mb={0.5} ml={-1.5}>
        <MDBox mt={0.5}>
          <Switch
            checked={setting[0]?.toggle?.complete === zerodhaAccountType}
            onChange={() => {
              complete(setting[0]?._id, setting[0]?.toggle?.complete);
            }}
          />
        </MDBox>
        <MDBox width="80%" ml={0.5}>
          <MDTypography variant="button" fontWeight="regular" color="dark">
            {setting[0]?.toggle?.complete === zerodhaAccountType
              ? "Complete Zerodha"
              : "Complete XTS"}
          </MDTypography>
        </MDBox>
      ...
      <MDBox display="flex" alignItems="center" mb={0.5} ml={-1.5}>
        <MDBox mt={0.5}>
          <Switch
            checked={setting[0]?.toggle?.ltp === zerodhaAccountType}
            onChange={() => {
              ltp(setting[0]?._id, setting[0]?.toggle?.ltp);
            }}
          />
        </MDBox>
        <MDBox width="80%" ml={0.5}>
          <MDTypography variant="button" fontWeight="regular" color="dark">
            {setting[0]?.toggle?.ltp === zerodhaAccountType
              ? "Zerodha Live Price"
              : "Xts Live Price"}
          </MDTypography>
        </MDBox>
      ...
      <MDBox display="flex" alignItems="center" mb={0.5} ml={-1.5}>
        <MDBox mt={0.5}>
          <Switch
            checked={setting[0]?.toggle?.liveOrder === zerodhaAccountType}
            onChange={() => {
              liveOrder(setting[0]?._id, setting[0]?.toggle?.liveOrder);
            }}
          />
        </MDBox>
        <MDBox width="80%" ml={0.5}>
          <MDTypography variant="button" fontWeight="regular" color="dark">
            {setting[0]?.toggle?.liveOrder === zerodhaAccountType
              ? "Zerodha Live Order"
              : "Xts Live Order"}
          </MDTypography>
        </MDBox>
