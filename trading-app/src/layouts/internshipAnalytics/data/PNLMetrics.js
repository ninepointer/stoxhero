...
export default function PNLMetrics({traderType, endpoint, batchId}) {
  ...
  const getOverview = async()=>{
    const res = await axios.get(`${apiUrl}analytics/${endpoint}/myoverview/${batchId}`, {withCredentials: true});
