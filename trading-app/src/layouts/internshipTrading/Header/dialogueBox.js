      ...
      {isSubscribed ? (
        <MDBox>
          <MDButton
            variant="contained"
            color="dark"
            sx={{ width: "130px", height: "20px", fontSize: "500x" }}
            onClick={() => {
        ...
        <MDBox>
          <MDButton
            variant="contained"
            color="dark"
            sx={{ width: "40px", height: "20px", fontSize: "500x" }}
            onClick={() => {
              navigate(`/tenxtrading/${name}`, {
                state: { subscriptionId: id },
              });
            ...
            <>
              <DialogContentText id="alert-dialog-description">
                ...
                >
                  ...
                  <Typography
                    textAlign="center"
                    sx={{ mt: "12px", width: "75%", mb: "12px" }}
                    color="#000"
                    variant="body2"
                  >
                    Your payment is encrypted and you can change your payment
                    method at anytime.
                  </Typography>
                  <Typography
                    variant="body2"
                    ...
                    <MDBox>
                      ...
                      >
                        <Typography
                          ...
                          sx={{ fontWeight: "600" }}
                        >
                          Your wallet balance is low kindly refer more users on
                          this platform to buy this subscription.
                        </Typography>
                        <MDBox
                          display="flex"
                          alignItems="center"
