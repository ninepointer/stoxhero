     ...
     >
      <Box sx={style}>
        ...
        <MDTypography style={{fontSize:'14px', fontWeight:'bold', marginBottom:'8px'}}>IMPORTANT</MDTypography>  
          ...
          <MDTypography style={{fontSize:'12px', marginBottom:'5px'}}>8. The minimum StoxHero wallet balance should be ₹{new Intl.NumberFormat(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 0 }).format(minWalletBalance ? minWalletBalance : 0)}.</MDTypography>
