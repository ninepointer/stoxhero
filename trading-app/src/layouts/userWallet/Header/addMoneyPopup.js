  ...
  const initiatePayment = async () => {
    try {
      const res = await axios.post(
        ...
        {
          amount: Number(amount * 100) + actualAmount * 100,
        ...
        <>
          ...
          <DialogContent>
            <Typography
              ...
              variant="body2"
            >
              Starting October 1, 2023, there's a small change: GST will now be
              added to all wallet top-ups due to new government regulations.
              However you don't need to pay anything extra. StoxHero will be
              taking care of the GST on your behalf. To offset it, we've
            ...
            {!showPromoCode ? (
              ...
              <>
                ...
                {verifiedCode && discountData?.rewardType == "Discount" && (
                  <Typography
                    textAlign="left"
                    mt={0}
                    sx={{ width: "100%", fontSize: "14px", fontWeight: 500 }}
                ...
                {verifiedCode && discountData?.rewardType == "Cashback" && (
                  <Typography
                    textAlign="left"
                    mt={0}
                    sx={{ width: "100%", fontSize: "14px", fontWeight: 500 }}
            ...
            <Typography
              textAlign="left"
              mt={1}
              sx={{ width: "100%", fontSize: "14px", fontWeight: 600 }}
              color="#000"
              variant="body2"
            >
              Cost Breakdown
            ...
            <Typography
              ...
              variant="body2"
            >
              Wallet Top-up Amount: ₹{amount ? amount : 0}
            </Typography>
            <Typography
              textAlign="left"
              sx={{ width: "100%", fontSize: "14px", fontWeight: 500 }}
              ...
              variant="body2"
            >
              GST({setting?.gstPercentage}%) on Wallet Top-up: ₹
            ...
            <Typography
              ...
              variant="body2"
            >
              Net Transaction Amount: ₹{Number(amount) + actualAmount}
            </Typography>
