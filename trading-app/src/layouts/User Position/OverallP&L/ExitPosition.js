...
function ExitPosition({ Render, portfolioId, contestId, product, symbol, quantity, exchange, instrumentToken }) {
  ...
  async function exitPosition(e, uId) {
    ...
    exitPositionFormDetails.Quantity = (Math.abs(quantity) > 1800) ? 1800 : Math.abs(quantity);
              ...
              <Box sx={{ display: "flex", flexDirection: "row" }}>
                ...
                <FormControl variant="standard" sx={{ m: 1, minWidth: 120, }}>
                  ...
                  <Select
                    ...
                    label="Quantity"
                    value={(Math.abs(quantity) > 1800) ? 1800 : Math.abs(quantity)}
