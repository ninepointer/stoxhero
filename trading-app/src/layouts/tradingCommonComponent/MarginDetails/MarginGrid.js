...
const MarginGrid = () => {
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/paperTrade/margin`, {
                    ...
                    value={
                      <MDBox display="flex" justifyContent="space-between">
                        <MDBox
                          ...
                          fontSize="15px"
                        >{`Virtual Margin Money: ${totalCreditString}`}</MDBox>
                        <MDBox
                          sx={{
                            backgroundColor: "#d3d3d3",
                            borderRadius: "5px",
                          ...
                          fontSize="15px"
                        >{`Virtual Available Margin: ${availableMarginpnlstring}`}</MDBox>
                        <MDBox
                          sx={{
                            backgroundColor: "#d3d3d3",
                            borderRadius: "5px",
                          ...
                          fontSize="15px"
                        >{`Virtual Used Margin: ${usedMarginString}`}</MDBox>
                        <MDBox
                          sx={{
                            backgroundColor: "#d3d3d3",
                            borderRadius: "5px",
                          ...
                          fontSize="15px"
                        >{`Virtual Unrealised P&L: ${unrealisedPnlString}`}</MDBox>
                      </MDBox>
                    }
                  />
                </Grid>
