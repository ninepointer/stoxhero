...
function Users({ contestId, setUpdatedDocument }) {
  ...
  function sendRequest(data) {
    ...
    axios
      .get(`${baseUrl}api/v1/dailycontest/contestusers?search=${data}`, {
        withCredentials: true,
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  async function addUser(userId) {
    axios
      .put(
        `${baseUrl}api/v1/dailycontest/contest/${contestId}/allow/${userId}`,
        {
          withCredentials: true,
          headers: {
            Accept: "application/json",
      ...
      >
        <TextField
          ...
          InputProps={{
            ...
            endAdornment: (
              <MDButton variant="text" color={"light"} onClick={handleClear}>
                {state.text && <RxCross2 />}
              </MDButton>
            ),
