...
const UpcomingContest = ({ type }) => {
  ...
  useEffect(() => {
    let call1 = axios.get(
      `${baseUrl}api/v1/dailycontest/contests/collegeongoing?skip=${skip}&limit=${limitSetting}`,
      {
  ...
  function backHandler() {
    ...
    axios
      .get(
        `${baseUrl}api/v1/dailycontest/contests/collegeongoing?skip=${
          skip - limitSetting
        }&limit=${limitSetting}`,
        {
          withCredentials: true,
