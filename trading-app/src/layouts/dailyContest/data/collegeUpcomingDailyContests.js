...
const UpcomingContest = ({ type }) => {
  ...
  useEffect(() => {
    let call1 = axios.get(
      `${baseUrl}api/v1/dailycontest/contests/collegeupcoming?skip=${skip}&limit=${limitSetting}`,
      {
  ...
  function backHandler() {
    ...
    axios
      .get(
        `${baseUrl}api/v1/dailycontest/contests/collegeupcoming?skip=${
          skip - limitSetting
        }&limit=${limitSetting}`,
        {
          withCredentials: true,
        ...
        <MDBox>
          <Grid container spacing={2} bgColor="dark">
            {upcomingContest?.map((e) => {
              let contestColor =
                e?.featured === true && e?.entryFee != 0
                  ? "success"
                  : e?.featured === true && e?.entryFee === 0
                  ? "warning"
                  : e?.featured === false && e?.entryFee != 0
                  ? "text"
                  : "light";
              console.log(
                contestColor,
                          ...
                          >
                            ...
                            >
                              ...
                              <span style={{ fontSize: 9, fontWeight: 700 }}>
                                ...
                                }).format(e?.portfolio?.portfolioValue)}
                              </span>
                            </MDTypography>
                          </Grid>
                        </Grid>
        ...
        <Grid container spacing={1} xs={12} md={6} lg={12}>
          ...
          >
            <MDTypography color="light">
              No Upcoming College TestZone(s)
            </MDTypography>
          </Grid>
        </Grid>
      )}
