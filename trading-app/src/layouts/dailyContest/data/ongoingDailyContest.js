...
const UpcomingContest = ({ type }) => {
  ...
  useEffect(() => {
    let call1 = axios.get(
      `${baseUrl}api/v1/dailycontest/contests/adminongoing?skip=${skip}&limit=${limitSetting}`,
      {
  ...
  function backHandler() {
    ...
    axios
      .get(
        `${baseUrl}api/v1/dailycontest/contests/adminongoing?skip=${
          skip - limitSetting
        }&limit=${limitSetting}`,
        {
          withCredentials: true,
        ...
        <Grid container spacing={1} xs={12} md={6} lg={12}>
          ...
          >
            <MDTypography color="light">
              No Ongoing StoxHero TestZone(s)
            </MDTypography>
          </Grid>
        </Grid>
      )}
