...
function CreateBatch({
      ...
      .then((res) => {
        ...
        setFormState({
          ...
          participantRevenueSharing:
            res.data.data?.participantRevenueSharing || "",
  ...
  async function onSubmit(e, formState) {
    ...
    if (
      !formState?.batchName ||
      !formState?.batchLimit ||
      !formState?.participantRevenueSharing ||
      !formState?.batchStartDate ||
      !formState?.batchEndDate ||
      !formState?.applicationStartDate ||
      !formState?.applicationEndDate ||
          ...
          <Grid container spacing={1} mt={0.5}>
            <Grid item xs={12} md={6} xl={3}>
              <TextField
                ...
                defaultValue={
                  oldObjectId ? batchData?.batchName : formState?.batchName
                }
                onChange={(e) => {
            ...
            <Grid item xs={12} md={6} xl={3}>
              <TextField
                ...
                label="Batch Limit *"
                defaultValue={
                  oldObjectId ? batchData.batchLimit : formState?.batchLimit
                }
                fullWidth
                type="number"
                onChange={(e) => {
            ...
            <Grid item xs={12} md={6} xl={3}>
              <TextField
                ...
                defaultValue={
                  oldObjectId
                    ? batchData.participantRevenueSharing
                    : formState?.participantRevenueSharing
                }
                fullWidth
                type="number"
                ...
                <DemoContainer components={["MobileDateTimePicker"]}>
                  <DemoItem>
                    <MobileDateTimePicker
                      ...
                      defaultValue={dayjs(
                        oldObjectId
                          ? batchData?.applicationStartDate
                          : setFormState?.applicationStartDate
                      )}
                      onChange={(e) => {
                        setFormState((prevState) => ({
                          ...prevState,
                ...
                <DemoContainer components={["MobileDateTimePicker"]}>
                  <DemoItem>
                    <MobileDateTimePicker
                      ...
                      defaultValue={dayjs(
                        oldObjectId
                          ? batchData?.applicationEndDate
                          : setFormState?.applicationEndDate
                      )}
                      onChange={(e) => {
                        setFormState((prevState) => ({
                          ...prevState,
