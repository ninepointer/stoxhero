        ...
        <Grid container spacing={1} mt={0.5}>
          ...
          {/* <Grid item xs={12} md={6} xl={3}>
              <FormControl sx={{width: "100%" }}>
                ...
                defaultValue={oldObjectId ? batchData.stockType :formState?.stockType}
                disabled={((isSubmitted || id) && (!editing || saving))}
                onChange={(e) => {setFormState(prevState => ({
                    ...prevState,
          ...
          {/* <Grid item xs={12} md={6} xl={3}>
            <TextField
                ...
                id="outlined-required"
                label="Contest On *"
                defaultValue={oldObjectId ? batchData?.contestOn : formState?.contestOn}
                fullWidth
                onChange={(e) => {setFormState(prevState => ({
                    ...prevState,
          ...
          {/* <Grid item xs={12} md={6} xl={3}>
            <TextField
                ...
                defaultValue={oldObjectId ? batchData?.entryFee?.amount :formState?.entryFee?.amount}
                fullWidth
                type="number"
                onChange={(e) => {setFormState(prevState => ({
                    ...prevState,
          ...
          {/* <Grid item xs={12} md={6} xl={3}>
              <FormControl sx={{width: "100%" }}>
                ...
                labelId="demo-simple-select-autowidth-label"
                id="demo-simple-select-autowidth"
                value={oldObjectId ? batchData?.entryFee?.currency : formState?.entryFee?.currency}
                disabled={((isSubmitted || id) && (!editing || saving))}
                onChange={(e) => {setFormState(prevState => ({
                    ...prevState,
                    entryFee: {
