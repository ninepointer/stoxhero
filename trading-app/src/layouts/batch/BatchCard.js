...
const BatchCard = ({
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/batch/active`)
      .then((res) => {
      ...
      {!batchDetailsForm ? (
                              ...
                              <Grid item xs={12} md={6} lg={12} mb={1}>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    {dateConvert(e?.applicationStartDate)}
                                  </MDTypography>
                                  <MDTypography
                                    fontSize={10}
                                    fontWeight="bold"
                                  ...
                                  >
                                    Application Ends on:{" "}
                                    {dateConvert(e?.applicationEndDate)}
                                  </MDTypography>
                                </MDBox>
                              </Grid>
                          ...
                          <MDButton color={"dark"} onClick={()=>{registration(e._id)}}>
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    Seats Left:{" "}
                                    {e?.batchLimit - e?.participants?.length}
                                  </MDBox>
                                </MDBox>
                                <MDBox
                                  color="light"
        ...
        <>
          <BatchDetailsForm
            ...
            setOldObjectId={setObjectId}
            setCreateContestFormCard={setBatchDetailsForm}
          />
        </>
      )}
    </>
