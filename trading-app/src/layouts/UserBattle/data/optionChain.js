                                            ...
                                            <Grid
                                                ...
                                                <Grid container p={1} lg={5.25} sx={{ backgroundColor: '#FFFFE0' }}>
                                                    {isRowHovered && liveData[0]?.last_price ?
                                                        <Grid item xs={12} md={2} lg={3} display="flex" justifyContent="center" alignContent="center">
                                                            <BuyModel isOption={true} setOpenOptionChain={setOpen} setBuyState={setBuyState} buyState={buyState} battleId={battleId} from={dailyContest} socket={socket} symbol={elem.tradingsymbol} exchange={elem.exchange} instrumentToken={elem.instrument_token} symbolName={`${elem.strike} ${elem.instrument_type}`} lotSize={elem.lot_size} maxLot={maxLot} ltp={(liveData[0]?.last_price)?.toFixed(2)} fromSearchInstrument={true} expiry={elem.expiry} exchangeInstrumentToken={elem.exchange_token} exchangeSegment={elem.segment} />
                                                            <SellModel isOption={true} setOpenOptionChain={setOpen}  setSellState={setSellState} sellState={sellState} battleId={battleId} from={dailyContest} socket={socket} symbol={elem.tradingsymbol} exchange={elem.exchange} instrumentToken={elem.instrument_token} symbolName={`${elem.strike} ${elem.instrument_type}`} lotSize={elem.lot_size} maxLot={maxLot} ltp={(liveData[0]?.last_price)?.toFixed(2)} fromSearchInstrument={true} expiry={elem.expiry} exchangeInstrumentToken={elem.exchange_token} exchangeSegment={elem.segment} />
                                                        </Grid>
                                                        :
                                                        <Grid item xs={12} md={2} lg={3}>
                                                ...
                                                <Grid container p={1} lg={5.25}>
                                                    ...
                                                    {isRowHovered && liveDataPE[0]?.last_price ?
                                                        <Grid item xs={12} md={2} lg={3} display="flex" justifyContent="center" alignContent="center">
                                                            <BuyModel isOption={true} setOpenOptionChain={setOpen} setBuyState={setBuyState} buyState={buyState} battleId={battleId} from={dailyContest} socket={socket} symbol={PE[0]?.tradingsymbol} exchange={PE[0]?.exchange} instrumentToken={PE[0]?.instrument_token} symbolName={`${PE[0]?.strike} ${PE[0]?.instrument_type}`} lotSize={PE[0]?.lot_size} maxLot={maxLot} ltp={(liveDataPE[0]?.last_price)?.toFixed(2)} fromSearchInstrument={true} expiry={PE[0]?.expiry} exchangeInstrumentToken={PE[0]?.exchange_token} exchangeSegment={PE[0]?.segment} />
                                                            <SellModel isOption={true} setOpenOptionChain={setOpen} setSellState={setSellState} sellState={sellState} battleId={battleId} from={dailyContest} socket={socket} symbol={PE[0]?.tradingsymbol} exchange={PE[0]?.exchange} instrumentToken={PE[0]?.instrument_token} symbolName={`${PE[0]?.strike} ${PE[0]?.instrument_type}`} lotSize={PE[0]?.lot_size} maxLot={maxLot} ltp={(liveDataPE[0]?.last_price)?.toFixed(2)} fromSearchInstrument={true} expiry={PE[0]?.expiry} exchangeInstrumentToken={PE[0]?.exchange_token} exchangeSegment={PE[0]?.segment} />
