...
function Leaderboard({ socket, name, id }) {
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/battles/prizedetail/${id}`, {
  ...
  reward.map((elem) => {
    if (elem.rank == myRank && !myReward) {
      ...
      if (
        Number(splited[0]) <= myRank &&
        myRank <= Number(splited[1]) &&
        myRank
      ) {
        myReward = elem.reward;
      ...
      {loading ? (
        ...
        >
          ...
          <MDBox display="flex" justifyContent="center" alignItems="center">
            <MDTypography fontSize={15} fontWeight="bold" color="black">
                    ...
                    >
                      ...
                      >
                        <MDTypography
                          ...
                          fontWeight="bold"
                        >
                          StoxHero {name} Battle Leaderboard
                        </MDTypography>
                      </Grid>
                      <Grid
                        item
                        ...
                        <MDBox>
                          ...
                          >
                            <MDButton
                              ...
                              onClick={() =>
                                window.open(
                                  "https://instagram.com/stoxhero_official?igshid=MzRlODBiNWFlZA==",
                                  "_blank"
                                )
                              }
                            >
                        ...
                        <MDBox>
                          ...
                          >
                            <MDButton
                              ...
                              onClick={() =>
                                window.open(
                                  "https://www.facebook.com/profile.php?id=100091564856087&mibextid=ZbWKwL",
                                  "_blank"
                                )
                              }
                            >
                        ...
                        <MDBox>
                          ...
                          >
                            <MDButton
                              ...
                              onClick={() =>
                                window.open(
                                  "https://chat.whatsapp.com/CbRHo9BP3SO5fIHI2nM6jq",
                                  "_blank"
                                )
                              }
                            >
                ...
                {leaderboard?.length !== 0 ? (
                      ...
                      return (
                        <div key={elem?.name}>
                          <Grid
                            ...
                            justifyContent="center"
                            alignItems="center"
                            border={myRank == index + 1 && "1px solid black"}
                          >
                            <Grid
                              item
                              xs={12}
                            ...
                            >
                              ...
                              <MDAvatar
                                src={
                                  elem?.photo ? elem?.photo : DefaultProfilePic
                                }
                                alt="Profile"
                                size="sm"
                                sx={({
                  ...
                  >
                    <MDBox mb={2}>
                      ...
                      >
                        The Battle Leaderboard will be displayed here!
                      </MDTypography>
                    </MDBox>
                  </Grid>
                )}
