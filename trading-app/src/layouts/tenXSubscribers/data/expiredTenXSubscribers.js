...
export default function ExpiredTenXSubscribers() {
  ...
  useEffect(()=>{
    axios.get(`${baseUrl}api/v1/tenx/expiredtenxsubscribers?skip=${skip}&limit=${limitSetting}`,{
  ...
  function backHandler(){
    ...
    setIsLoading(true)
    axios.get(`${baseUrl}api/v1/tenx/expiredtenxsubscribers?skip=${skip-limitSetting}&limit=${limitSetting}`,{
        withCredentials: true,
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
