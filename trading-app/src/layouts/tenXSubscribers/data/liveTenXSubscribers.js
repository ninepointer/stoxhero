...
export default function LiveTenXSubscribers() {
  ...
  useEffect(()=>{
    axios.get(`${baseUrl}api/v1/tenx/livetenxsubscribers?skip=${skip}&limit=${limitSetting}`,{
  ...
  function backHandler(){
    ...
    setIsLoading(true)
    axios.get(`${baseUrl}api/v1/tenx/livetenxsubscribers?skip=${skip-limitSetting}&limit=${limitSetting}`,{
        withCredentials: true,
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
