...
export default function TenXPurchasedYesterday() {
  let baseUrl =
  ...
  const [tenXPurchasedYesterday, setTenXPurchasedYesterday] = useState([]);

  useEffect(() => {
    axios
      .get(
        `${baseUrl}api/v1/tenx/tenxpurchaseyesterday?skip=${skip}&limit=${limitSetting}`,
        {
      ...
      .then((res) => {
        setTenXPurchasedYesterday(res.data.data);
  ...
  function backHandler() {
    ...
    setTenXPurchasedYesterday([]);
    setIsLoading(true);
    axios
      .get(
        `${baseUrl}api/v1/tenx/tenxpurchaseyesterday?skip=${
          skip - limitSetting
        }&limit=${limitSetting}`,
        {
          withCredentials: true,
  ...
  return (
    ...
    >
      <Grid container spacing={1}>
        ...
        {!isLoading ? (
          tenXPurchasedYesterday?.map((elem, index) => {
            return (
              <Grid
                container
                mt={1}
              ...
              >
                ...
                >
                  <MDTypography color={"light"} fontSize={10} fontWeight="bold">
                    {moment
                      .utc(elem?.expiry_date)
                      .add(elem?.expiryDays, "days")
                      .utcOffset("+05:30")
                      .format("DD-MMM-YY")}
                  </MDTypography>
                </Grid>
        ...
        {!isLoading && count !== 0 && (
          ...
          >
            ...
            <MDTypography color="light" fontSize={15} fontWeight="bold">
              Total Subscribers: {!count ? 0 : count} | Page{" "}
