...
const InactiveBattleTemplates = ({ type }) => {
  ...
  function backHandler() {
    ...
    axios
      .get(
        `${baseUrl}api/v1/battletemplates/inactive/?skip=${
          skip - limitSetting
        }&limit=${limitSetting}`,
        {
          withCredentials: true,
                    ...
                    >
                      <Grid container>
                        ...
                        >
                          ...
                          >
                            Template Name: {e?.battleTemplateName}
                          </MDTypography>
                        </Grid>
                        ...
                        >
                          ...
                          >
                            Min Participants: {e?.minParticipants}
                          </MDTypography>
                        </Grid>
                        ...
                        >
                          ...
                          >
                            Platform Commission:{" "}
                            {e?.platformCommissionPercentage}%
                          </MDTypography>
                        </Grid>
                        ...
                        >
                          <MDTypography
                            ...
                            style={{ color: "black", paddingRight: 4 }}
                          >
                            Winner Percentage: {e?.winnerPercentage}%
                          </MDTypography>
                        </Grid>
                        ...
                        >
                          <MDTypography
                            ...
                            style={{ color: "black", paddingRight: 4 }}
                          >
                            Template Type: {e?.battleTemplateType}
                          </MDTypography>
                        </Grid>
                        ...
                        >
                          <MDTypography
                            ...
                            style={{ color: "black", paddingRight: 4 }}
                          >
                            # of top Rewards: {e?.rankingPayout?.length}
                          </MDTypography>
                        </Grid>
          ...
          {!isLoading && count !== 0 && (
            ...
            >
              ...
              <MDTypography color="light" fontSize={15} fontWeight="bold">
                Total Templates: {!count ? 0 : count} | Page{" "}
        ...
        <Grid container spacing={1} xs={12} md={6} lg={12}>
          ...
          >
            <MDTypography color="light">
              No Inactive Battle Templates(s)
            </MDTypography>
          </Grid>
        </Grid>
      )}
