    ...
    >
            ...
            <Grid container xs={12} md={12} lg={12}>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  ...
                  >
                    Check all trader's marginx position here!
                  </MDTypography>
                </MDBox>
              </Grid>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4, paddingRight: 4 }}
                  >
                    Check all daily marginx reports here!
                  </MDTypography>
                </MDBox>
              </Grid>
          ...
          <MDBox p={1}>
            {completedMarginX && (
              <CompanySideContestDailyChart
                completedMarginX={completedMarginX}
              />
            )}
          </MDBox>
        </Grid>
      ...
      >
        <Grid item xs={12} md={12} lg={12}>
          <MDBox p={0.5}>
            {allMarginXUsers && (
              <DailyPaidContestUsers allMarginXUsers={allMarginXUsers} />
            )}
          </MDBox>
        </Grid>
      </Grid>
