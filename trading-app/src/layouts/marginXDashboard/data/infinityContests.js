...
export default function LabTabs({ socket }) {
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/dailycontest/live/overallAllContestPnlCompany`, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  return (
    ...
    >
      <Grid
        ...
        minHeight="auto"
        minWidth="100%"
        style={{ backgroundColor: "lightgrey", minWidth: "100%" }}
        borderRadius={1}
        display="flex"
        justifyContent="center"
      >
              ...
              >
                ...
                >
                  <MDTypography color="dark" fontSize={15} fontWeight="bold">
                    Infinity Contests - Company Side Details
                  </MDTypography>
                </MDBox>
                ...
                {liveContest.map((elem) => {
                  ...
                  let contestTradeData = tradeData.filter((subelem) => {
                    return (
                      elem?._id?.toString() ===
                      subelem?._id?.contest?.toString()
                    );
                  });

                  let contestTraderData = traderData.filter((subelem) => {
                    return (
                      elem?._id?.toString() === subelem?.contestId?.toString()
                    );
                  });
                          ...
                          >
                            <Grid container xs={12} md={12} lg={12}>
                              ...
                              >
                                ...
                                >{`Current Status: ${elem?.currentLiveStatus}`}</MDTypography>
                              </Grid>
                              ...
                              >
                                ...
                                >{`Type: ${elem?.contestFor}`}</MDTypography>
                              </Grid>
                                    ...
                                    {totalGrossPnl - totalTransactionCost >= 0
                                      ...
                                      : "-₹" +
                                        new Intl.NumberFormat(undefined, {
                                          ...
                                          totalTransactionCost - totalGrossPnl
                                        )}
                                  </span>
                                </MDTypography>
                              </Grid>
                              ...
                              >
                                ...
                                >
                                  ...
                                  <span
                                    style={{ fontSize: 12, fontWeight: 700 }}
                                  >
                                    {contestTraderData[0]?.positiveTraderCount}
                                  </span>
                                </MDTypography>
                              </Grid>
                              ...
                              >
                                ...
                                >
                                  ...
                                  <span
                                    style={{ fontSize: 12, fontWeight: 700 }}
                                  >
                                    {contestTraderData[0]?.negativeTraderCount}
                                  </span>
                                </MDTypography>
                              </Grid>
                              ...
                              >
                                ...
                                >
                                  ...
                                  <Grid item xs={6} md={6} lg={4}>
                                    <MDBox
                                      style={{
                                        backgroundColor: elem?.isBankNifty
                                          ? "yellow"
                                          : "white",
                                        border: "1px solid white",
                                        borderRadius: 3,
                                  ...
                                  <Grid item xs={6} md={6} lg={4}>
                                    <MDBox
                                      style={{
                                        backgroundColor: elem?.isFinNifty
                                          ? "yellow"
                                          : "white",
                                        border: "1px solid white",
                                        borderRadius: 3,
                                  ...
                                  <Grid item xs={6} md={6} lg={4}>
                                    ...
                                    >
                                      <MDTypography
                                        ...
                                        fontWeight="bold"
                                        color="dark"
                                      >{`Abs. Running Lots: ${totalAbsLots}`}</MDTypography>
                                    </MDBox>
                                  </Grid>
                                  <Grid item xs={6} md={6} lg={4}>
                                    <MDBox
                                    ...
                                    >
                                      <MDTypography
                                        ...
                                        fontWeight="bold"
                                        color="dark"
                                      >{`Running Lots: ${totalRunningLots}`}</MDTypography>
                                    </MDBox>
                                  </Grid>
