...
export default function PnlOverviewMock({ socket }) {
  ...
  useEffect(() => {
    ...
    setIsLoading(true);
    axios
      .get(`${baseUrl}api/v1/marginxtrade/overalltraderpnltoday`, {
    ...
    console.log("Loading: ", isLoading);
    axios
      .get(`${baseUrl}api/v1/marginxtrade/liveandtotaltradercounttoday`, {
        withCredentials: true,
      })
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/marginxtrade/overalltraderpnlyesterday`, {
        withCredentials: true,
      })
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/marginxtrade/overalltraderpnlthismonth`, {
        withCredentials: true,
      })
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/marginxtrade/overalltraderpnllifetime`, {
        withCredentials: true,
      })
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/marginxtrade/liveandtotaltradercountyesterday`, {
        withCredentials: true,
      })
      .then((res) => {
