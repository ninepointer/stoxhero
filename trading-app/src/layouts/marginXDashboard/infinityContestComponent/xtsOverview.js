...
export default function XTSOverview({ socket }) {
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/xtsOverview`, { withCredentials: true })
      .then((res) => {
                ...
                <Grid item p={2} xs={12} md={12} lg={12}>
                  ...
                  <Grid container spacing={0.5} xs={12} md={12} lg={12} mt={1}>
                    <Grid item xs={4} md={4} lg={2.4}>
                      ...
                      >
                        {tradeData ?? 0
                          ? tradeData?.netAmount >= 0
                            ? "+₹" +
                              new Intl.NumberFormat(undefined, {
                                minimumFractionDigits: 0,
                                maximumFractionDigits: 0,
                              }).format(tradeData?.netAmount)
                            : "-₹" +
                              new Intl.NumberFormat(undefined, {
                                minimumFractionDigits: 0,
                                maximumFractionDigits: 0,
                    ...
                    <Grid item xs={4} md={4} lg={2.4}>
                      ...
                      >
                        {tradeData ?? 0
                          ? tradeData.buyAmount >= 0
                            ? "+₹" +
                              new Intl.NumberFormat(undefined, {
                                minimumFractionDigits: 0,
                                maximumFractionDigits: 0,
                              }).format(tradeData.buyAmount)
                            : "-₹" +
                              new Intl.NumberFormat(undefined, {
                                minimumFractionDigits: 0,
                                maximumFractionDigits: 0,
                    ...
                    <Grid item xs={4} md={4} lg={2.4}>
                      ...
                      >
                        {tradeData ?? 0
                          ? tradeData.sellAmount >= 0
                            ? "+₹" +
                              new Intl.NumberFormat(undefined, {
                                minimumFractionDigits: 0,
                                maximumFractionDigits: 0,
                              }).format(tradeData.sellAmount)
                            : "-₹" +
                              new Intl.NumberFormat(undefined, {
                                minimumFractionDigits: 0,
                                maximumFractionDigits: 0,
