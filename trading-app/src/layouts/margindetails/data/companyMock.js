...
export default function UserTodayTradeData() {
  ...
  let url =
    selectTimeline === "Today"
      ? "marginused/mock/companymargintoday"
      : "marginused/mock/companymarginhistory";
  ...
  useEffect(() => {
    ...
    axios
      .get(`${baseUrl}api/v1/${url}?skip=${skip}&limit=${limitSetting}`, {
      ...
      <Grid container spacing={1}>
        ...
        >
          <Grid
            ...
            alignItems="center"
          >
            <MDTypography color="light" fontSize={9} fontWeight="bold">
              Name
            </MDTypography>
          </Grid>
            ...
            return (
              ...
              >
                <Grid
                  ...
                  alignItems="center"
                >
                  <MDTypography color="light" fontSize={8} fontWeight="bold">
                    {elem?.createdBy}
                  </MDTypography>
                </Grid>
                <Grid item xs={12} md={2} lg={1.2}>
        ...
        {!isLoading && count !== 0 && (
          ...
          >
            ...
            <MDTypography color="light" fontSize={15} fontWeight="bold">
              Total Order: {!count ? 0 : count} | Page{" "}
