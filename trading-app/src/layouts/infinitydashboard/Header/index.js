...
export default function LabTabs({ socket }) {
  ...
  const [notliveTraderCountRealTrade, setNotLiveTraderCountRealTrade] =
    useState(0);
  ...
  useEffect(() => {
    ...
    axios
      .get(`${baseUrl}api/v1/usedMargin/infinity`)
      .then((res) => {
        console.log(res.data);
  ...
  useEffect(() => {
    setIsLoading(true);
    axios
      .get(`${baseUrl}api/v1/infinityTrade/mock/overallcompanypnltoday`)
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/infinityTrade/live/overallcompanypnltoday`)
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/infinityTrade/mock/liveandtotaltradercounttoday`)
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/infinityTrade/live/liveandtotaltradercounttoday`)
      .then((res) => {
        console.log(res.data.data);
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${baseUrl}api/v1/infinityTrade/mock/overallinfinitymockcompanypnlyesterday`
      )
      .then((res) => {
    ...
    axios
      .get(
        `${baseUrl}api/v1/infinityTrade/live/overallinfinitylivecompanypnlyesterday`,
    ...
    axios
      .get(
        `${baseUrl}api/v1/infinityTrade/live/overallinfinitylivecompanypnlMTD`
      )
      .then((res) => {
        console.log(res.data.data);
    ...
    axios
      .get(
        `${baseUrl}api/v1/infinityTrade/mock/overallinfinitymockcompanypnlMTD`
      )
      .then((res) => {
        console.log(res.data.data);
  ...
  tradeData.map((subelem, index) => {
    ...
    let liveDetail = marketData.filter((elem) => {
      return (
        elem !== undefined &&
        (elem.instrument_token == subelem._id.instrumentToken ||
          elem.instrument_token == subelem._id.exchangeInstrumentToken)
      );
    });
    let updatedValue =
      subelem.amount + subelem.lots * liveDetail[0]?.last_price;
  ...
  const liveTotalnetPnlcolor =
    liveTotalGrossPnl - liveTotalTransactionCost >= 0 ? "success" : "error";
  const liveTotalquantitycolor =
    liveTotalRunningLots >= 0 ? "success" : "error";
  const addInMargin =
    totalGrossPnl - totalTransactionCost >= 0
      ? 0
      : Math.abs(totalGrossPnl - totalTransactionCost);
                        ...
                        {totalGrossPnl - totalTransactionCost >= 0
                          ? "+₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(totalGrossPnl - totalTransactionCost)
                          : "-₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(totalTransactionCost - totalGrossPnl)}
                      </MDTypography>
                    </Grid>
                  </Grid>
                  <Grid container mt={1}>
                  ...
                  <Grid container mt={1}>
                    ...
                    <Grid item lg={4}>
                      ...
                      <MDTypography
                        ...
                        justifyContent="center"
                      >
                        {liveTraderCount}/{notliveTraderCount + liveTraderCount}
                      </MDTypography>
                    </Grid>
                    <Grid item lg={4}>
                      <MDTypography
                        ...
                        {!isLoadMockMargin ? (
                          ...
                          <span style={{ marginRight: "10px" }}>
                            ...
                            {new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(mockMarginData + addInMargin)}
                          </span>
                        )}
                        <CachedIcon
                          sx={{ cursor: "pointer" }}
                          onClick={() => {
                            setRefreshMockMargin(!refreshMockMargin);
                          }}
                        />
                      </MDTypography>
                    </Grid>
                ...
                <Grid item p={2} xs={12} lg={5.9}>
                    ...
                    <Grid item lg={4}>
                      ...
                      >
                        ...
                        {new Intl.NumberFormat(undefined, {
                          minimumFractionDigits: 0,
                          maximumFractionDigits: 0,
                        }).format(liveTotalTransactionCost)}
                      </MDTypography>
                    </Grid>
                    <Grid item lg={4}>
                      <MDTypography
                      ...
                      <MDTypography
                        color={liveTotalnetPnlcolor}
                        fontSize={12}
                        display="flex"
                        justifyContent="right"
                      >
                        {liveTotalGrossPnl - liveTotalTransactionCost >= 0
                          ? "+₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(
                              liveTotalGrossPnl - liveTotalTransactionCost
                            )
                          : "-₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              ...
                              liveTotalTransactionCost - liveTotalGrossPnl
                            )}
                      </MDTypography>
                    </Grid>
                  </Grid>
                  <Grid container mt={1}>
                    ...
                    <Grid item lg={4}>
                      ...
                      <MDTypography
                        color={liveTotalquantitycolor}
                        fontSize={12}
                        display="flex"
                        justifyContent="center"
                      >
                        {liveTotalRunningLots}
                      </MDTypography>
                    </Grid>
                    <Grid item lg={4}>
                      <MDTypography
                  ...
                  <Grid container mt={1}>
                    ...
                    <Grid item lg={4}>
                      ...
                      <MDTypography
                        ...
                        justifyContent="center"
                      >
                        {liveTraderCountRealTrade}/
                        {notliveTraderCountRealTrade + liveTraderCountRealTrade}
                      </MDTypography>
                    </Grid>
                    <Grid item lg={4}>
                      <MDTypography
          ...
          {isLoadingData ? (
            ...
            <>
              <Grid container>
                <Grid item p={2} xs={12} lg={5.9}>
                  <MDTypography fontSize={16} fontWeight="bold" color="dark">
                    Last Trading Day (StoxHero) -{" "}
                    {new Date(lastMockTradingDate).toLocaleDateString("en-US", {
                      day: "numeric",
                      month: "short",
                      year: "numeric",
                      weekday: "short",
                      ...
                      >
                        {tradeDataYesterday[0]
                          ? new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(liveTradeYesterdayData[0]?.totallots)
                          : 0}
                      </MDTypography>
                    </Grid>
                    <Grid item lg={4}>
                ...
                <Grid item p={2} xs={12} lg={5.9}>
                  <MDTypography fontSize={16} fontWeight="bold" color="dark">
                    Last Trading Day (Infinity) -{" "}
                    {new Date(lastLiveTradingDate).toLocaleDateString("en-US", {
                      day: "numeric",
                      month: "short",
                      year: "numeric",
                      weekday: "short",
                  ...
                  <Grid container mt={1}>
                    <Grid item lg={4}>
                      ...
                      <MDTypography
                        ...
                        justifyContent="left"
                      >
                        {liveTradeYesterdayData[0]
                          ? liveTradeYesterdayData[0]?.amount >= 0
                            ? "+₹" +
                              new Intl.NumberFormat(undefined, {
                                minimumFractionDigits: 0,
                                maximumFractionDigits: 0,
                              }).format(liveTradeYesterdayData[0]?.amount)
                            : "-₹" +
                              new Intl.NumberFormat(undefined, {
                                minimumFractionDigits: 0,
                                maximumFractionDigits: 0,
                        ...
                        {liveTradeYesterdayData[0]
                          ? "₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(liveTradeYesterdayData[0]?.brokerage)
                          : "₹" + 0}
                      </MDTypography>
                    </Grid>
                    <Grid item lg={4}>
                      ...
                      >
                        {liveTradeYesterdayData[0]
                          ? liveTradeYesterdayData[0]?.amount -
                              liveTradeYesterdayData[0]?.brokerage >=
                            0
                            ? "+₹" +
                              new Intl.NumberFormat(undefined, {
                                minimumFractionDigits: 0,
                      ...
                      >
                        {liveTradeYesterdayData[0]
                          ? new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(liveTradeYesterdayData[0]?.turnover)
                          : "₹" + 0}
                      </MDTypography>
                    </Grid>
                    <Grid item lg={4}>
                      ...
                      >
                        {liveTradeYesterdayData[0]
                          ? liveTradeYesterdayData[0]?.trades
                          : 0}
                      </MDTypography>
                    </Grid>
                  </Grid>
                ...
                <Grid item p={2} xs={12} lg={5.9}>
                  ...
                  <Grid container mt={1}>
                    <Grid item lg={4}>
                      ...
                      >
                        {mockTradeMTDData[0]
                          ? mockTradeMTDData[0]?.amount >= 0
                            ? "+₹" +
                              new Intl.NumberFormat(undefined, {
                                minimumFractionDigits: 0,
                                maximumFractionDigits: 0,
                              }).format(mockTradeMTDData[0]?.amount)
                            : "-₹" +
                              new Intl.NumberFormat(undefined, {
                                minimumFractionDigits: 0,
                                maximumFractionDigits: 0,
                        ...
                        {mockTradeMTDData[0]
                          ? "₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(mockTradeMTDData[0]?.brokerage)
                          : "₹" + 0}
                      </MDTypography>
                    </Grid>
                    <Grid item lg={4}>
                      ...
                      >
                        {mockTradeMTDData[0]
                          ? mockTradeMTDData[0]?.amount -
                              mockTradeMTDData[0]?.brokerage >=
                            0
                            ? "+₹" +
                              new Intl.NumberFormat(undefined, {
                                minimumFractionDigits: 0,
                      ...
                      >
                        {mockTradeMTDData[0]
                          ? new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(mockTradeMTDData[0]?.totalLots)
                          : 0}
                      </MDTypography>
                    </Grid>
                    <Grid item lg={4}>
                        ...
                        {mockTradeMTDData[0]
                          ? "₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(mockTradeMTDData[0]?.turnover)
                          : "₹" + 0}
                      </MDTypography>
                    </Grid>
                    <Grid item lg={4}>
                      ...
                      <MDTypography
                        ...
                        justifyContent="right"
                      >
                        {mockTradeMTDData[0] ? mockTradeMTDData[0]?.trades : 0}
                      </MDTypography>
                    </Grid>
                  </Grid>
                </Grid>
                ...
                <Grid item p={2} xs={12} lg={5.9}>
                  ...
                  <Grid container mt={1}>
                    <Grid item lg={4}>
                      ...
                      >
                        {liveTradeMTDData[0]
                          ? liveTradeMTDData[0]?.amount >= 0
                            ? "+₹" +
                              new Intl.NumberFormat(undefined, {
                                minimumFractionDigits: 0,
                                maximumFractionDigits: 0,
                              }).format(liveTradeMTDData[0]?.amount)
                            : "-₹" +
                              new Intl.NumberFormat(undefined, {
                                minimumFractionDigits: 0,
                                maximumFractionDigits: 0,
                        ...
                        {liveTradeMTDData[0]
                          ? "₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(liveTradeMTDData[0]?.brokerage)
                          : "₹" + 0}
                      </MDTypography>
                    </Grid>
                    <Grid item lg={4}>
                      ...
                      >
                        {liveTradeMTDData[0]
                          ? liveTradeMTDData[0]?.amount -
                              liveTradeMTDData[0]?.brokerage >=
                            0
                            ? "+₹" +
                              new Intl.NumberFormat(undefined, {
                                minimumFractionDigits: 0,
                      ...
                      >
                        {liveTradeMTDData[0]
                          ? new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(liveTradeMTDData[0]?.totalLots)
                          : 0}
                      </MDTypography>
                    </Grid>
                    <Grid item lg={4}>
                        ...
                        {liveTradeMTDData[0]
                          ? "₹" +
                            new Intl.NumberFormat(undefined, {
                              minimumFractionDigits: 0,
                              maximumFractionDigits: 0,
                            }).format(liveTradeMTDData[0]?.turnover)
                          : "₹" + 0}
                      </MDTypography>
                    </Grid>
                    <Grid item lg={4}>
                      ...
                      <MDTypography
                        ...
                        justifyContent="right"
                      >
                        {liveTradeMTDData[0] ? liveTradeMTDData[0]?.trades : 0}
                      </MDTypography>
                    </Grid>
                  </Grid>
                </Grid>
          ...
          >
            <Grid container>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4, paddingRight: 4 }}
                  >
                    Check today's mock company position here!
                  </MDTypography>
                </MDBox>
              </Grid>
              ...
              <Grid
                ...
                justifyContent="left"
              >
                <MDTypography fontSize={9} style={{ color: "white" }}>
                  Active Traders:{" "}
          ...
          >
            <Grid container>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4, paddingRight: 4 }}
                  >
                    Check today's infinity position here!
                  </MDTypography>
                </MDBox>
              </Grid>
              ...
              >
                <MDTypography fontSize={9} style={{ color: "white" }}>
                  <span style={{ fontSize: 11, fontWeight: 700 }}>
                    Open Lots: {liveTotalRunningLots}
                  </span>
                </MDTypography>
              </Grid>
            </Grid>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4, paddingRight: 4 }}
                  >
                    Check today's mock(R) company position here!
                  </MDTypography>
                </MDBox>
              </Grid>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4, paddingRight: 4 }}
                  >
                    Check today's infinity(R) position here!
                  </MDTypography>
                </MDBox>
              </Grid>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4, paddingRight: 4 }}
                  >
                    Check today's traders position here!
                  </MDTypography>
                </MDBox>
              </Grid>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4, paddingRight: 4 }}
                  >
                    Check today's cohort position here!
                  </MDTypography>
                </MDBox>
              </Grid>
          ...
          >
            <Grid container>
              ...
              >
                <MDTypography
                  fontSize={15}
                  style={{ color: "white", paddingLeft: 4, fontWeight: "bold" }}
                >
                  Company's Report(M)
                </MDTypography>
              </Grid>
              ...
              >
                <MDBox display="flex" justifyContent="left">
                  ...
                  >
                    Check company side mock trades report here!
                  </MDTypography>
                </MDBox>
              </Grid>
              ...
              >
                <MDTypography fontSize={9} style={{ color: "white" }}>
                  Current Month's Net P&L(till yesterday):{" "}
                  <span style={{ fontSize: 11, fontWeight: 700 }}>
                    {mockTradeMTDData[0]
                      ? mockTradeMTDData[0]?.amount -
                          mockTradeMTDData[0]?.brokerage >=
              ...
              >
                <MDBox display="flex" justifyContent="left">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4 }}
                  >
                    Check company side infinity trades report here!
                  </MDTypography>
                </MDBox>
              </Grid>
          ...
          >
            <Grid container>
              ...
              >
                <MDBox display="flex" justifyContent="left">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4 }}
                  >
                    Check trader side mock trades report here!
                  </MDTypography>
                </MDBox>
              </Grid>
              ...
              >
                <MDTypography fontSize={9} style={{ color: "white" }}>
                  Current Month's Net P&L(till yesterday):{" "}
                  <span style={{ fontSize: 11, fontWeight: 700 }}>TBC</span>
                </MDTypography>
              </Grid>
            </Grid>
          </MDButton>
              ...
              >
                <MDBox display="flex" justifyContent="left">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4 }}
                  >
                    Check trader side infinity trades report here!
                  </MDTypography>
                </MDBox>
              </Grid>
        ...
        <Grid item lg={3}>
          ...
          >
            <Grid container>
              ...
              >
                <MDTypography fontSize={9} style={{ color: "white" }}>
                  My Current Month's Net P&L(till yesterday):{" "}
                  <span style={{ fontSize: 11, fontWeight: 700 }}>TBC</span>
                </MDTypography>
              </Grid>
            </Grid>
              ...
              >
                <MDBox display="flex" justifyContent="left">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4 }}
                  >
                    Check orders placed on XTS here!
                  </MDTypography>
                </MDBox>
              </Grid>
