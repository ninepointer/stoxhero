...
function TraderwiseTraderPNL({ socket }) {
  ...
  useEffect(() => {
    ...
    axios.get(`${apiUrl}battletrade/${selectedBattle?._id}/traderWisePnlTside`, { withCredentials: true })
      .then((res) => {
  ...
  const xFactor = selectedBattle?.battleTemplate?.portfolioValue / selectedBattle?.battleTemplate?.entryFee;
        ...
        <Card>
          ...
          <MDBox >
            ...
            <TextField
              select
              label=""
              value={selectedBattle?.battleName ? selectedBattle?.battleName : battle[0]?.battleName}
              minHeight="4em"
              // helperText="Please select subscription"
              variant="outlined"
              sx={{ margin: 1, padding: 1, width: "300px" }}
              onChange={(e) => { setselectedBattle(battle.filter((item) => item.battleName == e.target.value)[0]); }}
            >
              {battle?.map((option) => (
                <MenuItem key={option.battleName} value={option.battleName} minHeight="4em">
                  {option.battleName}
                </MenuItem>
              ))}
            </TextField>

            <MDBox style={{backgroundColor:`${selectedBattle?.battleTemplate?.entryFee > 0 ? 'lightgreen' : 'yellow'}`}} borderRadius={3} m={1}>
              <Grid container xs={12} md={12} lg={12}>
                  <Grid item xs={12} md={12} lg={2}>
                    <MDBox display="flex" justifyContent="center" alignContent="center" alignItems="center" borderRadius={5} p={1}>
                      ...
                      <MDTypography fontSize={13} fontWeight="bold" >₹{selectedBattle?.battleTemplate?.entryFee}</MDTypography>
                    </MDBox>
                  </Grid>
                  <Grid item xs={12} md={12} lg={2}>
                    <MDBox display="flex" justifyContent="center" alignContent="center" alignItems="center" borderRadius={5} p={1}>
                      <MDTypography fontSize={11}>Min Participant:&nbsp;</MDTypography>
                      <MDTypography fontSize={13} fontWeight="bold" >{selectedBattle?.battleTemplate?.minParticipants}</MDTypography>
                    </MDBox>
                  </Grid>
                  <Grid item xs={12} md={12} lg={2}>
                    <MDBox display="flex" justifyContent="center" alignContent="center" alignItems="center" borderRadius={5} p={1}>
                      <MDTypography fontSize={11}>Participant:&nbsp;</MDTypography>
                      <MDTypography fontSize={13} fontWeight="bold" >{selectedBattle?.participants?.length}</MDTypography>
                    </MDBox>
                  </Grid>
                  {/* <Grid item xs={12} md={12} lg={2}>
                    <MDBox display="flex" justifyContent="center" alignContent="center" alignItems="center" borderRadius={5} p={1}>
                  ...
                  <Grid item xs={12} md={12} lg={2}>
                    <MDBox display="flex" justifyContent="center" alignContent="center" alignItems="center" borderRadius={5} p={1}>
                      ...
                      <MDTypography fontSize={13} fontWeight="bold" >₹{(selectedBattle?.battleTemplate?.entryFee * selectedBattle?.participants?.length)}</MDTypography>
                    </MDBox>
                  </Grid>
                  <Grid item xs={12} md={12} lg={2}>
                    <MDBox display="flex" justifyContent="center" alignContent="center" alignItems="center" borderRadius={5} p={1}>
                      <MDTypography fontSize={11}>Template:&nbsp;</MDTypography>
                      <MDTypography fontSize={13} fontWeight="bold" >₹{(selectedBattle?.battleTemplate?.portfolioValue)}</MDTypography>
                    </MDBox>
                  </Grid>
                  <Grid item xs={12} md={12} lg={2}>
                    <MDBox display="flex" justifyContent="center" alignContent="center" alignItems="center" borderRadius={5} p={1}>
                      <MDTypography fontSize={11}>NIFTY:&nbsp;</MDTypography>
                      <MDTypography fontSize={13} fontWeight="bold" >{(selectedBattle?.isNifty === true ? 'Yes' : 'No')}</MDTypography>
                    </MDBox>
                  </Grid>
                  <Grid item xs={12} md={12} lg={2}>
                    <MDBox display="flex" justifyContent="center" alignContent="center" alignItems="center" borderRadius={5} p={1}>
                      <MDTypography fontSize={11}>BANKNIFTY:&nbsp;</MDTypography>
                      <MDTypography fontSize={13} fontWeight="bold" >{(selectedBattle?.isBankNifty === true ? 'Yes' : 'No')}</MDTypography>
                    </MDBox>
                  </Grid>
                  <Grid item xs={12} md={12} lg={2}>
                    <MDBox display="flex" justifyContent="center" alignContent="center" alignItems="center" borderRadius={5} p={1}>
                      <MDTypography fontSize={11}>FINNIFTY:&nbsp;</MDTypography>
                      <MDTypography fontSize={13} fontWeight="bold" >{(selectedBattle?.isFinNifty === true ? 'Yes' : 'No')}</MDTypography>
                    </MDBox>
                  </Grid>
              </Grid>
            </MDBox>
