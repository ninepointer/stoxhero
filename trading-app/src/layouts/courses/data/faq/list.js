...
const List = ({ courseId }) => {
    ...
    useEffect(() => {
        ...
        axios.get(`${apiUrl}courses/${courseId}/faq`, {withCredentials: true})
            .then((res) => {
    ...
    async function deleteData(id){
        ...
        setFaqData(del?.data?.data?.courseInstructors)
    }
    ...
    return (
        ...
        <Card mt={1}>
            ...
            {createForm && <>
                <Create createForm={createForm} setCreateForm={setCreateForm} courseId={courseId} faq={id} />
            </>
            }
            <MDBox mt={1}>
                <DataTable
