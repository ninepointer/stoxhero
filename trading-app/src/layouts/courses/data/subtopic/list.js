...
const List = ({ contentId, courseId, subTopics }) => {
    ...
    async function deleteData(id){
        const del = await axios.delete(`${apiUrl}courses/${courseId}/subtopic/${contentId}/${id}`, {withCredentials: true});
                ...
                <DialogContent>
                    <DialogContentText sx={{ display: "flex", flexDirection: "column", marginLeft: 2 }}>
                        <Card>
                            ...
                            {createForm && <>
                                <Create createForm={createForm} setCreateForm={setCreateForm} courseId={courseId} contentId={contentId} subtopic={id} data={data} setData={setData} />
                            </>
                            }
                            <MDBox mt={1}>
                                <DataTable
