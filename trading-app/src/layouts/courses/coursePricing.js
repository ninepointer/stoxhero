  ...
  return (
    <>
      {isLoading ? (
        ...
        :
        (
          <MDBox bgColor="light" color="dark" mb={1} borderRadius={10} minHeight='auto' display="flex" justifyContent="center" alignItems="center" style={{minWidth:'100%'}}>
            <Grid container spacing={1} xs={12} md={12} lg={12} display="flex" justifyContent="center" alignItems="center">
                ...
                <TextField
                    ...
                    value={formState?.discountedPrice || courseData?.discountedPrice}
                    fullWidth
                    type='number'
                    onChange={(e) => {
                    setFormState(prevState => ({
                ...
                <TextField
                    ...
                    value={formState?.commissionPercentage || courseData?.commissionPercentage}
                    fullWidth
                    type='number'
                    onChange={(e) => {
                    setFormState(prevState => ({
