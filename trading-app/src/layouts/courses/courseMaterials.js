  ...
  return (
    <>
      {isLoading ? (
        ...
        :
        (
          <MDBox bgColor="light" color="dark" mb={1} borderRadius={10} minHeight='auto' display="flex" justifyContent="center" alignItems="center">
            <Grid container spacing={1} xs={12} md={12} lg={12} display="flex" justifyContent="center" alignItems="flex-start">
                <Grid item mt={0.5} xs={12} md={12} lg={8} display="flex" justifyContent="center" alignItems="center">
                    <Grid container spacing={2} xs={12} md={12} lg={12} display="flex" justifyContent="flex-start" alignItems="center">
                        ...
                        <TextField
                            ...
                            value={formState?.courseOverview || courseData?.courseOverview}
                            fullWidth
                            onChange={(e) => {
                            setFormState(prevState => ({
                                ...prevState,
                        ...
                        <TextField
                            ...
                            value={formState?.courseLanguages || courseData?.courseLanguages}
                            fullWidth
                            onChange={(e) => {
                            setFormState(prevState => ({
                                ...prevState,
                        ...
                        <Grid item xs={12} md={6} lg={6}>
                            <FormControl sx={{ width: '100%' }}>
                                <InputLabel id="demo-simple-select-autowidth-label">Course Type *</InputLabel>
                                <Select
                                labelId="demo-simple-select-autowidth-label"
                                id="demo-simple-select-autowidth"
                                disabled={((isSubmitted || id) && (!editing || saving))}
                        ...
                        <TextField
                            ...
                            value={formState?.maxEnrolments || courseData?.maxEnrolments}
                            fullWidth
                            onChange={(e) => {
                            setFormState(prevState => ({
                                ...prevState,
                        ...
                        <Grid item xs={12} md={6} lg={6} mt={-1}>
                            ...
                            <DemoContainer components={['MobileDateTimePicker']}>
                                ...
                                <MobileDateTimePicker
                                    ...
                                    disabled={((isSubmitted || courseData) && (!editing || saving))}
                                    value={formState?.registrationStartTime || courseData ? dayjs(courseData?.registrationStartTime) : null}
                                    onChange={(newValue) => {
                                    if (newValue && newValue.isValid()) {
                                        setFormState(prevState => ({ ...prevState, registrationStartTime: newValue }))
                                    }
                                    }}
                                    minDateTime={null}
                                    sx={{ width: '100%' }}
                        ...
                        <Grid item xs={12} md={6} lg={6} mt={-1}>
                            ...
                            <DemoContainer components={['MobileDateTimePicker']}>
                                ...
                                <MobileDateTimePicker
                                    ...
                                    disabled={((isSubmitted || courseData) && (!editing || saving))}
                                    value={formState?.registrationEndTime || courseData ? dayjs(courseData?.registrationEndTime) : null}
                                    onChange={(newValue) => {
                                    if (newValue && newValue.isValid()) {
                                        setFormState(prevState => ({ ...prevState, registrationEndTime: newValue }))
                                    }
                                    }}
                                    minDateTime={null}
                                    sx={{ width: '100%' }}
                        ...
                        <DemoContainer components={['MobileDateTimePicker']}>
                            ...
                            <MobileDateTimePicker
                                ...
                                disabled={((isSubmitted || courseData) && (!editing || saving))}
                                value={formState?.courseStartTime || courseData ? dayjs(courseData?.courseStartTime) : null}
                                onChange={(newValue) => {
                                if (newValue && newValue.isValid()) {
                                    setFormState(prevState => ({ ...prevState, courseStartTime: newValue }))
                                }
                                }}
                                minDateTime={null}
                                sx={{ width: '100%' }}
                        ...
                        <Grid item xs={12} md={6} lg={6} mt={-1}>
                            ...
                            <DemoContainer components={['MobileDateTimePicker']}>
                                ...
                                <MobileDateTimePicker
                                    ...
                                    disabled={((isSubmitted || courseData) && (!editing || saving))}
                                    value={formState?.courseEndTime || courseData ? dayjs(courseData?.courseEndTime) : null}
                                    onChange={(newValue) => {
                                    if (newValue && newValue.isValid()) {
                                        setFormState(prevState => ({ ...prevState, courseEndTime: newValue }))
                                    }
                                    }}
                                    minDateTime={null}
                                    sx={{ width: '100%' }}
                ...
                <Grid item xs={12} md={12} lg={4} display="flex" justifyContent="center" alignItems="center" flexDirection='column'>
                    {!courseData ? 
                    <Grid item xs={12} md={12} lg={12} display="flex" justifyContent="center" alignItems="center" style={{minWidth:'100%'}}>
                        <Grid container xs={12} md={12} lg={12} display="flex" justifyContent="center" alignItems="center">
                            <Grid item xs={12} md={12} lg={12} display="flex" justifyContent="flex-start" alignItems="center">
                                <MDTypography variant='button'>Course Image</MDTypography>
                            </Grid>
                        {titlePreviewUrl ? (
                            <Grid item mt={.5} xs={12} md={12} lg={12} display='flex' justifyContent='center' alignItems='center' style={{ maxWidth: '100%',border: '1px dashed #ccc' }}>
                                <img src={titlePreviewUrl} alt="Preview" style={{ maxWidth: '100%' }} />
                            </Grid>
                        )
                        :
                            <Grid item mt={.5} xs={12} md={12} lg={12} display='flex' justifyContent='center' alignItems='center' style={{ maxWidth: '100%', minHeight: '220px', border: '1px dashed #ccc' }}>
                                <input
                                    type="file"
                                    ...
                                    <Grid container xs={12} md={12} lg={12} display='flex' justifyContent='center' alignItems='center'>
                                        ...
                                        <Grid item xs={12} md={12} lg={12} display='flex' justifyContent='center' alignItems='center'>
                                            <MDTypography variant="caption" component="span">
                                                {!formState?.courseImage?.name ? "Upload Image" : "Upload Another Image"}
                                            </MDTypography>
                                        </Grid>
                                    </Grid>
                                </label>
                    ...
                    :
                    <Grid item xs={12} md={12} lg={12} display="flex" justifyContent="center" alignItems="center">
                        <Grid container mt={.5} xs={12} md={12} lg={12} display='flex' justifyContent='center' alignItems='center' style={{ maxWidth: '100%',border: '1px dotted #ccc' }}>
                            <img src={courseData?.courseImage?.url} alt="Preview" style={{ maxWidth: '100%' }} />
                        </Grid>        
                    </Grid>
                    }

                    {!courseData ? 
                    <Grid item mt={1} xs={12} md={12} lg={12} display="flex" justifyContent="center" alignItems="center" style={{minWidth:'100%'}}>
                        <Grid container xs={12} md={12} lg={12} display="flex" justifyContent="center" alignItems="center">
                            <Grid item xs={12} md={12} lg={12} display="flex" justifyContent="flex-start" alignItems="center">
                            ...
                            <Grid item mt={.5} xs={12} md={12} lg={12} display='flex' justifyContent='center' alignItems='center' style={{ maxWidth: '100%', minHeight: '220px', border: '1px dashed #ccc' }}>
                                ...
                                <label htmlFor="video-upload" style={{cursor:'pointer'}}>
                                    <Grid container xs={12} md={12} lg={12} display='flex' justifyContent='center' alignItems='center'>
                                        ...
                                        <Grid item xs={12} md={12} lg={12} display='flex' justifyContent='center' alignItems='center'>
                                            <MDTypography variant="caption" component="span">
                                                {!formState?.courseImage?.name ? "Upload Video" : "Upload Another Video"}
                                            </MDTypography>
                                        </Grid>
                                    </Grid>
                                </label>
