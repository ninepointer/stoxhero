...
import LiveViewTradeDetailData from "./LiveViewTradeDetailData";

// Data
// import data from "./data";

function LiveViewTradeDetail({ userId, socket }) {
  ...
  useEffect(() => {
    axios
      .get(
        `${baseUrl}api/v1/getoverallpnllivetradeparticularusertodaycompanyside/${userId}`,
