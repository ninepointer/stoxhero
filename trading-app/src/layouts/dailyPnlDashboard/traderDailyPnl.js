...
const TraderDailypnldata = () => {
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/datewisetraderpnl/${firstDate}/${traderName}`)
      .then((res) => {
    ...
    axios
      .get(`${baseUrl}api/v1/traderdailypnldata/${firstDate}/${traderName}`, {
  ...
  function startDate(e) {
    ...
    axios
      .get(`${baseUrl}api/v1/traderdailypnldata/${e.target.value}`, {
        withCredentials: true,
      })
      .then((res) => {
        setData(res.data);
  ...
  const npnlcolor =
    -FDPNLData[0]?.amount - FDPNLData[0]?.brokerage >= 0 ? "success" : "error";
          ...
          <Grid item xs={12} md={12} xl={12}>
            ...
            >
              <MDBox>
                ...
                >
                  {FDPNLData[0]
                    ? -FDPNLData[0].amount >= 0
                      ? "+₹" + (-FDPNLData[0].amount).toFixed(0)
                      : "-₹" + FDPNLData[0].amount.toFixed(0)
                    : 0}
                </MDTypography>
              </MDBox>
              <MDBox>
                ...
                <MDTypography
                  ...
                  py={1}
                >
                  ₹{FDPNLData[0] ? FDPNLData[0].brokerage.toFixed(0) : 0}
                </MDTypography>
              </MDBox>
              <MDBox>
                <MDTypography variant="h6" textAlign="center" py={1}>
                ...
                >
                  {FDPNLData[0]
                    ? -FDPNLData[0].amount - FDPNLData[0].brokerage >= 0
                      ? "+₹" +
                        (-FDPNLData[0].amount - FDPNLData[0].brokerage).toFixed(
                          0
                        )
                      : "-₹" +
                        -(
                          -FDPNLData[0].amount - FDPNLData[0].brokerage
                        ).toFixed(0)
                    : 0}
                </MDTypography>
              </MDBox>
              <MDBox>
                ...
                <MDTypography
                  ...
                  py={1}
                >
                  {FDPNLData[0] ? FDPNLData[0].trades : 0}
                </MDTypography>
              </MDBox>
              <MDBox>
                <MDTypography variant="h6" textAlign="center" py={1}>
