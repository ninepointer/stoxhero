...
export default function Charts({dailyInternshipUsers}) {
  ...
  const options = {
    title: {
      text: 'Daily Unique Internship Users',
      left: 'left',
    },
    tooltip: {
        trigger: 'axis',
    ...
    xAxis: [
        {
          type: 'category',
          data: dailyInternshipUsers.map(item => 
    ...
    series: [
      {
        name: 'Contest Users',
        type: 'line',
        data: dailyInternshipUsers.map(item => item.internshipTrading),
      },
    ],
  };
