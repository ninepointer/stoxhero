...
export default function LabTabs({ socket }) {
  ...
  useEffect(() => {
    axios
      .get(`${baseUrl}api/v1/marginxtrade/payoutchart`, {
            ...
            <Grid container xs={12} md={12} lg={12}>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  ...
                  >
                    Create Challenge Template here!
                  </MDTypography>
                </MDBox>
              </Grid>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4, paddingRight: 4 }}
                  >
                    Check all challenge reports here!
                  </MDTypography>
                </MDBox>
              </Grid>
              ...
              >
                <MDBox display="flex" flexDirection="column">
                  <MDTypography
                    ...
                    style={{ color: "white", paddingLeft: 4, paddingRight: 4 }}
                  >
                    Check challenge leaderboard here!
                  </MDTypography>
                </MDBox>
              </Grid>
