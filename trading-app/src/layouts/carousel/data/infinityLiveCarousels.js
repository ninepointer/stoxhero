...
function backHandler(){
  ...
  setCarouselData([]);
  setIsLoading(true)
  axios.get(`${baseUrl}api/v1/carousels/infinitylive?skip=${skip-limitSetting}&limit=${limitSetting}`,{
      withCredentials: true,
      headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
  ...
  return (
    <MDBox bgColor="dark" color="light" mb={1} borderRadius={10} minWidth='100%' minHeight='auto'>
      ...
      <MDBox minHeight='20vH' display='flex' justifyContent='center' alignItems='center'>
          <MDTypography fontSize={15} fontWeight='bold' color='light'>No Live Carousels for Infinity Traders</MDTypography>
      </MDBox>
