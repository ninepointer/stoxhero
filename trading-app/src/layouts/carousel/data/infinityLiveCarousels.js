...
const LiveCarousels = () => {
  ...
  useEffect(() => {
    let call1 = axios.get(`${baseUrl}api/v1/carousels/infinitylive`, {
  ...
  function backHandler() {
    ...
    axios
      .get(
        `${baseUrl}api/v1/carousels/infinitylive?skip=${
          skip - limitSetting
        }&limit=${limitSetting}`,
        {
          withCredentials: true,
  ...
  function Delete(id) {
    console.log(id);
    axios
      .get(`${baseUrl}api/v1/carousels/delete/${id}`, {
        withCredentials: true,
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
      ...
      {carouselData?.length === 0 ? (
        ...
        >
          <MDTypography fontSize={15} fontWeight="bold" color="light">
            No Live Carousels for Infinity Traders
          </MDTypography>
        </MDBox>
      ) : (
        <MDBox>
              ...
              !isLoading ? (
                carouselData?.map((elem, index) => {
                  return (
                    ...
                    >
                      <CarouselBox
                        image={elem.carouselImage}
                        name={elem.carouselName}
                        startDate={elem.carouselStartDate}
                        endDate={elem.carouselEndDate}
                        link={elem.linkToCarousel}
                        elem={elem}
                      />
                    </Grid>
                  );
            ...
            {!isLoading && count !== 0 && (
              ...
              >
                ...
                <MDTypography color="light" fontSize={15} fontWeight="bold">
                  Total Carousels: {!count ? 0 : count} | Page{" "}
