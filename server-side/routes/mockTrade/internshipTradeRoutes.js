...
const {overallPnl,myTodaysTrade,myHistoryTrade, overallInternshipPnlYesterday, liveTotalTradersCountYesterday,
    marginDetail, overallInternshipPnl,myInternshipTradingDays, myOverallInternshipPnl, liveTotalTradersCount, tradingDays, overallPnlAllTrader, traderWiseMockTrader} = require('../../controllers/internshipTradeController');
...
router.route('/my/tradingDays').get(Authenticate, myInternshipTradingDays)
