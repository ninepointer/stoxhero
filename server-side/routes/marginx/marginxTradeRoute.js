...
const {liveTotalTradersCount, overallMarginXTraderPnl, overallMarginXCompanySidePnlThisMonth,
    overallPnlTrader, myTodaysTrade, getMyPnlAndCreditData, getRedisMyRankHTTP,overallMarginXCompanySidePnlLifetime,
    myPnlAndPayout, overallMarginXPnlYesterday, MarginXPayoutChart,
    liveTotalTradersCountYesterday, traderWiseMockCompanySide, MarginxPnlTWiseTraderSide,
    MarginXPnlTWise, traderWiseMockTraderSide, myAllOrder } = require('../../controllers/marginX/marginxTradeController');
