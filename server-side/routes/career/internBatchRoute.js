...
const {createBatch, getBatch, getBatches,getInactiveBatches,getCompletedBatches, editBatch, approveUser, deleteBatch, getActiveBatches, getBatchParticipants, removeParticipantFromBatch} = require('../../controllers/career/internBatch');
