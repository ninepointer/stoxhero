...
const {
  getPaperTradesOverview,
  setCurrentUser,
  getPaperTradesDateWiseStats,
  getPaperTradesDailyPnlData,
  getPaperTradesMonthlyPnlData,
  getPaperTradesDateWiseWeekStats,
  getPaperTradesOverallStats, getPaperTradesWeekDayWiseStats
} = require("../../../controllers/analyticsController");

router
  .route("/myoverview")
  .get(Authenticate, setCurrentUser, getPaperTradesOverview);
router
  .route("/mystats")
  .get(Authenticate, setCurrentUser, getPaperTradesDateWiseStats);
router
  .route("/myweekdaystats")
  .get(Authenticate, setCurrentUser, getPaperTradesDateWiseWeekStats);

  router
  .route("/myweekdayfullstats")
  .get(Authenticate, setCurrentUser, getPaperTradesWeekDayWiseStats);
...
router
  .route("/mymonthlypnl")
  .get(Authenticate, setCurrentUser, getPaperTradesMonthlyPnlData);
