...
const {getHistoryRanks, newTrade, getUserTrades, currentUser, getContestRank, getMyContestRank, getContestPnl, getLastFiveTrade, getRedisLeaderBoard, getRedisMyRank} = require('../../controllers/contestTradeController');
