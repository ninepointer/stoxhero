   ...
   if (process.env.PROD === "true") {
    ...
    Setting.find().then((res) => {
        ...
        if (process.env.PROD === "true") {
            ...
            if (weekDay > res?.[0]?.weekStart && weekDay < res?.[0]?.weekEnd) {
    ...
    if (process.env.PROD === "true") {
        ...
        const removeInstrumentFromWatch = nodeCron.schedule(`0 0 23 * * *`, removeInstrumentFromWatchlist);
    ...
    app.use('/api/v1/fullcollege', require("./routes/createCollege/collegeRoutes"));
