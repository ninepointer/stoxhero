...
exports.apiRoutes = async (app) => {
  const setting = await Setting.findOne({});

  if (
    setting?.toggle?.ltp == zerodhaAccountType ||
    setting?.toggle?.complete == zerodhaAccountType
  ) {
  ...
  app.get("/api/v1/servertime", (req, res, next) => {
    res.json({ status: "success", data: new Date() });
  });
  ...
  app.get("/api/v1/assetclass", async (req, res, next) => {
    const assetClass = await AssetClass.find({ status: "Active" }).sort({
      createdOn: -1,
    });
  ...
  app.use(
    "/api/v1/marginxtemplate",
    require("./routes/marginx/marginxTemplateRoutes")
  );
  app.use("/api/v1/marginx", require("./routes/marginx/marginxRoutes"));
  app.use(
    "/api/v1/marginxtrade",
    require("./routes/marginx/marginxTradeRoute")
  );
  ...
  app.use(
    "/api/v1/affiliate",
    require("./routes/affiliateProgramme/affiliateRoute")
  );
  app.use(
    "/api/v1/influencer",
    require("./routes/influencerRoute/influencerRoute")
  );
  app.use(
    "/api/v1/leaderboard",
    require("./routes/leaderboard-parameter/leaderboard")
  );

  //  TODO toggle
  app.use(
    "/api/v1/contestmaster",
    require("./routes/DailyContest/contestMaster")
  );
  ...
  app.use("/api/v1/chart", require("./routes/pnlChart/pnlChart"));
  ...
  app.use(
    "/api/v1/pendingorder",
    require("./routes/pendingOrder/pendingRoute")
  );
  ...
  app.use(
    "/api/v1/tradingholiday",
    require("./routes/tradingHoliday/tradingHolidayRoute")
  );
  ...
  app.use(
    "/api/v1/activations",
    require("./routes/campaigns/activationRoutes")
  );
  app.use("/api/v1/campaign", require("./routes/campaigns/campaignRoute"));
  app.use(
    "/api/v1/contestTrade",
    require("./routes/contest/contestTradeRoutes")
  );
  app.use(
    "/api/v1/portfolio",
    require("./routes/userPortfolio/userPortfolioRoutes")
  );
  app.use(
    "/api/v1/userwallet",
    require("./routes/userWallet/userWalletRoutes")
  );
  ...
  app.use(
    "/api/v1/infinityRedis",
    require("./routes/mockTrade/infinityTradeRedis")
  );
  ...
  app.use(
    "/api/v1/internship",
    require("./routes/mockTrade/internshipTradeRoutes")
  );
  app.use("/api/v1/college", require("./routes/career/collegeRoute"));
  app.use(
    "/api/v1/fullcollege",
    require("./routes/createCollege/collegeRoutes")
  );
  ...
  app.use(
    "/api/v1/dailycontest",
    require("./routes/DailyContest/dailyContestRoutes")
  );
  app.use(
    "/api/v1/dailycontest/trade",
    require("./routes/DailyContest/dailyContestTrade")
  );
  app.use(
    "/api/v1/optionChain",
    require("./routes/optionChain/optionChainRoute")
  );
  app.use(
    "/api/v1/brokerreport",
    require("./routes/BrokerReport/brokerReportRoutes")
  );
  app.use(
    "/api/v1/contestscoreboard",
    require("./routes/DailyContest/contestScoreboard")
  );
  app.use(
    "/api/v1/instrumentpnl",
    require("./routes/instrumentPNL/instrumentPNL")
  );
  app.use("/api/v1/analytics", require("./routes/analytics/analytics"));
  app.use(
    "/api/v1/appmetrics",
    require("./routes/appMetrics/appMetricsRoutes")
  );
  app.use(
    "/api/v1/newappmetrics",
    require("./routes/appMetrics/newAppMetricesRoutes")
  );
  app.use(
    "/api/v1/infinitymining",
    require("./routes/infinityMining/infinityMiningRoutes")
  );
  app.use(
    "/api/v1/virtualtradingperformance",
    require("./routes/performance/virtualTradingRoute")
  );
  app.use("/api/v1/user", require("./routes/user/userRoutes"));
  app.use(
    "/api/v1/withdrawals",
    require("./routes/withdrawal/withdrawalRoutes")
  );
  app.use("/api/v1/KYC", require("./routes/KYCApproval/KYCRoutes"));
  app.use("/api/v1/quiz", require("./routes/School/quizRoutes"));
  app.use(
    "/api/v1/paymenttest",
    require("./routes/paymentTest/paymentTestRoutes")
  );
  app.use(
    "/api/v1/stoxherouserdashboard",
    require("./routes/StoxHeroDashboard/userAnalytics")
  );
  app.use(
    "/api/v1/revenue",
    require("./routes/revenuDashboardRoutes/revenueDashboardRoute")
  );
  app.use(
    "/api/v1/marginrequired",
    require("./routes/marginRequired/marginRequired")
  );
  app.use(
    "/api/v1/userdashboard",
    require("./routes/UserDashboard/dashboardRoutes")
  );
  ...
  app.use(
    "/api/v1/battletemplates",
    require("./routes/battles/battleTemplateRoutes")
  );
  app.use("/api/v1/marginxs", require("./routes/marginx/marginxRoutes"));
  app.use(
    "/api/v1/marginxtemplates",
    require("./routes/marginx/marginxTemplateRoutes")
  );
  app.use(
  ...
  app.use(
    "/api/v1/learningmodule",
    require("./routes/learningModule/learningModuleRoutes")
  );
  app.use(
    "/api/v1/alltradeview",
    require("./routes/viewRoutes/allTradesViewRoute")
  );
  app.use(
    "/api/v1/push",
    require("./routes/pushNotifications/pushNotificationRoutes")
  );
  app.use(
    "/api/v1/notificationgroup",
    require("./routes/notificationGroup/notificationGroupRoutes")
  );
  app.use("/api/v1/cities", require("./routes/city/cityRoutes"));
  app.use(
    "/api/v1/questionbank",
    require("./routes/QuestionBank/queBankRoutes")
  );
  app.use("/api/v1/school", require("./routes/School/school"));
  app.use("/api/v1/courses", require("./routes/courses/courseRoutes"));
  app.use("/api/v1/charts", require("./routes/chart/chartRoutes"));
